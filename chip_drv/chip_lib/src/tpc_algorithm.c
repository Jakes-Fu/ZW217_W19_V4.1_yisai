...
OUT: 	
    Xd1 = len2pixel(Xf1,(FLOAT_TYPE)LCD_WIDTH,TP_WIDTH);
    Yd1 = len2pixel(Yf1,(FLOAT_TYPE)LCD_HEIGHT,TP_HEIGHT);
    Xd2 = len2pixel(Xf2,(FLOAT_TYPE)LCD_WIDTH,TP_WIDTH);
    Yd2 = len2pixel(Yf2,(FLOAT_TYPE)LCD_HEIGHT,TP_HEIGHT);   
