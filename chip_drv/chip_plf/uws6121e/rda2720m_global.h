...
///
// =============================================================================
#define REG_RDA2720M_GLOBAL_RTC_BASE   0x800
#define REG_RDA2720M_GLOBAL_BASE   0xC00

typedef volatile struct
{
    REG32                          MODULE_EN0;                  //0x00000000
    REG32                          DIG_CLK_EN0;                 //0x00000004
    REG32                          RTC_CLK_EN0;                   //0x00000008
    REG32                          SOFT_RST0;                  //0x0000000C
    REG32                          VBAT_CTRL1;                  //0x00000010
    REG32                          LDO_VGEN_CTRL3;                    //0x00000014
    REG32                          DCDC_CTRL1;                    //0x00000018
    REG32                          PM2_PD_EN;                  //0x0000001C
    REG32                          VGEN_CTRL1;                  //0x00000020
    REG32                          LDO_VBAT_CTRL1;                  //0x00000024
    REG32                          CHGR_STATUS;                //0x00000028
    REG32                          POWER_PD_SW0;                //0x0000002C
    REG32                          POWER_PD_HW;                //0x00000030
    REG32                          SOFT_RST_HW;                //0x00000034
    REG32                          XTAL_RC_CTRL;               //0x00000038
    REG32                          RTC_CTRL;               //0x0000003C
    REG32                          RG_RTC_RESERVED1;               //0x00000040
    REG32                          DVDD_CTRL;                //0x00000044
    REG32                          POWON_CTRL;                //0x00000048
    REG32                          KPLED_CTRL0;                //0x0000004C
    REG32                          POWER_PD_SW1;                //0x00000050
    REG32                          POWER_LP_SW0;                 //0x00000054
    REG32                          LDO_VOSEL1;                //0x00000058
    REG32                          SLP_LDO_ULP_CTRL;                //0x0000005C
    REG32                          LDO_VGEN_CTRL;                //0x00000060
    REG32                          LDO_LP18_VIO33_ULP_EN;                 //0x00000064
    REG32                          VCORE_CTRL0;              //0x00000068
    REG32                          VCORE_CTRL1;                 //0x0000006C
    REG32                          VRF_CTRL2;                //0x00000070
    REG32                          VRF_CTRL3;                //0x00000074
    REG32                          VGEN_CTRL0;                //0x00000078
    REG32                          CHGR_CTRL0;                //0x0000007c
    REG32                          CHGR_DET_CTRL0;                //0x00000080
    REG32                          SLP_LDO_PD_CTRL0;                 //0x00000084
    REG32                          SLP_LDO_PD_CTRL1;                 //0x00000088
    REG32                          SLP_DCDC_PD_CTRL;                //0x0000008c
    REG32                          DCDC_CORE_SLP_CTRL0;               //0x00000090
    REG32                          DCDC_CORE_SLP_CTRL1;                //0x00000094
    REG32                          SLP_DCDC_LP_CTRL;                //0x00000098
    REG32                          SLP_LDO_LP_CTRL0;               //0x0000009c
    REG32                          SLP_LDO_LP_CTRL1;               //0x000000A0
    REG32                          RESERVED_REG_RTC;                //0x000000A4
    REG32                          DCDC_VLG_SEL;                //0x000000A8
    REG32                          LDO_VLG_SEL0;                 //0x000000AC
    REG32                          CLK32KLESS_CTRL0;                 //0x000000B0
    REG32                          CLK32KLESS_CTRL1;                 //0x000000B4
    REG32                          XTL_WAIT_CTRL0;                 //0x000000B8
    REG32                          POR_RST_MONITOR;                //0x000000BC
    REG32                          WDG_RST_MONITOR;              //0x000000C0
    REG32                          POR_PIN_RST_MONITOR;                //0x000000C4
    REG32                          POR_SRC_FLAG;                //0x000000C8
    REG32                          POR_7S_CTRL;             //0x000000CC
    REG32                          HWRST_RTC;                //0x000000D0
    REG32                          SMPL_CTRL0;               //0x000000D4
    REG32                          RTC_RST0;               //0x000000D8
    REG32                          RTC_RST1;               //0x000000DC
    REG32                          RTC_RST2;                //0x000000E0
    REG32                          RTC_CLK_STOP;                //0x000000E4
    REG32                          VBAT_DROP_CNT;                 //0x000000E8
    REG32                          MIXED_CTRL;                 //0x000000EC
    REG32                          POR_OFF_FLAG;            //0x000000F0
    REG32                          SWRST_CTRL0;          //0x000000F4
    REG32                          SWRST_CTRL1;            //0x000000F8
    REG32                          FREE_TIMER_LOW;               //0x000000FC
    REG32                          FREE_TIMER_HIGH;             //0x00000100
    REG32                          RESERVED_REG1;               //0x00000104
    REG32                          RESERVED_REG2;               //0x00000108
    REG32                          RESERVED_REG3;             //0x0000010C
    REG32                          RESERVED_REG4;               //0x00000110
    REG32                          RESERVED_REG5;               //0x00000114
    REG32                          RESERVED_REG6;               //0x00000118
    REG32                          PWR_WR_PROT_VALUE;              //0x0000011C
    REG32                          VOL_TUNE_CTRL_CORE;              //0x00000120
    REG32                          SMPL_CTRL1;                //0x00000124
} HWP_RDA2720M_GLOBAL_RTC_T;
...
typedef volatile struct
{
    ...
    REG32                          DIG_CLK_EN0;                  //0x0000000C
    REG32                          RTC_CLK_EN0;                  //0x00000010
    REG32                          SOFT_RST0;                    //0x00000014
    REG32                          XTL_WAIT;                    //0x00000018
    REG32                          RG_DVDD_RESERVED1;                  //0x0000001C
    REG32                          VBAT_CTRL0;                  //0x00000020
    REG32                          THM_OTP_CTRL;                  //0x00000024
    REG32                          LED_CTRL;                //0x00000028
    REG32                          KPLED_CTRL1;                //0x0000002C
    REG32                          LDO_VBAT_CTRL1;                //0x00000030
    REG32                          LDO_VBAT_CTRL2;                //0x00000034
    REG32                          LDO_VBAT_CTRL3;               //0x00000038
    REG32                          LDO_ANA_CTRL;               //0x0000003C
    REG32                          LDO_VIO18_CTRL;               //0x00000040
    REG32                          LDO_VGEN_CTRL1;                //0x00000044
    REG32                          LDO_SPIMEM_CTRL;                //0x00000048
    REG32                          LDO_CAMD_CTRL;                //0x0000004C
    REG32                          LDO_RF18_CTRL;                //0x00000050
    REG32                          LDO_VGEN_CTRL3;                 //0x00000054
    REG32                          LDO_LP18_CTRL;                //0x00000058
    REG32                          LDO_RF12_CTRL;                //0x0000005C
    REG32                          DCDC_CTRL1;                //0x00000060
    REG32                          VCORE_CTRL2;                 //0x00000064
    REG32                          VCORE_CTRL3;              //0x00000068
    REG32                          VRF_CTRL0;                 //0x0000006C
    REG32                          VRF_CTRL1;                //0x00000070
    REG32                          VGEN_CTRL2;                //0x00000074
    REG32                          VGEN_CTRL3;                //0x00000078
    REG32                          CHGR_CTRL1;                //0x0000007c
    REG32                          AUXADC_CTRL;                //0x00000080
    REG32                          CHGR_STATUS;                 //0x00000084
    REG32                          ARCH_EN;                 //0x00000088
    REG32                          MCU_WR_PROT_VALUE;                //0x0000008c
    REG32                          RESERVED_90;               //0x00000090
    REG32                          DCDC_CORE_REG1;                //0x00000094
    REG32                          DCDC_GEN_REG1;                //0x00000098
    REG32                          DCDC_VRF_REG1;               //0x0000009c
    REG32                          BG_CTRL0;               //0x000000A0
    REG32                          LDO_VOSEL1;                //0x000000A4
    REG32                          LDO_VOSEL3;                //0x000000A8
    REG32                          LDO_VOSEL4;                 //0x000000AC
    REG32                          LDO_LP18_VIO33_CTRL1;                 //0x000000B0
    REG32                          RESERVED_REG_CORE;                 //0x000000B4
    REG32                          RESERVED_REG1;                 //0x000000B8
    REG32                          RESERVED_REG2;                //0x000000BC
    REG32                          LDO_SIM_CTRL0;              //0x000000C0
    REG32                          LDO_SIM_VOSEL;                //0x000000C4
    REG32                          SIM_VPA_CTRL0;                //0x000000C8
    REG32                          LDO_SIM_CTRL1;             //0x000000CC
    REG32                          VPA_CTRL0;                //0x000000D0
    REG32                          VPA_CTRL1;               //0x000000D4
    REG32                          VPA_CTRL2;               //0x000000D8
    REG32                          VPA_CTRL3;               //0x000000DC
    REG32                          DCDC_VPA_REG1;                //0x000000E0
    #if 0
    REG32                          ARM_CLK_EN0;//call in sc6531efm_audio_cfg.h
    #endif
} HWP_RDA2720M_GLOBAL_T;

#define hwp_rda2720mGlobalRtc         ((HWP_RDA2720M_GLOBAL_RTC_T*) REG_ACCESS_ADDRESS(REG_RDA2720M_GLOBAL_RTC_BASE))
...
#define UIP8850_GLOBAL_TMR_EN     (1<<12)
#define UIP8850_GLOBAL_BLTC_EN    (1<<9)
#define UIP8850_GLOBAL_IOMUX_EN  (1<<8)
#define UIP8850_GLOBAL_RTC_TOPA_EN     (1<<7)
#define UIP8850_GLOBAL_EFS_EN     (1<<6)
#define UIP8850_GLOBAL_ADC_EN     (1<<5)
#define UIP8850_GLOBAL_PSM_TOPA_EN     (1<<4)
#define UIP8850_GLOBAL_EIC_EN     (1<<3)
#define UIP8850_GLOBAL_WDG_EN     (1<<2)
#define UIP8850_GLOBAL_RTC_EN     (1<<1)
#define UIP8850_GLOBAL_CAL_EN     (1<<0)
