...
{
    {TB_TIMER1_OS_INT,          ISR_UNIT_0,  INTCTL_TIMER1_OS_IRQ,       NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    ...
    {TB_UART0_INT,              ISR_UNIT_1,  INTCTL_UART0_IRQ,           NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    ...
    {TB_LCDC_INT,               ISR_UNIT_1,  INTCTL_LCDC_IRQ,            NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    ...
    {TB_PMIC_INT,               ISR_UNIT_3,  INTCTL_PMIC_IRQ,            NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_UART2_INT,              ISR_UNIT_0,  INTCTL_UART2_IRQ,           NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_ZSPUART_INT,            ISR_UNIT_1,              NULL,           NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_IDLE_LPS_INT,           ISR_UNIT_1,  INTCTL_IDLE_LPS_IRQ,        NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_WDG_INT,                ISR_UNIT_3,  INTCTL_ANA_WDG_IRQ,         NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},

    {TB_AIF_APB0_INT,           ISR_UNIT_0,  NULL,                       NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_AIF_APB1_INT,           ISR_UNIT_0,  NULL,                       NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},

    {TB_WCN_AWAKE_INT,          ISR_UNIT_2,  INTCTL_WCN_AWAKE_IRQ,       NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
    {TB_WCN_WLAN_INT,           ISR_UNIT_2,  INTCTL_WCN_WLAN_IRQ,        NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},

    {TB_GPIO1_INT,				ISR_UNIT_1,INTCTL_GPIO_1_IRQ,			NULL,NULL,INT_PHY_IrqHandleDefaultFunc},
    {TB_PAGE_SPY_INT,          ISR_UNIT_0,  INTCTL_PAGESPY_IRQ,       NULL,  NULL,  INT_PHY_IrqHandleDefaultFunc},
};

PUBLIC PRI_INDEX_GET_STATUS_T fiq_isr_array[MAX_FIQ_NUM] = //order by priority.
{
    {TB_TIMER2_OS_INT,       ISR_UNIT_0,  INTCTL_TIMER2_OS_IRQ,       NULL,  NULL,  INT_PHY_FiqHandleDefaultFunc},
