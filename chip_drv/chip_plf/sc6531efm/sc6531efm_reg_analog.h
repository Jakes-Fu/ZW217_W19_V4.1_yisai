/*******************************************************************************
 ** File Name:    sc6531efm_reg_analog.h                                        *
 ** Author:       windy                                                        *
 ** DATE:         09/19/11                                                     *
...
#ifndef _SC6531EFM_GLB_REG_H_
#define _SC6531EFM_GLB_REG_H_
...
#define ANA_CHIP_ID_LOW               			(ANA_GLB_REG_BASE + 0x0000UL)
#define ANA_CHIP_ID_HIGH               			(ANA_GLB_REG_BASE + 0x0004UL)
#define ANA_MODULE_EN0               			(ANA_GLB_REG_BASE + 0x0008UL)
#define ANA_ARM_CLK_EN0               			(ANA_GLB_REG_BASE + 0x000CUL)
#define ANA_RTC_CLK_EN0               			(ANA_GLB_REG_BASE + 0x0010UL)
#define ANA_SOFT_RST0               			(ANA_GLB_REG_BASE + 0x0014UL)
#define ANA_POWER_PD_SW               		(ANA_GLB_REG_BASE + 0x0018UL)
#define ANA_POWER_PD_HW                 		(ANA_GLB_REG_BASE + 0x001CUL)
#define RESERVED_REG0                			(ANA_GLB_REG_BASE + 0x0020UL)
#define RESERVED_REG1                			(ANA_GLB_REG_BASE + 0x0024UL)
#define RESERVED_REG2                			(ANA_GLB_REG_BASE + 0x0028UL)
#define RESERVED_REG3                			(ANA_GLB_REG_BASE + 0x002CUL)
#define RESERVED_REG4                			(ANA_GLB_REG_BASE + 0x0030UL)
#define RESERVED_REG5                			(ANA_GLB_REG_BASE + 0x0034UL)
#define ANA_LDO_CAMA_REG0               		(ANA_GLB_REG_BASE + 0x0038UL)
#define ANA_LDO_CAMA_REG1              		(ANA_GLB_REG_BASE + 0x003CUL)
#define ANA_LDO_SIM0_REG0                		(ANA_GLB_REG_BASE + 0x0040UL)
#define ANA_LDO_SIM0_REG1                		(ANA_GLB_REG_BASE + 0x0044UL)
#define ANA_LDO_SIM0_REG2                		(ANA_GLB_REG_BASE + 0x0048UL)
#define ANA_LDO_SIM1_REG0                		(ANA_GLB_REG_BASE + 0x004CUL)
#define ANA_LDO_SIM1_REG1                		(ANA_GLB_REG_BASE + 0x0050UL)
#define ANA_LDO_SIM1_PD_REG            		(ANA_GLB_REG_BASE + 0x0054UL)
#define ANA_LDO_SD_REG0               			(ANA_GLB_REG_BASE + 0x0058UL)
#define ANA_LDO_SD_REG1               			(ANA_GLB_REG_BASE + 0x005CUL)
#define ANA_LDO_SD_REG2               			(ANA_GLB_REG_BASE + 0x0060UL)
#define ANA_LDO_VDD28_REG0              		(ANA_GLB_REG_BASE + 0x0064UL)
#define ANA_LDO_VDD28_REG1              		(ANA_GLB_REG_BASE + 0x0068UL)
#define ANA_LDO_BTPA_REG0                		(ANA_GLB_REG_BASE + 0x006CUL)
#define ANA_LDO_BTPA_REG1                		(ANA_GLB_REG_BASE + 0x0070UL)
#define ANA_LDO_DCXO_REG0                		(ANA_GLB_REG_BASE + 0x0074UL)
#define ANA_LDO_DCXO_REG1               		(ANA_GLB_REG_BASE + 0x0078UL)
#define ANA_LDO_USB_REG0               		(ANA_GLB_REG_BASE + 0x007CUL)
#define ANA_LDO_USB_REG1               		(ANA_GLB_REG_BASE + 0x0080UL)
#define ANA_LDO_CAMD_REG0               		(ANA_GLB_REG_BASE + 0x0084UL)
#define ANA_LDO_CAMD_REG1               		(ANA_GLB_REG_BASE + 0x0088UL)
#define ANA_LDO_SF_REG0               			(ANA_GLB_REG_BASE + 0x008CUL)
#define ANA_LDO_SF_REG1               			(ANA_GLB_REG_BASE + 0x0090UL)
#define ANA_LDO_VDD18_REG0              		(ANA_GLB_REG_BASE + 0x0094UL)
#define ANA_LDO_VDD18_REG1              		(ANA_GLB_REG_BASE + 0x0098UL)
#define ANA_LDO_RF_REG0               			(ANA_GLB_REG_BASE + 0x009CUL)
#define ANA_LDO_RF_REG1               			(ANA_GLB_REG_BASE + 0x00A0UL)
#define ANA_LDO_CORE_REG0               		(ANA_GLB_REG_BASE + 0x00A4UL)
#define ANA_LDO_CORE_REG1               		(ANA_GLB_REG_BASE + 0x00A8UL)
#define RESERVED_REG17              			(ANA_GLB_REG_BASE + 0x00ACUL)
#define RESERVED_REG18              			(ANA_GLB_REG_BASE + 0x00B0UL)
#define RESERVED_REG19              			(ANA_GLB_REG_BASE + 0x00B4UL)
#define RESERVED_REG20              			(ANA_GLB_REG_BASE + 0x00B8UL)
#define RESERVED_REG21              			(ANA_GLB_REG_BASE + 0x00BCUL)
#define RESERVED_REG22              			(ANA_GLB_REG_BASE + 0x00C0UL)
#define ANA_LDO_CH_CTRL               			(ANA_GLB_REG_BASE + 0x00C4UL)
#define ANA_LDO_REFTRIM_REG            	  	(ANA_GLB_REG_BASE + 0x00C8UL)
#define RESERVED_REG24              		  	(ANA_GLB_REG_BASE + 0x00CCUL)
#define RESERVED_REG25              		  	(ANA_GLB_REG_BASE + 0x00D0UL)
#define RESERVED_REG26				  	(ANA_GLB_REG_BASE + 0x00D4UL)
#define RESERVED_REG27              		  	(ANA_GLB_REG_BASE + 0x00D8UL)
#define ANA_SLP_CTRL               			  	(ANA_GLB_REG_BASE + 0x00DCUL)
#define ANA_SLP_LDO_PD_CTRL0               	(ANA_GLB_REG_BASE + 0x00E0UL)
#define ANA_SLP_LDO_LP_CTRL0               	(ANA_GLB_REG_BASE + 0x00E4UL)
#define ANA_LDO_CORE_SLP_CTRL0               	(ANA_GLB_REG_BASE + 0x00E8UL)
#define ANA_LDO_CORE_SLP_CTRL1               	(ANA_GLB_REG_BASE + 0x00ECUL)
#define ANA_LDO_CORE_SLP_CTRL2               	(ANA_GLB_REG_BASE + 0x00F0UL)
#define ANA_LDO_CORE_SLP_CTRL3               	(ANA_GLB_REG_BASE + 0x00F4UL)
#define ANA_LDO_XTL_EN0               		  	(ANA_GLB_REG_BASE + 0x00F8UL)
#define ANA_LDO_XTL_EN1               		  	(ANA_GLB_REG_BASE + 0x00FCUL)
#define ANA_XO_BG_XTL_EN               		(ANA_GLB_REG_BASE + 0x0100UL)
#define RESERVED_REG29              		  	(ANA_GLB_REG_BASE + 0x0104UL)
#define RESERVED_REG30              		  	(ANA_GLB_REG_BASE + 0x0108UL)
#define RESERVED_REG31              		  	(ANA_GLB_REG_BASE + 0x010CUL)
#define RESERVED_REG32              		  	(ANA_GLB_REG_BASE + 0x0110UL)
#define RESERVED_REG33              		  	(ANA_GLB_REG_BASE + 0x0114UL)
#define RESERVED_REG34              		  	(ANA_GLB_REG_BASE + 0x0118UL)
#define ANA_CLK32KLESS_CTRL0               	(ANA_GLB_REG_BASE + 0x011CUL)
#define ANA_CLK32KLESS_CTRL1               	(ANA_GLB_REG_BASE + 0x0120UL)
#define ANA_CLK32KLESS_CTRL2               	(ANA_GLB_REG_BASE + 0x0124UL)
#define ANA_CLK32KLESS_CTRL3               	(ANA_GLB_REG_BASE + 0x0128UL)
#define ANA_CLK32KLESS_CTRL4               	(ANA_GLB_REG_BASE + 0x012CUL)
#define ANA_AUXAD_CTL               			(ANA_GLB_REG_BASE + 0x0130UL)
#define ANA_XTL_WAIT_CTRL                		(ANA_GLB_REG_BASE + 0x0134UL)
#define ANA_IB_CTRL               				(ANA_GLB_REG_BASE + 0x0138UL)
#define ANA_WHTLED_CTRL               		  	(ANA_GLB_REG_BASE + 0x013CUL)
#define ANA_KPLED_CTRL               			(ANA_GLB_REG_BASE + 0x0140UL)
#define ANA_VIBR_CTRL               			(ANA_GLB_REG_BASE + 0x0144UL)
#define ANA_AUDIO_CTRL0               	  	  	(ANA_GLB_REG_BASE + 0x0148UL)
#define ANA_AUDIO_CTRL1					(ANA_GLB_REG_BASE + 0x014CUL)
#define ANA_CHGR_CTL0               			(ANA_GLB_REG_BASE + 0x0150UL)
#define ANA_CHGR_CTL1               			(ANA_GLB_REG_BASE + 0x0154UL)
#define ANA_CHGR_CTL2               			(ANA_GLB_REG_BASE + 0x0158UL)
#define ANA_CHGR_STATUS               			(ANA_GLB_REG_BASE + 0x015CUL)
#define ANA_MIXED_CTRL0               			(ANA_GLB_REG_BASE + 0x0160UL)
#define ANA_MIXED_CTRL1               			(ANA_GLB_REG_BASE + 0x0164UL)
#define ANA_POR_RST_MONITOR               	(ANA_GLB_REG_BASE + 0x0168UL)
#define ANA_WDG_RST_MONITOR               	(ANA_GLB_REG_BASE + 0x016CUL)
#define ANA_POR_PIN_RST_MONITOR              (ANA_GLB_REG_BASE + 0x0170UL)
#define ANA_POR_SRC_FLAG               		(ANA_GLB_REG_BASE + 0x0174UL)
#define ANA_POR_7S_CTRL               			(ANA_GLB_REG_BASE + 0x0178UL)
#define ANA_HWRST_RTC               			(ANA_GLB_REG_BASE + 0x017CUL)
#define ANA_ARCH_EN               				(ANA_GLB_REG_BASE + 0x0180UL)
#define ANA_MCU_WR_PROT_VALUE               	(ANA_GLB_REG_BASE + 0x0184UL)
#define ANA_PWR_WR_PROT_VALUE               	(ANA_GLB_REG_BASE + 0x0188UL)
#define ANA_SMPL_CTRL0               			(ANA_GLB_REG_BASE + 0x018CUL)
#define ANA_SMPL_CTRL1               			(ANA_GLB_REG_BASE + 0x0190UL)
#define ANA_RTC_RST0               				(ANA_GLB_REG_BASE + 0x0194UL)
#define ANA_RTC_RST1               				(ANA_GLB_REG_BASE + 0x0198UL)
#define ANA_RTC_RST2               				(ANA_GLB_REG_BASE + 0x019CUL)
#define ANA_RTC_CLK_STOP               		(ANA_GLB_REG_BASE + 0x01A0UL)
#define ANA_VBAT_DROP_CNT               		(ANA_GLB_REG_BASE + 0x01A4UL)
#define ANA_SWRST_CTRL0               			(ANA_GLB_REG_BASE + 0x01A8UL)
#define ANA_SWRST_CTRL1               			(ANA_GLB_REG_BASE + 0x01ACUL)
#define ANA_OTP_CTRL               				(ANA_GLB_REG_BASE + 0x01B0UL)
#define RESERVED_REG35               			(ANA_GLB_REG_BASE + 0x01B4UL)
#define RESERVED_REG36               			(ANA_GLB_REG_BASE + 0x01B8UL)
#define ANA_LOW_PWR_CLK32K_CTRL             (ANA_GLB_REG_BASE + 0x01BCUL)
#define ANA_LOW_PWR_CLK32K_TEST0           (ANA_GLB_REG_BASE + 0x01C0UL)
#define ANA_LOW_PWR_CLK32K_TEST1           (ANA_GLB_REG_BASE + 0x01C4UL)
#define ANA_LOW_PWR_CLK32K_TEST2           (ANA_GLB_REG_BASE + 0x01C8UL)
#define ANA_LOW_PWR_CLK32K_TEST3           (ANA_GLB_REG_BASE + 0x01CCUL)
 ...
 **************************   Fields Definition *******************************/
#define    ANA_PINREG_EN		(BIT_7)
#define    ANA_PWM_EN			(BIT_6)
 ...
 **************************   Fields Definition *******************************/
#define    ANA_CLK_AUD_SCLK_EN				(BIT_7)
...
#define    LDO_CAMA_V_MSK               (0xFFUL << LDO_CAMA_V_SHIFT)
...
#define    LDO_SD_V_MSK               (0xFFUL << LDO_SD_V_SHIFT)
...
#define    LDO_CAMD_V_MSK               (0xFFUL << LDO_CAMD_V_SHIFT)
...
#define    WHTLED_V_SHIFT            	(1)
#define    WHTLED_V_MSK               	(0xFUL << WHTLED_V_SHIFT)
