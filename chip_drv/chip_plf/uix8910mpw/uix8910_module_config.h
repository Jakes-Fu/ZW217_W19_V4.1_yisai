/******************************************************************************
 ** File Name:    sc6531efm_module_config.h                                      *
 ** Author:       Yong.Li                                                     *
 ** DATE:         04/11/2012                                                  *
 ...
 ******************************************************************************/
#ifndef _UIX8910_MODULE_CONFIG_H_
#define _UIX8910_MODULE_CONFIG_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
/**---------------------------------------------------------------------------*
...
#define WDG_IRQ_COUNT      (0x0001FFFF) //uint : 1/32768s    total: 2s
...
**---------------------------------------------------------------------------*/
#define ADC_CHANNEL_VBAT    2
#define ADC_CHANNEL_VCHG    3
#define ADC_CHANNEL_PROG    4

#define CHGMNG_STOP_VPROG	120 //100//0x70  // Isense stop point,current value
/**---------------------------------------------------------------------------*
