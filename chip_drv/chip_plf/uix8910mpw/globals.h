...
// AON_APB_ID_T
// -----------------------------------------------------------------------------
/// 8910 sys aon apb module id
// =============================================================================
typedef enum
{
    AON_APB_ID_SYS_CTRL                         = 0x00000000,
    AON_APB_ID_LVDS                             = 0x00000001,
    AON_APB_ID_LPS                              = 0x00000002,
    AON_APB_ID_I2C_M4                           = 0x00000003,
    AON_APB_ID_CALENDAR                         = 0x00000004,
...
/// Last of AON Normal slave
    ...
    AON_APB_ID_RSV_17                           = 0x00000011,
    AON_APB_ID_RSV_18                           = 0x00000012,
    AON_APB_ID_SCI_1                            = 0x00000013,
    AON_APB_ID_SCI_2                            = 0x00000014,
...
// AP_APB_ID_T
// -----------------------------------------------------------------------------
/// 8910 sys apb module id
// =============================================================================
typedef enum
{
    AP_APB_ID_0_RESERVED                        = 0x00000000,
    ...
    AP_APB_ID_I2C_M2                            = 0x0000000B,
    AP_APB_ID_I2C_M3                            = 0x0000000C,
...
/// Last of Sys APB Normal slave
    ...
    AP_APB_ID_SPI_3                             = 0x00000014,
    AP_APB_ID_SPI_RESERVED                      = 0x00000015,
    AP_APB_ID_UART_1                            = 0x00000016,
...
typedef enum
{
    ...
    AP_APB_DMA_ID_SPI_3_TX                      = 0x00000008,
    AP_APB_DMA_ID_SPI_3_RX                      = 0x00000009,
    AP_APB_DMA_ID_10_RESERVED                   = 0x0000000A,
    AP_APB_DMA_ID_11_RESERVED                   = 0x0000000B,
...
typedef enum
{
    ...
    AON_APB_DMA_ID_TX_SCI_1                     = 0x00000006,
    AON_APB_DMA_ID_RX_SCI_1                     = 0x00000007,
    AON_APB_DMA_ID_TX_SCI_2                     = 0x00000008,
    AON_APB_DMA_ID_RX_SCI_2                     = 0x00000009
} AON_IFC_REQUEST_IDS_T;
...
/// System IRQ IDs
    ...
    SYS_IRQ_ID_I2C_M2                           = 0x00000009,
    SYS_IRQ_ID_I2C_M3                           = 0x0000000A,
    SYS_IRQ_ID_AIF_APB_0                        = 0x0000000B,
    SYS_IRQ_ID_AIF_APB_1                        = 0x0000000C,
    SYS_IRQ_ID_AIF_APB_2                        = 0x0000000D,
    SYS_IRQ_ID_AIF_APB_3                        = 0x0000000E,
    SYS_IRQ_ID_SDMMC1                           = 0x0000000F,
    SYS_IRQ_ID_SDMMC2                           = 0x00000010,
    SYS_IRQ_ID_SPI_1                            = 0x00000011,
    SYS_IRQ_ID_SPI_2                            = 0x00000012,
    SYS_IRQ_ID_SPI_3                            = 0x00000013,
    SYS_IRQ_ID_UART_1                           = 0x00000014,
    SYS_IRQ_ID_UART_2                           = 0x00000015,
    SYS_IRQ_ID_UART_3                           = 0x00000016,
    SYS_IRQ_ID_CAMERA                           = 0x00000017,
    SYS_IRQ_ID_LZMA                             = 0x00000018,
    SYS_IRQ_ID_GOUDA                            = 0x00000019,
    SYS_IRQ_ID_F8                               = 0x0000001A,
    SYS_IRQ_ID_USBC                             = 0x0000001B,
    SYS_IRQ_ID_AXIDMA                           = 0x0000001C,
    SYS_IRQ_ID_PMU_APCPU                        = 0x0000001D,
    SYS_IRQ_ID_PMU_CPCPU                        = 0x0000001E,
    SYS_IRQ_ID_LCD                              = 0x0000001F,
    SYS_IRQ_ID_LPS                              = 0x00000020,
    SYS_IRQ_ID_I2C_M4                           = 0x00000021,
    SYS_IRQ_ID_TIMER_3                          = 0x00000022,
    SYS_IRQ_ID_TIMER_3_OS                       = 0x00000023,
    SYS_IRQ_ID_KEYPAD                           = 0x00000024,
    SYS_IRQ_ID_GPIO_1                           = 0x00000025,
    SYS_IRQ_ID_GPIO_2                           = 0x00000026,
    SYS_IRQ_ID_DEBUG_UART                       = 0x00000027,
    SYS_IRQ_ID_SCI_1                            = 0x00000028,
    SYS_IRQ_ID_SCI_2                            = 0x00000029,
    SYS_IRQ_ID_ADI                              = 0x0000002A,
    SYS_IRQ_ID_CP_IDLE_2_H                      = 0x0000002B,
    SYS_IRQ_ID_MAILBOX_ARM_AP                   = 0x0000002C,
    SYS_IRQ_ID_MAILBOX_ARM_CP                   = 0x0000002D,
    SYS_IRQ_ID_LTEM1_FRAME                      = 0x0000002E,
    SYS_IRQ_ID_LTEM2_FRAME                      = 0x0000002F,
    SYS_IRQ_ID_CP_IDLE_H                        = 0x00000030,
    SYS_IRQ_ID_RFSPI_CONFLICT                   = 0x00000031,
    SYS_IRQ_ID_CP_WD_RESET                      = 0x00000032,
    SYS_IRQ_ID_GSM_FRAME                        = 0x00000033,
    SYS_IRQ_ID_PWRCTRL_TIMEOUT                  = 0x00000034,
    SYS_IRQ_ID_LTE_COEFF                        = 0x00000035,
    SYS_IRQ_ID_LTE_CSIRS                        = 0x00000036,
    SYS_IRQ_ID_LTE_DLFFT                        = 0x00000037,
    SYS_IRQ_ID_LTE_DLFFT_ERR                    = 0x00000038,
    SYS_IRQ_ID_LTE_IDDET                        = 0x00000039,
    SYS_IRQ_ID_LTE_LDTC1_CTRL                   = 0x0000003A,
    SYS_IRQ_ID_LTE_LDTC1_DATA                   = 0x0000003B,
    SYS_IRQ_ID_LTE_LDTC1_VIT                    = 0x0000003C,
    SYS_IRQ_ID_LTE_LDTC                         = 0x0000003D,
    SYS_IRQ_ID_LTE_MEASPWR                      = 0x0000003E,
    SYS_IRQ_ID_LTE_PUSCH                        = 0x0000003F,
    SYS_IRQ_ID_LTE_RFMODEL                      = 0x00000040,
    SYS_IRQ_ID_LTE_RX_TRACE                     = 0x00000041,
    SYS_IRQ_ID_LTE_TXRX                         = 0x00000042,
    SYS_IRQ_ID_LTE_TX_TRACE                     = 0x00000043,
    SYS_IRQ_ID_LTE_ULDFT                        = 0x00000044,
    SYS_IRQ_ID_LTE_ULDFT_ERR                    = 0x00000045,
    SYS_IRQ_ID_LTE_ULPCDCI                      = 0x00000046,
    SYS_IRQ_ID_LTE_CORR                         = 0x00000047,
    SYS_IRQ_ID_ZSP_AXIDMA                       = 0x00000048,
    SYS_IRQ_ID_ZSP_BUSMON                       = 0x00000049,
    SYS_IRQ_ID_ZSP_WD                           = 0x0000004A,
    SYS_IRQ_ID_GGE_TCU_SYNC                     = 0x0000004B,
    SYS_IRQ_ID_GGE_FINT                         = 0x0000004C,
    SYS_IRQ_ID_GGE_TCU_0                        = 0x0000004D,
    SYS_IRQ_ID_GGE_TCU_1                        = 0x0000004E,
    SYS_IRQ_ID_GGE_COMP_INT                     = 0x0000004F,
    SYS_IRQ_ID_WCN_WLAN                         = 0x00000050,
    SYS_IRQ_ID_WCN_SOFT                         = 0x00000051,
    SYS_IRQ_ID_WCN_WDT_RST                      = 0x00000052,
    SYS_IRQ_ID_WCN_AWAKE                        = 0x00000053,
    SYS_IRQ_ID_RF_WDG_RST                       = 0x00000054,
    SYS_IRQ_ID_SPIFLASH                         = 0x00000055,
    SYS_IRQ_ID_GGE_NB_RX_DSP                    = 0x00000056,
    SYS_IRQ_ID_GGE_NB_RX_MCU                    = 0x00000057,
    SYS_IRQ_ID_GGE_NB_TX_DSP                    = 0x00000058,
    SYS_IRQ_ID_GGE_NB_ACC_DSP                   = 0x00000059,
    SYS_IRQ_ID_GPRS_0                           = 0x0000005A,
    SYS_IRQ_ID_GPRS_1                           = 0x0000005B,
    SYS_IRQ_ID_DMC                              = 0x0000005C,
    SYS_IRQ_ID_AXIDMA_1                         = 0x0000005D,
    SYS_IRQ_ID_AUD_2AD                          = 0x0000005E,
    SYS_IRQ_ID_SPIFLASH1                        = 0x0000005F
} SYS_IRQ_ID_T;
...
typedef enum
{
    ...
    BB_SYSCTRL_ID_MAILBOX                       = 0x00000002,
...
typedef enum
{
    ...
    CP_ZSP_SYS_ID_ZSP_UART                      = 0x00001000,
...
// GGE_SYS_APB_ID_T
// -----------------------------------------------------------------------------
/// 8910 gge sys apb module id
// =============================================================================
typedef enum
{
    GGE_SYS_APB_ID_0_RSV                        = 0x00000000,
    GGE_SYS_APB_ID_TCU                          = 0x00000001,
    GGE_SYS_APB_ID_2_RSV                        = 0x00000002,
    GGE_SYS_APB_ID_3_RSV                        = 0x00000003,
    ...
    GGE_SYS_APB_ID_RFSPI                        = 0x0000000E
} GGE_SYS_APB_ID_T;
...
{
/// GGE IRQ IDs
    GGE_BB_IRQ_ID_TCU0                          = 0x00000000,
    GGE_BB_IRQ_ID_TCU1                          = 0x00000001,
    GGE_BB_IRQ_ID_FRAME                         = 0x00000002,
    GGE_BB_IRQ_ID_A53                           = 0x00000003,
    GGE_BB_IRQ_ID_4_RSV                         = 0x00000004,
    GGE_BB_IRQ_ID_5_RSV                         = 0x00000005,
    GGE_BB_IRQ_ID_RFIF_DBG_2G                   = 0x00000006,
    GGE_BB_IRQ_ID_RFIF_DBG_NB                   = 0x00000007,
    GGE_BB_IRQ_ID_RFIF_RX                       = 0x00000008,
    GGE_BB_IRQ_ID_RFIF_TX                       = 0x00000009,
    GGE_BB_IRQ_ID_EVITAC                        = 0x0000000A,
    GGE_BB_IRQ_ID_EXCOR                         = 0x0000000B,
    GGE_BB_IRQ_ID_ITLV                          = 0x0000000C,
    GGE_BB_IRQ_ID_VITAC                         = 0x0000000D,
    GGE_BB_IRQ_ID_XCOR                          = 0x0000000E,
    GGE_BB_IRQ_ID_CHOLK                         = 0x0000000F,
    GGE_BB_IRQ_ID_16_RSV                        = 0x00000010,
    GGE_BB_IRQ_ID_MAILBOX                       = 0x00000011,
    GGE_BB_IRQ_ID_TCU_SYNC                      = 0x00000012,
    GGE_BB_IRQ_ID_NB_RX                         = 0x00000013,
    GGE_BB_IRQ_ID_NB_TX                         = 0x00000014,
    GGE_BB_IRQ_ID_NB_ACC                        = 0x00000015
} GGE_BB_IRQ_ID_T;
...
// RF_APB_ID_T
// -----------------------------------------------------------------------------
/// 8910 rf apb module id
// =============================================================================
typedef enum
{
    RF_APB_ID_CTRL_1                            = 0x00000000,
    RF_APB_ID_CTRL_2                            = 0x00000001,
    RF_APB_ID_DFE_1                             = 0x00000002,
    RF_APB_ID_DFE_2                             = 0x00000003,
