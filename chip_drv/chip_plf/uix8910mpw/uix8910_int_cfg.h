 ...
 ******************************************************************************/
#ifndef _UIX8910_INT_CFG_H_
#define _UIX8910_INT_CFG_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
#define TB_TIMER1_INT                SYS_IRQ_ID_TIMER_1
#define TB_TIMER1_OS_INT             SYS_IRQ_ID_TIMER_1_OS
#define TB_TIMER2_INT                SYS_IRQ_ID_TIMER_2
#define TB_TIMER2_OS_INT             SYS_IRQ_ID_TIMER_2_OS
#define TB_TIMER3_INT                SYS_IRQ_ID_TIMER_3
#define TB_TIMER3_OS_INT             SYS_IRQ_ID_TIMER_3_OS
#define TB_TIMER4_INT                SYS_IRQ_ID_TIMER_4
#define TB_TIMER4_OS_INT             SYS_IRQ_ID_TIMER_4_OS
#define TB_GPIO_EICDBC_INT           SYS_IRQ_ID_GPIO_1
#define TB_GPIO2_INT                 SYS_IRQ_ID_GPIO_2
#define TB_DEBUG_UART_INT            SYS_IRQ_ID_DEBUG_UART
#define TB_EIC_SYNC_ASYNC_INT        0xB
#define TB_KPD_INT                   SYS_IRQ_ID_KEYPAD
#define TB_I2C0_INT                  SYS_IRQ_ID_I2C_M1
#define TB_I2C1_INT                  SYS_IRQ_ID_I2C_M2
#define TB_I2C2_INT                  SYS_IRQ_ID_I2C_M3
#define TB_I2C3_INT                  SYS_IRQ_ID_I2C_M4
#define TB_AIF_APB0_INT              SYS_IRQ_ID_AIF_APB_0
#define TB_AIF_APB1_INT              SYS_IRQ_ID_AIF_APB_1
#define TB_AIF_APB2_INT              SYS_IRQ_ID_AIF_APB_2
#define TB_AIF_APB3_INT              SYS_IRQ_ID_AIF_APB_3
#define TB_AUD_INT                   0x10
#define TB_SIM0_INT                  SYS_IRQ_ID_SCI_1
#define TB_SIM1_INT                  SYS_IRQ_ID_SCI_2
#define TB_UART0_INT                 SYS_IRQ_ID_UART_1
#define TB_UART1_INT                 SYS_IRQ_ID_UART_2
#define TB_UART2_INT                 SYS_IRQ_ID_UART_3
#define TB_DSP_INT                   0x15
#define TB_LCDC_INT                  SYS_IRQ_ID_LCD
#define TB_GEA_INT                   0x17
#define TB_SYST_INT                  0x18
#define TB_SPI0_INT                  SYS_IRQ_ID_SPI_1
#define TB_SPI1_INT                  SYS_IRQ_ID_SPI_2
...
#define TB_DMA_INT                   SYS_IRQ_ID_AXIDMA
...
#define TB_SDIO_INT                  SYS_IRQ_ID_SDMMC1
#define TB_SDIO2_INT                 SYS_IRQ_ID_SDMMC2
...
#define INTCTL_GPIO_EICDBC_IRQ          (1 << 5)
#define INTCTL_EIC_SYNC_ASYNC_IRQ       (1 << 7)
#define INTCTL_KPD_IRQ                  (1 << 4)
#define INTCTL_I2C_IRQ                  (1 << 8)
#define INTCTL_SIM0_IRQ                 (1 << 10)
#define INTCTL_SYSMAIL_AP_IRQ           (1 << 12)
#define INTCTL_UART0_IRQ                (1 << 0x14)
#define INTCTL_UART1_IRQ                (1 << 0x15)
#define INTCTL_DSP_IRQ                  (1 << 13)
#define INTCTL_LCDC_IRQ                 (1 << 0x1F)
...
#define INTCTL_USB_IRQ                  (1 << 0x1B)
#define INTCTL_DCAM_IRQ                 (1 << 0x17)
#define INTCTL_IIS_IRQ                  (1 << 27)
#define INTCTL_SDIO_IRQ                 (1 << 0xF)
#define INTCTL_SDIO2_IRQ                (1 << 0x10)
...
#define ISR_UNIT_0_NUMBER   (10)
#define ISR_UNIT_1_NUMBER   (4)
#define ISR_UNIT_2_NUMBER   (0)
#define ISR_UNIT_3_NUMBER   (2)
