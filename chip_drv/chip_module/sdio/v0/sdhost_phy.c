...
PUBLIC uint32 SDHOST_SD_Clk_Freq_Set (SDHOST_HANDLE sdhost_handler,uint32 sdio_clk)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_552_112_2_17_23_6_15_1117,(uint8*)"d",clkDiv);
    ...
    if (256 < clkDiv)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_559_112_2_17_23_6_15_1118,(uint8*)"d",clkDiv);
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_615_112_2_17_23_6_15_1119,(uint8*)"d",sdhost_handler->sdClock/1000);
...
LOCAL void _GetSDHOSTCapbility (SDHOST_HANDLE sdhost_handler,SDHOST_CAPBILIT_T *capbility)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1283_112_2_17_23_6_16_1120,(uint8*)"d",sdhost_handler->capbility.capbility_function);
    //SDHOST_PRINT:"cability_Max_BlkLen = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1284_112_2_17_23_6_16_1121,(uint8*)"d",sdhost_handler->capbility.cability_Max_BlkLen);
    //SDHOST_PRINT:"sd_Base_Max_Clk = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1285_112_2_17_23_6_16_1122,(uint8*)"d",sdhost_handler->capbility.sd_Base_Max_Clk);
    //SDHOST_PRINT:"timeOut_Clk_unit = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1286_112_2_17_23_6_16_1123,(uint8*)"d",sdhost_handler->capbility.timeOut_Clk_unit);
    //SDHOST_PRINT:"timeOut_Base_Clk = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1287_112_2_17_23_6_16_1124,(uint8*)"d",sdhost_handler->capbility.timeOut_Base_Clk);
    //SDHOST_PRINT:"max_current_for_1_8 = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1288_112_2_17_23_6_16_1125,(uint8*)"d",sdhost_handler->capbility.max_current_for_1_8);
    //SDHOST_PRINT:"max_current_for_3_0 = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1289_112_2_17_23_6_16_1126,(uint8*)"d",sdhost_handler->capbility.max_current_for_3_0);
    //SDHOST_PRINT:"max_current_for_3_3 = %x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SDHOST_PHY_1290_112_2_17_23_6_16_1127,(uint8*)"d",sdhost_handler->capbility.max_current_for_3_3);
}
...
PUBLIC SDHOST_HANDLE SDHOST_Register (SDHOST_SLOT_NO slot_NO,SDIO_CALLBACK fun)
{
...
#ifndef OS_NONE
        // Get SDIO device handle, enable SDIO
        SCI_ASSERT (DEVICE_Find ("SDIO", &s_dev_sdio) == CLOCK_SUCCESS);/*assert verified*/
        DEVICE_Open (s_dev_sdio);
        DEVICE_Reset (s_dev_sdio);
#else
	    REG32 (AHB_CTL0)     |= BIT_4;
    ...
    {
        sdio_port_ctl[slot_NO].baseClock = SDHOST_BaseClk_Set (SDIO_BASE_CLK);
    }
    else
    {
