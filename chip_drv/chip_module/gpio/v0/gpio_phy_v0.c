...
LOCAL BOOLEAN _GPIO_GetGpioDataRegAddr (GPIO_INFO_T *pGpio_info, uint32 *pOffsetAddr)
{
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_INVALID:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_194_112_2_17_23_4_45_992,(uint8*)"");
...
PUBLIC void GPIO_PHY_SetPinData (GPIO_INFO_T *pGpio_info ,BOOLEAN b_on)
{
    ...
    GPIO_REG_SET (reg_addr, ( (GPIO_REG32 (reg_addr) & ~ (1UL<<pGpio_info->bit_num)) |
...
LOCAL BOOLEAN _GPIO_GetGpioDataMaskRegAddr (GPIO_INFO_T *pGpio_info, uint32 *pOffsetAddr)
{
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_263_112_2_17_23_4_45_993,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return SCI_FALSE;
        default:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_267_112_2_17_23_4_45_994,(uint8*)"");
            SCI_ASSERT (0);/*assert to do*/
...
LOCAL BOOLEAN _GPIO_GetGpioIntMaskAddr (GPIO_INFO_T *pGpio_info, uint32 *pOffsetAddr)
{
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_GPO:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_323_112_2_17_23_4_45_995,(uint8*)"");
            return SCI_FALSE;
        ...
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_331_112_2_17_23_4_45_996,(uint8*)"");
            return SCI_FALSE;
...
PUBLIC BOOLEAN GPIO_PHY_GetDirection (GPIO_INFO_T *pGpio_info)
{
    ...
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_431_112_2_17_23_4_45_997,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return SCI_FALSE;
    ...
    switch (pGpio_info->gpio_type)
    {
        case GPIO_SECTION_GPI:
            ...
            if (directions)
            {
                ...
                SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_458_112_2_17_23_4_45_998,(uint8*)"");
                GPIO_SECTION_ASSERT(0);/*assert to do*/
            }
        ...
        case GPIO_SECTION_GPO:
            ...
            {
                //GPIO_PRINT:"[GPIO_DRV]GPIO_SetDirection error"
                SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_468_112_2_17_23_4_45_999,(uint8*)"");
                GPIO_SECTION_ASSERT(0);/*assert to do*/
            }
        ...
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_478_112_2_17_23_4_45_1000,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return;
...
PUBLIC BOOLEAN GPIO_PHY_GetIntState (GPIO_INFO_T *pGpio_info)
{
    ...
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_GPO:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_509_112_2_17_23_4_45_1001,(uint8*)"");
            return SCI_FALSE;
        ...
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_516_112_2_17_23_4_45_1002,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return SCI_FALSE;
...
PUBLIC void GPIO_PHY_ClearIntStatus (GPIO_INFO_T *pGpio_info)
{
    ...
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_GPO:
            //GPIO_PRINT:"[GPIO_DRV]this opretion can not belong to GPO"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_546_112_2_17_23_4_45_1003,(uint8*)"");
            return;
        case GPIO_SECTION_GPIO:
            reg_addr += GPIO_IC;
            break;
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_552_112_2_17_23_4_45_1004,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return;
...
PUBLIC void GPIO_PHY_SetInterruptSense (GPIO_INFO_T *pGpio_info, GPIO_INT_TYPE sensetype)
{
    switch (pGpio_info->gpio_type)
    {
        case GPIO_SECTION_GPI:
            {
                switch (sensetype)
                {
                    ...
                    case GPIO_INT_LEVEL_LOW:    // detect low level.
                        GPIO_REG_AND ( (pGpio_info->baseAddr + GPI_IEV), ~ (0x1UL << pGpio_info->bit_num));
                        break;
                    ...
                    default:
                        ...
                        SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_589_112_2_17_23_4_46_1005,(uint8*)"");
                        SCI_ASSERT (0);/*assert to do*/
                        break;
                }
            }
        ...
        case GPIO_SECTION_GPO:
            //GPIO_PRINT:"[GPIO_DRV]this opretion can not belong to GPO"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_597_112_2_17_23_4_46_1006,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return;
        ...
        case GPIO_SECTION_GPIO:
            {
                ...
                {
                    case GPIO_INT_LEVEL_HIGH:   // detect high level.
                        GPIO_REG_OR ( (pGpio_info->baseAddr + GPIO_IS), (0x1UL << pGpio_info->bit_num));
                        GPIO_REG_AND ( (pGpio_info->baseAddr + GPIO_IBE), ~ (0x1UL << pGpio_info->bit_num));
                    ...
                    case GPIO_INT_LEVEL_LOW:    // detect low level.
                        ...
                        GPIO_REG_AND ( (pGpio_info->baseAddr + GPIO_IBE), ~ (0x1UL <<pGpio_info->bit_num));
                        GPIO_REG_AND ( (pGpio_info->baseAddr + GPIO_IEV), ~ (0x1UL <<pGpio_info->bit_num));
                        break;

                    case GPIO_INT_EDGES_BOTH:    // detect the rising edges and falling edges.
                        GPIO_REG_AND ( (pGpio_info->baseAddr + GPIO_IS), ~ (0x1UL << pGpio_info->bit_num));
                    ...
                    default:
                        ...
                        SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_636_112_2_17_23_4_46_1007,(uint8*)"");
                }
            }
            break;
        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_641_112_2_17_23_4_46_1008,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return;
        default:
            SCI_ASSERT (0);/*assert to do*/
...
PUBLIC void GPIO_PHY_SetGPIDebounce (GPIO_INFO_T *pGpio_info, uint8 debounce_period)
{
    ...
    if (i == size)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_677_112_2_17_23_4_46_1009,(uint8*)"");
        return;
    }
...
PUBLIC void GPIO_PHY_TrigGPIDetect (GPIO_INFO_T *pGpio_info)
{
    ...
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_GPIO:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_715_112_2_17_23_4_46_1010,(uint8*)"");
            return;

        case GPIO_SECTION_INVALID:
            //GPIO_PRINT:"[GPIO_DRV]the GPIO_ID is Invalid in this chip"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,GPIO_PHY_V0_719_112_2_17_23_4_46_1011,(uint8*)"");
            GPIO_SECTION_ASSERT(0);/*assert to do*/
            return;
