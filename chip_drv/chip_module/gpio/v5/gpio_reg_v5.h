 ...
 ******************************************************************************/
#ifndef _GPIO_REG_V5_H_
#define _GPIO_REG_V5_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
#define GPIO_PG0_BASE               (GPIO_BASE) //  GPIO 15~0       Register Base Address   =GPIO_ID(15-0)
#define GPIO_PG0_NUM                      0x10  //  GPIO 15~0

#define GPIO_PG1_BASE               (GPIO_PG_BASE + 0x0080) //  GPIO 31~16  Register Base Address   =GPIO_ID(31-16)
#define GPIO_PG1_NUM                      0x10  //  GPIO 31~16

#define GPIO_PG2_BASE               (GPIO_PG_BASE + 0x0100) //  GPIO 47~32      Register Base Address   =GPIO_ID(47-32)
#define GPIO_PG2_NUM                      0x10  //  GPIO 47~32

#define GPIO_PG3_BASE               (GPIO_PG_BASE + 0x0180) //  GPIO 63~48  Register Base Address   =GPIO_ID(63-48)
#define GPIO_PG3_NUM                      0x10  //  GPIO 63~48

#define GPIO_PG4_BASE               (GPIO_PG_BASE + 0x0200) //  GPIO 79~64      Register Base Address   =GPIO_ID(79-64)
#define GPIO_PG4_NUM                      0x10  //  GPIO 79~64

#define GPIO_PG5_BASE               (GPIO_PG_BASE + 0x0280) //  GPIO 95~80  Register Base Address   =GPIO_ID(95-80)
#define GPIO_PG5_NUM                      0x10  //  GPIO 95~80

#define GPIO_PG6_BASE               (GPIO_PG_BASE + 0x0300) //  GPIO 111~96         Register Base Address   =GPIO_ID(111-96)
#define GPIO_PG6_NUM                      0x10  //  GPIO 111~96

#define GPIO_PG7_BASE               (GPIO_PG_BASE + 0x0380) //  GPIO 117~112    Register Base Address   =GPIO_ID(117-112)
#define GPIO_PG7_NUM                      0x10  //  GPIO 112~127
