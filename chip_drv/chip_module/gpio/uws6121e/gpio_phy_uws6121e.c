...
#ifndef GPIO_INTSET_R_OFFSET
#define GPIO_INTSET_R_OFFSET    0x18
#endif

#ifndef GPIO_INTCLR_R_OFFSET
#define GPIO_INTCLR_R_OFFSET    0x1C
#endif

#ifndef GPIO_INTSET_F_OFFSET
#define GPIO_INTSET_F_OFFSET    0x38
#endif

#ifndef GPIO_INTCLR_F_OFFSET
#define GPIO_INTCLR_F_OFFSET    0x3C
#endif

#ifndef GPIO_DBN_EN_SET_OFFSET
#define GPIO_DBN_EN_SET_OFFSET    0x40
#endif

#ifndef GPIO_DBN_EN_CLR_OFFSET
#define GPIO_DBN_EN_CLR_OFFSET    0x44
#endif

#ifndef GPIO_INTSET_MODE_OFFSET
#define GPIO_INTSET_MODE_OFFSET    0x48
#endif

#ifndef GPIO_INTCLR_MODE_OFFSET
#define GPIO_INTCLR_MODE_OFFSET    0x4C
#endif
...
extern GPIO_INT_TYPE g_gpio_inttype[32];

typedef struct
{
    uint32 dbn_en_set_reg;
    uint32 gpint_ctrl_f_set_reg;
    uint32 gpint_ctrl_r_set_reg;
    uint32 gpint_mode_set_reg;
    uint32 gpio_oen_val;
    uint32 gpio_val_reg;
} GPIO_regs_t;
...
typedef struct
{
//    GPIO_regs_t gpio1_reg;
    GPIO_regs_t gpio2_reg;
} GPIO_suspend_regs_t;

GPIO_suspend_regs_t gpioctx = {0};


/**
 * GPIO suspend callback
 */
void _gpioSuspend(void)
{
#if 0
    gpioctx.gpio1_reg.dbn_en_set_reg = hwp_gpio1->dbn_en_set_REG;
    gpioctx.gpio1_reg.gpint_ctrl_f_set_reg = hwp_gpio1->gpint_ctrl_f_set_REG;
    gpioctx.gpio1_reg.gpint_ctrl_r_set_reg = hwp_gpio1->gpint_ctrl_r_set_REG;
    gpioctx.gpio1_reg.gpint_mode_set_reg = hwp_gpio1->gpint_mode_set_REG;
    gpioctx.gpio1_reg.gpio_oen_val = hwp_gpio1->gpio_oen_val;
    gpioctx.gpio1_reg.gpio_val_reg = hwp_gpio1->gpio_val_REG;
#endif
    gpioctx.gpio2_reg.dbn_en_set_reg = hwp_gpio2->dbn_en_set_REG;
    gpioctx.gpio2_reg.gpint_ctrl_f_set_reg = hwp_gpio2->gpint_ctrl_f_set_REG;
    gpioctx.gpio2_reg.gpint_ctrl_r_set_reg = hwp_gpio2->gpint_ctrl_r_set_REG;
    gpioctx.gpio2_reg.gpint_mode_set_reg = hwp_gpio2->gpint_mode_set_REG;
    gpioctx.gpio2_reg.gpio_oen_val = hwp_gpio2->gpio_oen_val;
    gpioctx.gpio2_reg.gpio_val_reg = hwp_gpio2->gpio_val_REG;
}

/**
 * GPIO resume callback
 */
void _gpioResume(void)
{
#if 0
    ...
    hwp_gpio1->dbn_en_set_REG = gpioctx.gpio1_reg.dbn_en_set_reg;
    hwp_gpio1->gpint_ctrl_f_set_REG = gpioctx.gpio1_reg.gpint_ctrl_f_set_reg;
    hwp_gpio1->gpint_ctrl_r_set_REG = gpioctx.gpio1_reg.gpint_ctrl_r_set_reg;
    hwp_gpio1->gpint_mode_set_REG = gpioctx.gpio1_reg.gpint_mode_set_reg;
    hwp_gpio1->gpio_oen_val = gpioctx.gpio1_reg.gpio_oen_val;
    hwp_gpio1->gpio_val_REG = gpioctx.gpio1_reg.gpio_val_reg;
#endif
    hwp_gpio2->gpint_ctrl_r_clr_REG = 0xffffffff;
    hwp_gpio2->gpint_ctrl_f_clr_REG = 0xffffffff;
    hwp_gpio2->dbn_en_clr_REG = 0xffffffff;
    hwp_gpio2->gpint_mode_clr_REG = 0xffffffff;

    hwp_gpio2->dbn_en_set_REG = gpioctx.gpio2_reg.dbn_en_set_reg;
    hwp_gpio2->gpint_ctrl_f_set_REG = gpioctx.gpio2_reg.gpint_ctrl_f_set_reg;
    hwp_gpio2->gpint_ctrl_r_set_REG = gpioctx.gpio2_reg.gpint_ctrl_r_set_reg;
    hwp_gpio2->gpint_mode_set_REG = gpioctx.gpio2_reg.gpint_mode_set_reg;
    hwp_gpio2->gpio_oen_val = gpioctx.gpio2_reg.gpio_oen_val;
    hwp_gpio2->gpio_val_REG = gpioctx.gpio2_reg.gpio_val_reg;
}
...
LOCAL BOOLEAN _GPIO_GetGpioIntMaskAddr (GPIO_INFO_T *pGpio_info, uint32 *pOffsetAddr)
{
    switch (pGpio_info->gpio_type)
    {
        ...
        case GPIO_SECTION_GPIO:
            *pOffsetAddr = GPIO_INTSET_R_OFFSET;
            break;
...
PUBLIC BOOLEAN GPIO_PHY_GetIntIsMask (GPIO_INFO_T *pGpio_info)
{
    ...
    {
        reg_addr += offsetAddr;
        return ( ((GPIO_REG32 (reg_addr) & (GPIO_GPINT_CTRL_R_SET(1 << pGpio_info->bit_num))) || (GPIO_REG32 (reg_addr+0x20) & (GPIO_GPINT_CTRL_R_SET(1 << pGpio_info->bit_num)))) ? SCI_TRUE : SCI_FALSE);
    }
...
PUBLIC void GPIO_PHY_SetIntMask (GPIO_INFO_T *pGpio_info)
{
    ...
    if (_GPIO_GetGpioIntMaskAddr (pGpio_info, &offsetAddr))
    {
        ...
        switch(g_gpio_inttype[pGpio_info->bit_num])
        {
            ...
            {
                GPIO_REG_SET (reg_addr, (GPIO_GPINT_CTRL_R_SET(1 << pGpio_info->bit_num)));
                break;
            }
            case GPIO_INT_LEVEL_LOW:
            case GPIO_INT_EDGES_FALLING:
            {
                GPIO_REG_SET (reg_addr+0x20, (GPIO_GPINT_CTRL_R_SET(1 << pGpio_info->bit_num)));
                break;
            }
...
PUBLIC void GPIO_PHY_CleanIntMask (GPIO_INFO_T *pGpio_info)
{
    ...
    {
        reg_addr += offsetAddr + 0x4;
        GPIO_REG_SET (reg_addr, (GPIO_GPINT_CTRL_R_CLR(1 << pGpio_info->bit_num)));
        GPIO_REG_SET (reg_addr + 0x20, (GPIO_GPINT_CTRL_R_CLR(1 << pGpio_info->bit_num)));
    }
        ...
        case GPIO_SECTION_GPIO:
            {
                switch (sensetype)
                {
                    case GPIO_INT_LEVEL_HIGH:   // detect high level.
                        gpio_int_ctrl = GPIO_GPINT_CTRL_R_SET(gpio_bit); 
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_R_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_F_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_MODE_OFFSET), gpio_int_ctrl); 
                        g_gpio_inttype[pGpio_info->bit_num] = GPIO_INT_LEVEL_HIGH;
                        break;

                    case GPIO_INT_LEVEL_LOW:    // detect low level.
                        gpio_int_ctrl = GPIO_GPINT_CTRL_F_SET(gpio_bit); 
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_F_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_R_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_MODE_OFFSET), gpio_int_ctrl);         
                        g_gpio_inttype[pGpio_info->bit_num] = GPIO_INT_LEVEL_LOW;
                        break;
                    ...
                    case GPIO_INT_EDGES_BOTH:    // detect the rising edges and falling edges.
                        ...
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_R_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_F_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_MODE_OFFSET), gpio_int_ctrl);        
                        g_gpio_inttype[pGpio_info->bit_num] = GPIO_INT_EDGES_BOTH;
                        break;
                    ...
                    case GPIO_INT_EDGES_RISING:  // detect the rising edges.
                        ...
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_F_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_MODE_OFFSET), gpio_int_ctrl);       
                        g_gpio_inttype[pGpio_info->bit_num] = GPIO_INT_EDGES_RISING;
                        break;
                    ...
                    case GPIO_INT_EDGES_FALLING:
                        ...
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTSET_F_OFFSET), gpio_int_ctrl);
                        GPIO_REG_SET ( (pGpio_info->baseAddr + GPIO_INTCLR_MODE_OFFSET), gpio_int_ctrl);   
                        g_gpio_inttype[pGpio_info->bit_num] = GPIO_INT_EDGES_FALLING;
                        break;
...
PUBLIC void GPIO_PHY_SetGPIDebounce (GPIO_INFO_T *pGpio_info, uint8 debounce_period)
{
    ...
    {
        GPIO_REG_SET (reg_addr + GPIO_DBN_EN_SET_OFFSET, GPIO_DBN_EN_SET(gpio_bit));
    }
    else// not recommend
    {
        GPIO_REG_SET (reg_addr + GPIO_DBN_EN_CLR_OFFSET, GPIO_DBN_EN_SET(gpio_bit)); //bypass mode
    }
