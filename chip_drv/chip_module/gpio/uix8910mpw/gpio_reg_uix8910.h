...
#endif
#if defined(REG_ADDRESS_FOR_GGE)
#define REG_GPIO2_BASE             0x0510B000
#else
...
typedef union {
    REG32 v;
    struct {
        REG32 gpint_r_set : 8; // [7:0], write set
        REG32 gpint_f_set : 8; // [15:8], write set
        REG32 dbn_en_set : 8; // [23:16], write set
        REG32 gpint_mode_set : 8; // [31:24], write set
    } b;
} REG_GPIO_GPINT_CTRL_SET_T;

//gpint_ctrl_clr
typedef union {
    REG32 v;
    struct {
        REG32 gpint_r_clr : 8; // [7:0], write clear
        REG32 gpint_f_clr : 8; // [15:8], write clear
        REG32 dbn_en_clr : 8; // [23:16], write clear
        REG32 gpint_mode_clr : 8; // [31:24], write clear
    } b;
} REG_GPIO_GPINT_CTRL_CLR_T;

//int_clr
typedef union {
    REG32 v;
    struct {
        REG32 gpint_clr : 8; // [7:0], write clear
        REG32 __31_8 : 24;
    } b;
} REG_GPIO_INT_CLR_T;
...
typedef union {
    REG32 v;
    struct {
        REG32 gpint_status : 8; // [7:0], read only
        REG32 __31_8 : 24;
    } b;
} REG_GPIO_INT_STATUS_T;
...
#define GPIO_OEN_VAL_MASK          (0xFFFFFFFF<<0)
#define GPIO_OEN_VAL_SHIFT         (0)
...
#define GPIO_OEN_SET_OUT_MASK      (0xFFFFFFFF<<0)
#define GPIO_OEN_SET_OUT_SHIFT     (0)

//gpio_oen_set_in
#define GPIO_OEN_SET_IN(n)         (((n)&0xFFFFFFFF)<<0)
#define GPIO_OEN_SET_IN_MASK       (0xFFFFFFFF<<0)
#define GPIO_OEN_SET_IN_SHIFT      (0)

//gpio_val_REG
#define GPIO_GPIO_VAL(n)           (((n)&0xFFFFFFFF)<<0)
#define GPIO_GPIO_VAL_MASK         (0xFFFFFFFF<<0)
#define GPIO_GPIO_VAL_SHIFT        (0)

//gpio_set_REG
#define GPIO_GPIO_SET(n)           (((n)&0xFFFFFFFF)<<0)
#define GPIO_GPIO_SET_MASK         (0xFFFFFFFF<<0)
#define GPIO_GPIO_SET_SHIFT        (0)

//gpio_clr_REG
#define GPIO_GPIO_CLR(n)           (((n)&0xFFFFFFFF)<<0)
#define GPIO_GPIO_CLR_MASK         (0xFFFFFFFF<<0)
#define GPIO_GPIO_CLR_SHIFT        (0)

//gpint_ctrl_set
#define GPIO_GPINT_R_SET(n)        (((n)&0xFF)<<0)
#define GPIO_GPINT_R_SET_MASK      (0xFF<<0)
#define GPIO_GPINT_R_SET_SHIFT     (0)
#define GPIO_GPINT_F_SET(n)        (((n)&0xFF)<<8)
#define GPIO_GPINT_F_SET_MASK      (0xFF<<8)
#define GPIO_GPINT_F_SET_SHIFT     (8)
#define GPIO_DBN_EN_SET(n)         (((n)&0xFF)<<16)
#define GPIO_DBN_EN_SET_MASK       (0xFF<<16)
#define GPIO_DBN_EN_SET_SHIFT      (16)
#define GPIO_GPINT_MODE_SET(n)     (((n)&0xFF)<<24)
#define GPIO_GPINT_MODE_SET_MASK   (0xFF<<24)
#define GPIO_GPINT_MODE_SET_SHIFT  (24)

//gpint_ctrl_clr
#define GPIO_GPINT_R_CLR(n)        (((n)&0xFF)<<0)
#define GPIO_GPINT_R_CLR_MASK      (0xFF<<0)
#define GPIO_GPINT_R_CLR_SHIFT     (0)
#define GPIO_GPINT_F_CLR(n)        (((n)&0xFF)<<8)
#define GPIO_GPINT_F_CLR_MASK      (0xFF<<8)
#define GPIO_GPINT_F_CLR_SHIFT     (8)
#define GPIO_DBN_EN_CLR(n)         (((n)&0xFF)<<16)
#define GPIO_DBN_EN_CLR_MASK       (0xFF<<16)
#define GPIO_DBN_EN_CLR_SHIFT      (16)
#define GPIO_GPINT_MODE_CLR(n)     (((n)&0xFF)<<24)
#define GPIO_GPINT_MODE_CLR_MASK   (0xFF<<24)
#define GPIO_GPINT_MODE_CLR_SHIFT  (24)

//int_clr
#define GPIO_GPINT_CLR(n)          (((n)&0xFF)<<0)
#define GPIO_GPINT_CLR_MASK        (0xFF<<0)
#define GPIO_GPINT_CLR_SHIFT       (0)
...
#define GPIO_OUT_TIME_MASK         (15<<0)
#define GPIO_OUT_TIME_SHIFT        (0)
#define GPIO_WAIT_TIME(n)          (((n)&0x3F)<<4)
#define GPIO_WAIT_TIME_MASK        (0x3F<<4)
#define GPIO_WAIT_TIME_SHIFT       (4)
#define GPIO_INT_MODE(n)           (((n)&3)<<16)
#define GPIO_INT_MODE_MASK         (3<<16)
...
#define GPIO_DCON_MODE_SET_MASK    (1<<0)
#define GPIO_DCON_MODE_SET_SHIFT   (0)
#define GPIO_CHG_MODE_SET          (1<<4)
#define GPIO_CHG_MODE_SET_MASK     (1<<4)
#define GPIO_CHG_MODE_SET_SHIFT    (4)
#define GPIO_DCON_MODE_CLR         (1<<8)
#define GPIO_DCON_MODE_CLR_MASK    (1<<8)
#define GPIO_DCON_MODE_CLR_SHIFT   (8)
#define GPIO_CHG_MODE_CLR          (1<<12)
#define GPIO_CHG_MODE_CLR_MASK     (1<<12)
#define GPIO_CHG_MODE_CLR_SHIFT    (12)
#define GPIO_CHG_DOWN              (1<<24)
#define GPIO_CHG_DOWN_MASK         (1<<24)
#define GPIO_CHG_DOWN_SHIFT        (24)

//gpo_set_REG
#define GPIO_GPO_SET(n)            (((n)&0xFF)<<0)
#define GPIO_GPO_SET_MASK          (0xFF<<0)
#define GPIO_GPO_SET_SHIFT         (0)

//gpo_clr_REG
#define GPIO_GPO_CLR(n)            (((n)&0xFF)<<0)
#define GPIO_GPO_CLR_MASK          (0xFF<<0)
#define GPIO_GPO_CLR_SHIFT         (0)
