/******************************************************************************
 ** File Name:      sprd_codec_dp_phy_v1.h                                    *
 ** Author:         ken.kuang                                                 *
 ** DATE:           12/12/2011                                                *
...
#ifndef __SPRD_CODEC_DP_PHY_V1_H___
#define __SPRD_CODEC_DP_PHY_V1_H___
...
//dac_sdm_dc_l
#define DAC_SDM_DC_L_SHIFT      (0)
#define DAC_SDM_DC_L_MASK       (0xFFFF<<DAC_SDM_DC_L_SHIFT)

//dac_sdm_dc_h
#define DAC_SDM_DC_H_SHIFT      (0)
#define DAC_SDM_DC_H_MASK       (0xFF<<DAC_SDM_DC_H_SHIFT)
#endif
...
typedef struct{
    ...
    uint32  int_en;     //0028
#ifdef CHIP_VER_6531EFM
    uint32  if_fifo_ctl;     //002c
    uint32  dmic_ctl;        //0030
    uint32  reserved;        //0034
    uint32  dac_sdm_dc_l;    //0038
    uint32  dac_sdm_dc_h;    //003c
    uint32  if_ctl0;         //0040
    uint32  if_adc_fifo_sts; //0044
    uint32  if_dac_fifo_sts; //0048
    uint32  if_sts;          //004c
    uint32  if_fifo_raw_sts; //0050
    uint32  if_fifo_raw_clr; //0054
#endif
}SPRD_CODEC_DP_CTL_T;

#endif //__SPRD_CODEC_DP_PHY_V1_H___
