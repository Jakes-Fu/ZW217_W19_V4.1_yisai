/******************************************************************************
 ** File Name:      sprd_codec_ap_phy_v0.h                                    *
 ** Author:         ken.kuang                                                 *
 ** DATE:           12/12/2011                                                *
...
#ifndef __SPRD_CODEC_AP_PHY_V0_H___
#define __SPRD_CODEC_AP_PHY_V0_H___
#include "Chip_plf_export.h"


//audif_enb
#define AUDIF_DAC_EN_L          (BIT_0)
#define AUDIF_ADC_EN_L          (BIT_1)
#define AUDIF_DAC_EN_R          (BIT_2)
#define AUDIF_ADC_EN_R          (BIT_3)
...
#define PA_SHUTDOWN_EN0         (BIT_3)
#define PA_SHUTDOWN_EN1         (BIT_4)
#define PA_SHUTDOWN_EN2         (BIT_5)
#define AUDIO_CLK_SEL           (BIT_6)

//audif_int_en
#define HP_OCP_IRQ_EN           (BIT_0)
#define EAR_OCP_IRQ_EN          (BIT_1)
#define LO_OCP_IRQ_EN           (BIT_2)
#define PA_OCP_IRQ_EN           (BIT_3)
#define OTP_IRQ_EN              (BIT_4)
#define AUDIO_POP_IRQ_EN        (BIT_5)
#define OVP_IRQ_EN              (BIT_6)

//audif_int_clr
#define HP_OCP_IRQ_CLR          (BIT_0)
#define EAR_OCP_IRQ_CLR         (BIT_1)
#define LO_OCP_IRQ_CLR          (BIT_2)
#define PA_OCP_IRQ_CLR          (BIT_3)
#define OTP_IRQ_CLR             (BIT_4)
#define AUDIO_POP_IRQ_CLR       (BIT_5)
#define OVP_IRQ_CLR             (BIT_6)

//audif_int_raw
#define HP_OCP_IRQ              (BIT_0)
#define EAR_OCP_IRQ             (BIT_1)
#define LO_OCP_IRQ              (BIT_2)
#define PA_OCP_IRQ              (BIT_3)
#define OTP_IRQ                 (BIT_4)
#define AUDIO_POP_IRQ           (BIT_5)
#define OVP_IRQ                 (BIT_6)

//audif_int_mask
#define HP_OCP_IRQ_MASK         (BIT_0)
#define EAR_OCP_IRQ_MASK        (BIT_1)
#define LO_OCP_IRQ_MASK         (BIT_2)
#define PA_OCP_IRQ_MASK         (BIT_3)
#define OTP_IRQ_MASK            (BIT_4)
#define AUDIO_POP_IRQ_MASK      (BIT_5)
...
#define BG_IBIAS_EN             (BIT_1)
#define MICBIAS_EN              (BIT_2)
#define AUD_BG_EN               (BIT_3)
#define VBO_EN                  (BIT_4)
#define VB_EN                   (BIT_5)
#define VCM_BUF_EN              (BIT_6)
#define AUD_VCM_EN              (BIT_7)

//pmur2

#define OVP_LDO_EN              (BIT_0)
#define OVP_PD                  (BIT_1)
#define SPKR_EN                 (BIT_2)
#define PA_EN                   (BIT_3)
#define SPKR_LDO_EN             (BIT_4)
#define PA_LDO_EN               (BIT_5)
#define SPKR_SW_EN              (BIT_6)
#define PA_SW_EN                (BIT_7)

//pmur3
#define MICBIAS_V_SHIFT         (1)
#define MICBIAS_V_MASK          (0x3<<MICBIAS_V_SHIFT)

#define AUD_BG_I_SHIFT          (3)
#define AUD_BG_I_MASK           (0x3<<AUD_BG_I_SHIFT)

#define AUD_BG_RST              (BIT_5)

#define AUD_VCM_V_SHIFT         (6)
#define AUD_VCM_V_MASK          (0x3<<AUD_VCM_V_SHIFT)
...
//daocr1
#define DAC_ADCPGAR_BUFN_SPN    (BIT_0)
#define DAC_ADCPGAR_BUFP_SPP    (BIT_1)
#define DAC_ADCPGAR_BUFP_HPR    (BIT_2)
#define DAC_ADCPGAR_BUFP_HPL    (BIT_3)
#define DAC_ADCPGAL_BUFN_SPN    (BIT_4)
#define DAC_ADCPGAL_BUFP_SPP    (BIT_5)
...
#define DAC_DACR_HPR            (BIT_2)
#define DAC_DACR_HPL            (BIT_3)
#define DAC_DACL_SPN            (BIT_4)
#define DAC_DACL_SPP            (BIT_5)
#define DAC_DACL_HPR            (BIT_6)
#define DAC_DACL_HPL            (BIT_7)
...
#endif //__SPRD_CODEC_AP_PHY_V0_H___
