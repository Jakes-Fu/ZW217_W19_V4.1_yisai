...
PUBLIC int32 __vbc_dma_da_chan_cfg(DMA_CHNCFG_T * pCfg,uint32 chan)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V3_435_112_2_17_23_3_18_361,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
...
PUBLIC int32 __vbc_dma_ad_chan_cfg(DMA_CHNCFG_T * pCfg,uint32 chan)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V3_467_112_2_17_23_3_18_362,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
    pCfg->requestmode       = DMA_CHN_REQMODE_NORMAL;
...
PUBLIC int32 __vbc_dma_dac_chan_en(DMA_CHNCFG_T * pCfg,uint32 chan_id)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V3_500_112_2_17_23_3_18_363,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
...
PUBLIC int32 __vbc_dma_adc_chan_en(DMA_CHNCFG_T * pCfg,uint32 chan_id)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V3_528_112_2_17_23_3_18_364,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
