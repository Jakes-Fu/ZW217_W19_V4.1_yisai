 ...
 *****************************************************************************/
#ifndef _VBC_PHY_V6_H_
#define _VBC_PHY_V6_H_
...
#define VBDATASWT               (ARM_VBC_BASE+0x0038)
#define VBIISSEL                (ARM_VBC_BASE+0x003C)
...
//notch tone control
#define DANCHCTL                 (ARM_VBC_BASE+0x0088)
#define DANCH_PTSINMW            (ARM_VBC_BASE+0x008c)
#define DANCH_PTSINLW            (ARM_VBC_BASE+0x0090)
#define DANCH_PTCOSMW            (ARM_VBC_BASE+0x0094)
#define DANCH_PTCOSLW            (ARM_VBC_BASE+0x0098)
#define DANCH_PTGL               (ARM_VBC_BASE+0x009c)
#define DANCH_PTGR               (ARM_VBC_BASE+0x00a0)
#define DANCH_PTGD               (ARM_VBC_BASE+0x00a4)
#define DANCH_PTGU               (ARM_VBC_BASE+0x00a8)
#define DANCH_PTH                (ARM_VBC_BASE+0x00ac)
#define DANCH_VTSINMW            (ARM_VBC_BASE+0x00b0)
#define DANCH_VTSINLW            (ARM_VBC_BASE+0x00b4)
#define DANCH_VTCOSMW            (ARM_VBC_BASE+0x00b8)
#define DANCH_VTCOSLW            (ARM_VBC_BASE+0x00bc)
#define DANCH_VTGL               (ARM_VBC_BASE+0x00c0)
#define DANCH_VTGR               (ARM_VBC_BASE+0x00c4)
#define DANCH_VTGD               (ARM_VBC_BASE+0x00c8)
#define DANCH_VTGU               (ARM_VBC_BASE+0x00cc)
#define DANCH_VTH                (ARM_VBC_BASE+0x00d0)
#define DANCH_STS                (ARM_VBC_BASE+0x00d4)
...
#define VBFIFOLVL               (ARM_VBC_BASE+0x01C0)
...
//VBDATASWT
#define VBDATASWT_BUF_IN            (BIT_0)
#define VBDATASWT_BUF_OUT           (BIT_1)

//VBIISSEL
#define VBIISSEL_AD_PORT_SHIFT      (0)
#define VBIISSEL_AD_PORT_MASK       (0x3<<VBIISSEL_AD_PORT_SHIFT)

#define VBIISSEL_DA_PORT_SHIFT      (2)
#define VBIISSEL_DA_PORT_MASK       (0x3<<VBIISSEL_DA_PORT_SHIFT)

#define VBIISSEL_AD_LSB_MODE        (BIT_4)
#define VBIISSEL_DA_LSB_MODE        (BIT_5)

#define VBIISSEL_AD_PCM_MODE        (BIT_6)
#define VBIISSEL_DA_PCM_MODE        (BIT_7)

#define VBIISSEL_AD_LRCK            (BIT_8)
#define VBIISSEL_DA_LRCK            (BIT_9)
