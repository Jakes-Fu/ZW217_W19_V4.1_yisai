...
#define ARM_VB_ADLON                ARM_VB_AD0ON
...
#define ARM_VB_ADRON                ARM_VB_AD0ON
...
PUBLIC int32 __vbc_dma_da_chan_cfg(DMA_CHNCFG_T * pCfg,uint32 chan)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V0_419_112_2_17_23_3_16_357,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
...
PUBLIC int32 __vbc_dma_ad_chan_cfg(DMA_CHNCFG_T * pCfg,uint32 chan)
{
    ...
    if( ( AUDIO_CHAN_L==(AUDIO_CHAN_L & (chan)) ) )
    {
        pCfg->src_address   = (uint32) (VBADL+2);
    }
    else if( ( AUDIO_CHAN_R==(AUDIO_CHAN_R & (chan)) ) )
    {
        pCfg->src_address   = (uint32) (VBADR+2);
    }
    else
    {
        //VBC_PHY_PRT:"[AUDDRV][VBC] adc pls set cfg chan."
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V0_451_112_2_17_23_3_16_358,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
    pCfg->requestmode       = DMA_CHN_REQMODE_NORMAL;
...
PUBLIC int32 __vbc_dma_dac_chan_en(DMA_CHNCFG_T * pCfg,uint32 chan_id)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V0_484_112_2_17_23_3_16_359,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
...
PUBLIC int32 __vbc_dma_adc_chan_en(DMA_CHNCFG_T * pCfg,uint32 chan_id)
{
    ...
    else
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,VBC_PHY_V0_512_112_2_17_23_3_16_360,(uint8*)"");
        ret = AUDIO_HAL_ERROR;
    }
