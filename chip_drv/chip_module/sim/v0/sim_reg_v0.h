 ...
 ******************************************************************************/
#ifndef _SIM_REG_V0_H_
#define _SIM_REG_V0_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
// SIM_CTL1
#define SIM_CTL1_RX_INT_MARK_SHIFT      (0)
#define SIM_CTL1_RX_INT_MARK_MASK       (0xF << SIM_CTL1_RX_INT_MARK_SHIFT)
#define SIM_CTL1_TX_INT_MARK_SHIFT      (4)
#define SIM_CTL1_TX_INT_MARK_MASK       (0xF << SIM_CTL1_TX_INT_MARK_SHIFT)
