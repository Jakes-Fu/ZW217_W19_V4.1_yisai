 ...
 ******************************************************************************/
#ifndef _SIM_REG_V5_H_
#define _SIM_REG_V5_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
#define SIM_CTL2                         (SIM0_BASE + 0x003C)
#define SIM_STS2                         (SIM0_BASE + 0x0040)
#define SIM_PROT0                        (SIM0_BASE + 0x0050)
#define SIM_PROT1                        (SIM0_BASE + 0x0054)
#define SIM_PROT2                        (SIM0_BASE + 0x0058)
#define SIM_PROT3                        (SIM0_BASE + 0x005C)
#define SIM_PROT4                        (SIM0_BASE + 0x0060)
#define SIM_PROT5                        (SIM0_BASE + 0x0064)
#define SIM_PROT6                        (SIM0_BASE + 0x0068)
#define SIM_PROT7                        (SIM0_BASE + 0x006C)
...
#define SIM_FIFO_BUF_SIZE               64

// SIM_SEH
#define SIM_SEH_RX_RETRX_LMT_SHIFT      (0)
#define SIM_SEH_RX_RETRX_LMT_MASK       (0xF << SIM_SEH_RX_RETRX_LMT_SHIFT)
#define SIM_SEH_TX_RETRX_LMT_SHIFT      (4)
#define SIM_SEH_TX_RETRX_LMT_MASK       (0xF << SIM_SEH_TX_RETRX_LMT_SHIFT)
#define SIM_SEH_DMA_RX_EN_SHIFT         (8)
#define SIM_SEH_DMA_RX_EN_MASK          (1 << SIM_SEH_DMA_RX_EN_SHIFT)
#define SIM_SEH_DMA_TX_EN_SHIFT         (9)
#define SIM_SEH_DMA_TX_EN_MASK          (1 << SIM_SEH_DMA_TX_EN_SHIFT)

// SIM_CTL2
#define SIM_CTL2_RX_INT_MARK_SHIFT      (0)
#define SIM_CTL2_RX_INT_MARK_MASK       (0x3F << SIM_CTL2_RX_INT_MARK_SHIFT)
#define SIM_CTL2_TX_INT_MARK_SHIFT      (8)
#define SIM_CTL2_TX_INT_MARK_MASK       (0x3F << SIM_CTL2_TX_INT_MARK_SHIFT)

// SIM_CTL1
#define SIM_CTL1_CLOCK_MODE_SHIFT       (8)
#define SIM_CTL1_CLOCK_MODE_MASK        (0x7 << SIM_CTL1_CLOCK_MODE_SHIFT)

#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV2        0
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV4        1
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV8        2
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV16       3
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV32       4
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV64       5
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV128      6
#define SIM_CTL1_CLOCK_MODE_ARM_CLK_DIV256      7
...
#define SIMSTS0_B_TX_OVERRUN            (1 << 10)        //Int status bit to show activation is done
#define SIMSTS0_B_RX_OVERRUN            (1 << 11)        //Int status bit to show activation is done

#define SIMSTS0_REG_MASK                0x39F

//The corresponding bit of SIM_STS1 register.
//Get the RX byte number in the rx fifo,rx_fifo_count--SIM_STS1[3:0]
#define GET_RX_FIFO_COUNT(sim_register_map)     ((sim_register_map)->sts2 & 0x007f)
//Get the TX byte number in the TX fifo,rx_fifo_count--SIM_STS1[8:5]
#define GET_TX_FIFO_COUNT(sim_register_map)     (((sim_register_map)->sts2 & 0x7f00) >> 8)
...
typedef struct sim_tag
{
    ...
    VOLATILE uint32 prot0;
    VOLATILE uint32 prot1;
    VOLATILE uint32 prot2;
    VOLATILE uint32 prot3;
    VOLATILE uint32 prot4;
    VOLATILE uint32 prot5;
    VOLATILE uint32 prot6;
    VOLATILE uint32 prot7;
}sim_s;
#else
typedef struct sim_tag
{
...
#define SET_RX_INT_MARK(sim_register_map,mark)      (((sim_register_map)->ctl2 & 0xffc0) | mark)
...
#define SET_TX_INT_MARK(sim_register_map,mark)      (((sim_register_map)->ctl2 & 0xc0ff) | (mark << 8))
