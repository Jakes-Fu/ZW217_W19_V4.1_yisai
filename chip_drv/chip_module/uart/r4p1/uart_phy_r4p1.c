                                  ...
                                  UART_INIT_PARA_T *para)
{
    ...
    {
        p->xcmd = UART_XON << UART_XON_SHIFT| UART_XOFF;
        p->escape = UART_ESCAPE;    
        // must set the xcmd and escape value before scftl_mode enable
        p->sfctl = SW_FCTL_EN | SW_FCTL_MODE;   
    }
    else
    {
