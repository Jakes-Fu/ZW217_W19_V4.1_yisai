 ...
 ******************************************************************************/
#ifndef _UART_REG_R4P1_H_
#define _UART_REG_R4P1_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
**                               Micro Define                                **
**---------------------------------------------------------------------------*/
#define UART0_RXD_SPC_ENABLE (0x1)
#define UART0_CTSN_SPC_ENABLE (0x2)
#define UART1_RXD_SPC_ENABLE (0x4)
#define USBSE0_SPC_ENABLE (0x10)

#define UART_INT_STS_MASK     0x1f
#define UART0_INT_STS_MASK     0x3
#define UART1_INT_STS_MASK     (0x4)
#define USBINPUT_SE0_INT_STS_MASK     (0x10)
...
#define ARM_UART_SFCTL                  0x0034         
#define ARM_UART_XCMD                   0x0038  //[15:8] XON; [7:0] XOFF
#define ARM_UART_ESCAPE                 0x003C  //[7:0] ESCAPE
...
#define UART_TRANSFER_TIME_OUT 6000 //6000 ms
...
#define UC_RX_HW_FLOW_CTL_EN   BIT_7
#define UC_TX_HW_FLOW_CTL_EN   BIT_8
...
#define SW_FCTL_MODE        BIT_0
#define SW_FCTL_EN          BIT_1

#define UART_XON_SHIFT      0x8
#define UART_XON            0x11
#define UART_XOFF           0x13
#define UART_ESCAPE         0x77
...
typedef struct
{
    ...
    volatile uint32       sfctl;
    volatile uint32       xcmd;
    volatile uint32       escape;
} UART_REG_S;
