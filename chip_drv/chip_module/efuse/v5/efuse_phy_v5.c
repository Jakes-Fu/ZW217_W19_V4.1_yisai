...
)
{
    ...
    switch (blk_hal)
    {
        case EFUSE_HASH_START_ID:
            min_id = EFUSE_PHY_BLK_ID_2;
            max_id = EFUSE_PHY_BLK_ID_6;
            break;
        case EFUSE_IMEI_START_ID:
            min_id = EFUSE_PHY_BLK_ID_3;
            max_id = EFUSE_PHY_BLK_ID_6;
            break;
