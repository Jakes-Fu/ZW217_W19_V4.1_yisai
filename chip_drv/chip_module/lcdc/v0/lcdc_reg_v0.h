 ...
 ******************************************************************************/
#ifndef _LCDC_REG_V0_H_
#define _LCDC_REG_V0_H_
/*----------------------------------------------------------------------------*
 **                          Dependencies                                     *
 **---------------------------------------------------------------------------*/
...
#define REG_OSD3_CTRL                   (REG_LCDC_REG_BASE + 0x00a0)
#define REG_OSD3_BASE_ADDR              (REG_LCDC_REG_BASE + 0x00a4)
#define REG_OSD3_SIZE_XY                (REG_LCDC_REG_BASE + 0x00a8)
#define REG_OSD3_PITCH                  (REG_LCDC_REG_BASE + 0x00ac)
#define REG_OSD3_DISP_XY                (REG_LCDC_REG_BASE + 0x00b0)
#define REG_OSD3_ALPHA                  (REG_LCDC_REG_BASE + 0x00b4)
#define REG_OSD3_GREY_RGB               (REG_LCDC_REG_BASE + 0x00b8)
#define REG_OSD3_CK                     (REG_LCDC_REG_BASE + 0x00bc)

#define REG_CAP_CTRL                    (REG_LCDC_REG_BASE + 0x00d0)
#define REG_CAP_BASE_ADDR               (REG_LCDC_REG_BASE + 0x00d4)
#define REG_CAP_START_XY                (REG_LCDC_REG_BASE + 0x00d8)
#define REG_CAP_SIZE_XY                 (REG_LCDC_REG_BASE + 0x00dc)
#define REG_CAP_PITCH                   (REG_LCDC_REG_BASE + 0x00e0)

#define REG_Y2R_CTRL                    (REG_LCDC_REG_BASE + 0x00f0)
#define REG_Y2R_CONTRAST                (REG_LCDC_REG_BASE + 0x00f4)
#define REG_Y2R_SATURATION              (REG_LCDC_REG_BASE + 0x00f8)
#define REG_Y2R_BRIGHTNESS              (REG_LCDC_REG_BASE + 0x00fc)

#define REG_LCDC_IRQ_EN                 (REG_LCDC_REG_BASE + 0x0100)
#define REG_LCDC_IRQ_CLR                (REG_LCDC_REG_BASE + 0x0104)
#define REG_LCDC_IRQ_STATUS             (REG_LCDC_REG_BASE + 0x0108)
#define REG_LCDC_IRQ_RAW                (REG_LCDC_REG_BASE + 0x010c)
...
typedef union _lcdc_ctrl_tag
{
    struct _lcdc_ctrl_map
    {
        ...
        volatile unsigned int hi_addr           :4; //[19:16]The MSBs for memory address, it is as an offset for every block base address, the (hi_addr<<24 + base_addr) is the real access address.
        volatile unsigned int reserved_1        :12; //[9:15] Reserved ;
    } mBits ;
...
typedef union _img_ctrl_tag
{
    struct _img_ctrl_map
    {
        ...
        volatile unsigned int img_format        :4;     //[1:5] Image layer data format, it supports following ones:
        //0000-YUV422;
        //0001-YUV420;
        //0010-YUV400;
        //0011-RGB888;
...
typedef union _img_y_base_addr_tag
{
    ...
    {
        volatile unsigned int img_y_base_addr   :24;    //[23:0]  //When image is YUV format, it is Y data base address;
...
typedef union _img_uv_base_addr_tag
{
    ...
    {
        volatile unsigned int img_uv_base_addr  :24;    //[23:0]  //When image is YUV format, it is UV base address;
        volatile unsigned int reserved          :8;     //[31:24]
    } mBits;
    volatile unsigned int dwValue;
} IMG_UV_BASE_ADDR_U;
...
typedef union _osd_base_addr_ctrl_tag
{
    ...
    {
        volatile unsigned int blk_base_addr     :24;    //[23:0] block base address
        volatile unsigned int reserved          :8;     //[31:24] Reserved
    } mBits;
    volatile unsigned int dwValue;
} OSD_BASE_ADDR_U;
...
typedef union _osd_alpha_base_addr_ctrl_tag
{
    ...
    {
        volatile unsigned int blk_alpha_base_addr   :24;    //[23:0] block base address
        volatile unsigned int reserved              :8;     //[31:24] Reserved
    } mBits;
    volatile unsigned int dwValue;
...
typedef union _cap_base_addr_tag
{
    ...
    {
        volatile unsigned int base_addr         :24;    //[23:0] Capture base address
        volatile unsigned int reserved          :8;     //[31:24] Reserved
    } mBits;
    volatile unsigned int dwValue;
} CAP_BASE_ADDR_U;
