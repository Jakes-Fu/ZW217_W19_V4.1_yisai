...
LOCAL void _KpdEnable (void)
{
    ...
    hwp_lpsApb->lps_clk_auto_sel_clr = (1 << 10);
//bringup_tmp     hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_KEYPAD;
}
...
LOCAL void _KpdDisable (void)
{
 ...
 //bringup_tmp    hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_KEYPAD;
...
LOCAL void _KpdReset (void)
{
 ...
 //bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
 //bringup_tmp    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_KEYPAD;
    DELAY_CYCLE(1000)

 //bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_KEYPAD;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_I2C1;
}
...
LOCAL void _IIC0Disable (void)
{
 ...
 //bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
 //bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_I2C1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_I2C2;
}
...
LOCAL void _IIC1Disable (void)
{
 ...
 //bringup_tmp   hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
 //bringup_tmp   hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_I2C2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_ADI;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_ADI;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_ADI;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_ADI;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _RtcEnable (void)
{
    ...
    ANA_REG_OR (ANA_MODULE_EN0_RTC,  ANA_RTC_EN);
    ANA_REG_OR (ANA_RTC_CLK_EN0_RTC,  ANA_RTC_RTC_EN);
}
...
LOCAL void _RtcDisable (void)
{
    ...
    ANA_REG_AND (ANA_MODULE_EN0_RTC,  ~ANA_RTC_EN);
    ANA_REG_AND (ANA_RTC_CLK_EN0_RTC,  ~ANA_RTC_RTC_EN);
}
...
LOCAL void _RtcReset (void)
{
    ...
    ANA_REG_OR (ANA_SOFT_RST0_RTC,  ANA_RTC_SOFT_RST);
    DELAY_CYCLE(1000)

    ANA_REG_AND (ANA_SOFT_RST0_RTC,  ~ANA_RTC_SOFT_RST);
    DELAY_CYCLE(1000)
}	
...
LOCAL void _WdgEnable (void)
{
    ...
    ANA_REG_OR (ANA_MODULE_EN0_RTC,  ANA_WDG_EN);
    ANA_REG_OR (ANA_RTC_CLK_EN0_RTC,  ANA_RTC_WDG_EN);
}
...
LOCAL void _WdgDisable (void)
{
    ...
    ANA_REG_AND (ANA_MODULE_EN0_RTC,  ~ANA_WDG_EN);
    ANA_REG_AND (ANA_RTC_CLK_EN0_RTC,  ~ANA_RTC_WDG_EN);
}
...
LOCAL void _WdgReset (void)
{
    ...
    ANA_REG_OR (ANA_SOFT_RST0_RTC,  ANA_WDG_SOFT_RST);
    DELAY_CYCLE(1000)

    ANA_REG_AND (ANA_SOFT_RST0_RTC,  ~ANA_WDG_SOFT_RST);
    DELAY_CYCLE(1000)
}
...
LOCAL void _AdcEnable (void)
{
    ...
    *((volatile unsigned long *)0x500304c8) = 0x1;  //ANA_ctrl_reg32=1
    ...
    ANA_REG_OR (ANA_DIG_CLK_EN0,  (ANA_CLK_AUXADC_EN | ANA_CLK_AUXAD_EN));
}
...
LOCAL void _AdcDisable (void)
{
    ...
    ANA_REG_AND (ANA_DIG_CLK_EN0,  ~(ANA_CLK_AUXADC_EN | ANA_CLK_AUXAD_EN));	
}
...
LOCAL void _GpiodEnable (void)
{
    ...
    // D-die
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_GPIO;
}
...
LOCAL void _GpiodDisable (void)
{
    ...
    // D-die
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_GPIO;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_GPIO;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_GPIO;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _EicaEnable (void)
{
    ...
    ANA_REG_OR (ANA_MODULE_EN0_RTC,  ANA_EIC_EN);
}
...
LOCAL void _EicaDisable (void)
{
    ...
    ANA_REG_AND (ANA_MODULE_EN0_RTC,  ~ANA_EIC_EN);
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_SCI1;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_SCI1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_SCI1;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_SCI1;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_ENABLE = SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_GEA3;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_DISABLE = SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_GEA3;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_GEA3;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_GEA3;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_EFUSE;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_EFUSE;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_SPI1;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_SPI1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_SPI1;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_SPI1;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_SPI2;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_SPI2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_SPI2;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_SPI2;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_OTHERS_ENABLE = SYS_CTRL_ENABLE_OC_ID_UART1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_OTHERS_DISABLE = SYS_CTRL_DISABLE_OC_ID_UART1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_UART1;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_UART1;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
    //hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_UART1;
//bringup_tmp    hwp_sysCtrl->CLK_OTHERS_ENABLE = SYS_CTRL_ENABLE_OC_ID_UART2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_OTHERS_DISABLE = SYS_CTRL_DISABLE_OC_ID_UART2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_UART2;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_UART2;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _PinEnable (void)
{
    ...
    ANA_REG_OR(ANA_MODULE_EN0_RTC, ANA_PINREG_EN);
}
...
LOCAL void _PinDisable (void)
{
    ...
    ANA_REG_AND(ANA_MODULE_EN0_RTC, ~ANA_PINREG_EN);
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_PWM;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_PWM;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_CAMERA;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_CAMERA;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_CAMERA;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_CAMERA;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AXI_ENABLE = SYS_CTRL_ENABLE_SYS_AXI_CLK_ID_LZMA;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AXI_DISABLE = SYS_CTRL_DISABLE_SYS_AXI_CLK_ID_LZMA;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AXI_RST_SET = SYS_CTRL_SET_SYS_AXI_RST_ID_LZMA;
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_LZMA;
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_LZMA;

    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->SYS_AXI_RST_CLR = SYS_CTRL_CLR_SYS_AXI_RST_ID_LZMA;
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_LZMA;
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_LZMA;
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_ENABLE = SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_LCD | SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_GOUDA;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_DISABLE = SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_LCD | SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_GOUDA;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_LCD | SYS_CTRL_SET_SYS_AHB_RST_ID_GOUDA;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_LCD | SYS_CTRL_CLR_SYS_AHB_RST_ID_GOUDA;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_ENABLE = SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_LCD;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_DISABLE = SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_LCD;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_LCD;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_LCD;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_ENABLE = SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_USBC;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_DISABLE = SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_USBC;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_USBC;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_USBC;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_ENABLE = SYS_CTRL_ENABLE_SYS_AHB_CLK_ID_AXIDMA;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_SYS_AHB_DISABLE = SYS_CTRL_DISABLE_SYS_AHB_CLK_ID_AXIDMA;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_SET = SYS_CTRL_SET_SYS_AHB_RST_ID_AXIDMA;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->SYS_AHB_RST_CLR = SYS_CTRL_CLR_SYS_AHB_RST_ID_AXIDMA;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_SDMMC2;
    return;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
//bringup_tmp    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_SDMMC2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
    return;
}
...
//bringup_tmp    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
//bringup_tmp    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_SDMMC2;
    DELAY_CYCLE(1000)

//bringup_tmp    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_SDMMC2;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
...
// 	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SC6530_CLOCK_CFG_1948_112_2_17_23_3_49_653,(uint8*)"");
	...
	ANA_REG_OR (ANA_DIG_CLK_EN0,  ANA_CLK_CAL_EN);
}
...
//	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SC6530_CLOCK_CFG_1956_112_2_17_23_3_49_654,(uint8*)"");
	...
	ANA_REG_AND (ANA_DIG_CLK_EN0,  ~ANA_CLK_CAL_EN);
}
/******************************************************************************
* _CALReset
******************************************************************************/
