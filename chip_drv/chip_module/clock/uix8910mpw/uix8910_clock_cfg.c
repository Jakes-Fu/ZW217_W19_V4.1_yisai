...
LOCAL void _IIC1Enable (void)
{
    ...
    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_I2C2;
}
...
LOCAL void _IIC1Disable (void)
{
    ...
    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
    hwp_sysCtrl->CLK_AP_APB_DISABLE = SYS_CTRL_DISABLE_AP_APB_CLK_ID_I2C2;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _Sim0Enable (void)
{
    ...
    hwp_sysCtrl->CLK_AON_APB_ENABLE = SYS_CTRL_ENABLE_AON_APB_CLK_ID_SCI1;
}
...
LOCAL void _Sim0Disable (void)
{
    ...
    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
    hwp_sysCtrl->CLK_AON_APB_DISABLE = SYS_CTRL_DISABLE_AON_APB_CLK_ID_SCI1;
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _Sim0Reset (void)
{
    ...
    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
    hwp_sysCtrl->AON_APB_RST_SET = SYS_CTRL_SET_AON_APB_RST_ID_SCI1;
    DELAY_CYCLE(1000)
	
    hwp_sysCtrl->AON_APB_RST_CLR = SYS_CTRL_CLR_AON_APB_RST_ID_SCI1;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
LOCAL void _Uart0Reset (void)
{
    ...
    hwp_sysCtrl->REG_DBG = 0xa50001;     /*allow to set disable_reg*/
	//reset adi module
    hwp_sysCtrl->AP_APB_RST_SET = SYS_CTRL_SET_AP_APB_RST_ID_UART1;
    DELAY_CYCLE(1000)
	
    hwp_sysCtrl->AP_APB_RST_CLR = SYS_CTRL_CLR_AP_APB_RST_ID_UART1;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
...
//    hwp_sysCtrl->Cfg_Clk_Uart[2] |= (1 << 25);
    hwp_sysCtrl->CLK_AP_APB_ENABLE = SYS_CTRL_ENABLE_AP_APB_CLK_ID_UART2;
}
...
LOCAL void _LzmaReset (void)
{
    ...
    hwp_sysCtrl->SYS_AXI_RST_CLR = SYS_CTRL_SET_SYS_AXI_RST_ID_LZMA;
    DELAY_CYCLE(1000)
    //hwp_sysCtrl->REG_DBG = 0xa50000;     /*do not allow to set disable_reg*/
}
