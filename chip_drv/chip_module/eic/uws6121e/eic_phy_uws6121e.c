...
PUBLIC void EIC_PHY_Open( void )
{
    ...
    EIC_PHY_EIC_DBNC_IE_EN();

    EIC_PHY_EIC_DBNC_DMSK_EN();
    /* Reset eic model */
    EIC_PHY_Reset();
}
...
{
	ANA_REG_OR(ANA_EIC_DBNC_IE, ANA_EIC_DBNC_ABLE);
}

PUBLIC void EIC_PHY_EIC_DBNC_IE_UNEN( void )
{
	ANA_REG_AND(ANA_EIC_DBNC_IE, ANA_EIC_DBNC_DISABLE);
}

PUBLIC void EIC_PHY_EIC_DBNC_DMSK_EN( void )
{
	ANA_REG_OR(ANA_EIC_DBNC_DMSK, ANA_EIC_DBNC_ABLE);
}

PUBLIC void EIC_PHY_EIC_DBNC_DMSK_UNEN( void )
{
	ANA_REG_AND(ANA_EIC_DBNC_DMSK, ANA_EIC_DBNC_DISABLE);
}
