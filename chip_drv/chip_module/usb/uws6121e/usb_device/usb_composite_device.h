 ...
 */
static uint32_t cfFillDesc(copsFunc_t *f, void *buf, uint32_t size)
{
    if (size == 0 || buf == NULL)
        return 0;
 ...
 */
static  void cfDestroy(copsFunc_t *f)
{
 ...
 *      - 0     success
 */
static int cfSetup(copsFunc_t *f, const usb_device_request_t *ctrl)
{
 ...
 *      - 0     success
 */
static int cfBind(copsFunc_t *f, cops_t *cops, udc_t *udc)
{
 ...
 * @param f the function
 */
static void cfUnbind(copsFunc_t *f)
{
 ...
 *      - 0     success
 */
static  int cfSetAlt(copsFunc_t *f, uint8_t intf, uint8_t alt)
{
 ...
 * @param f     the function
 */
static void cfDisable(copsFunc_t *f)
{
 ...
 * @param f     the function
 */
static void cfSuspend(copsFunc_t *f)
{
 ...
 * @param f     the function
 */
static void cfResume(copsFunc_t *f)
{
