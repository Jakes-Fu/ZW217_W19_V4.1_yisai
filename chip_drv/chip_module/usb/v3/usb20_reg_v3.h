...
typedef union usb_pcgcctl_tag
{
    struct usb_pcgcctl_map
    {
        ...
        volatile unsigned int   Reserved     :23;  //global_interrupt_mask
        volatile unsigned int   ResetAfterSusp          :1;
        ...
        volatile unsigned int   Enbl_L1Gating          :1;
        volatile unsigned int   PhySuspended          :1;  //dma_enable
        volatile unsigned int   RstPdwnModule        :1;  //burst_length
        volatile unsigned int   PwrClmp     :1;  //global_interrupt_mask
        volatile unsigned int   GateHclk     :1;  //global_interrupt_mask
