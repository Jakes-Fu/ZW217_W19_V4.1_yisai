 ...
 ******************************************************************************/
#ifndef _LDO_REG_V5_H_
#define _LDO_REG_V5_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
#define GET_LEVEL(_reg_addr, _bit0_mask, _bit1_mask, _bit2_mask, _level_var)    \
    {   \
        (_level_var) |= \
                        (((ANA_REG_GET(_reg_addr)&(_bit0_mask))?(BIT_0):0)|    \
                         ((ANA_REG_GET(_reg_addr)&(_bit1_mask))?(BIT_1):0)|    \
                         ((ANA_REG_GET(_reg_addr)&(_bit2_mask))?(BIT_2):0)); \
    }
...
#define SET_LEVEL(_reg_addr, _bit0_mask, _bit1_mask, _bit2_mask, _set_bit0,     \
                  _rst_bit0, _set_bit1, _rst_bit1, _set_bit2, _rst_bit2)    \
{   \
    REG_SETBIT( \
                (_reg_addr),    \
                ((_set_bit0)|(_rst_bit0) | (_set_bit1)|(_rst_bit1) | (_set_bit2)|(_rst_bit2)),  \
                (((_set_bit0)&(_bit0_mask)) | ((_rst_bit0)&(~_bit0_mask))|  \
                 ((_set_bit1)&(_bit1_mask)) | ((_rst_bit1)&(~_bit1_mask))|  \
                 ((_set_bit2)&(_bit2_mask)) | ((_rst_bit2)&(~_bit2_mask)))   \
              )   \
}
