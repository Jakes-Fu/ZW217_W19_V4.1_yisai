...
#define SMC_CLK_OUT_EN_SHIFT			5
#define SMC_CLK_OUT_EN_MASK				(0x1 << SMC_CLK_OUT_EN_SHIFT)
#define SMC_CLK_OUT_MODE_SHIFT			6
#define SMC_CLK_OUT_MODE_MASK			(0x3 << SMC_CLK_OUT_MODE_SHIFT)
#define SMC_SAMPLE_RST_SHIFT			8
#define SMC_SAMPLE_RST_MASK				(0x1 << SMC_SAMPLE_RST_SHIFT)
#define SMC_DATA_SRC_MODE_SHIFT			9
#define SMC_DATA_SRC_MODE_MASK			(0x3 << SMC_DATA_SRC_MODE_SHIFT)
...
#define SMC_SAMPLE_AUTO_RST_EN_MASK		(0x1 << SMC_SAMPLE_AUTO_RST_EN_SHIFT)
...
#define SMC_DDR_WDATA_DLY_SHIFT			4
#define SMC_DDR_WDATA_DLY_MASK			(0x3 << SMC_DDR_WDATA_DLY_SHIFT)
...
#define SMC_DLL_EN_MASK					(0x1 << SMC_DLL_EN_SHIFT)
#define SMC_DLL_CLR_SHIFT				8
#define SMC_DLL_CLR_MASK				(0x1 << SMC_DLL_CLR_SHIFT)
...
#define SMC_DLL_CPST_EN_MASK			(0x1 << SMC_DLL_CPST_EN_SHIFT)
...
#define SMC_WAIT_EN_R_SHIFT				12
#define SMC_WAIT_EN_R_MASK				(0x1 << SMC_WAIT_EN_R_SHIFT)
#define SMC_WAIT_POL_SHIFT				14
#define SMC_WAIT_POL_MASK				(0x1 << SMC_WAIT_POL_SHIFT)
#define SMC_CRE_EN_SHIFT				17
#define SMC_CRE_EN_MASK					(0x1 << SMC_CRE_EN_SHIFT)
#define SMC_DDR_EN_SHIFT				27
#define SMC_DDR_EN_MASK					(0x1 << SMC_DDR_EN_SHIFT)
#define SMC_ADMUX_EN_SHIFT				23
#define SMC_ADMUX_EN_MASK				(0x1 << SMC_ADMUX_EN_SHIFT)
#define SMC_ROW_DETECT_EN_W_SHIFT		19
#define SMC_ROW_DETECT_EN_W_MASK		(0x1 << SMC_ROW_DETECT_EN_W_SHIFT)
#define SMC_ROW_DETECT_EN_R_SHIFT		18
#define SMC_ROW_DETECT_EN_R_MASK		(0x1 << SMC_ROW_DETECT_EN_R_SHIFT)
#define SMC_ROW_LENGTH_SHIFT			20
#define SMC_ROW_LENGTH_MASK				(0x7 << SMC_ROW_LENGTH_SHIFT)
/*****************************************************/
/*						CFG1_CSX					 */
/*****************************************************/
#define SMC_T_SAMPLE_DLY_W_SHIFT		22
#define SMC_T_SAMPLE_DLY_W_MASK			(0x3 << SMC_T_SAMPLE_DLY_W_SHIFT)
#define SMC_T_SAMPLE_DLY_R_SHIFT		20
#define SMC_T_SAMPLE_DLY_R_MASK			(0x3 << SMC_T_SAMPLE_DLY_R_SHIFT)
#define SMC_T_FIRST_W_SHIFT				8
#define SMC_T_FIRST_W_MASK				(0xF << SMC_T_FIRST_W_SHIFT)
#define SMC_T_SAMPLE_STP_SHIFT			16
#define SMC_T_SAMPLE_STP_MASK			(0xF << SMC_T_SAMPLE_STP_SHIFT)
#define SMC_T_WAIT_DLY_R_SHIFT			24
#define SMC_T_WAIT_DLY_R_MASK			(0x3 << SMC_T_WAIT_DLY_R_SHIFT)
#define SMC_T_NEXT_W_SHIFT				12
#define SMC_T_NEXT_W_MASK				(0xF << SMC_T_NEXT_W_SHIFT)
#define SMC_T_NEXT_R_SHIFT				4
#define SMC_T_NEXT_R_MASK				(0xF << SMC_T_NEXT_R_SHIFT)
#define SMC_T_FIRST_R_SHIFT				0
#define SMC_T_FIRST_R_MASK				(0xF << SMC_T_FIRST_R_SHIFT)
...
#define SMC_DLX_DLY_CPST_EN_MASK		(0x1 << SMC_DLX_DLY_CPST_EN_SHIFT)
#define SMC_STS_DLX_DLY_CNT_SHIFT		24
#define SMC_STS_DLX_DLY_CNT_MASK		(0x7F << SMC_STS_DLX_DLY_CNT_SHIFT)

/*****************************************************/
/*			  APTIC CONTROL REGISTER(BCR)		     */
/*****************************************************/
#define APTIC_BURST_LENGTH_SHIFT		0
#define APTIC_BURST_LENGTH_MASK			(0x7 << APTIC_BURST_LENGTH_SHIFT)
#define APTIC_BURST_WRAP_SHIFT			3
#define APTIC_BURST_WRAP_MASK			(0x1 << APTIC_BURST_WRAP_SHIFT)
#define APTIC_DRIVE_STRENGTH_SHIFT		4
#define APTIC_DRIVER_STRENGTH_MASK		(0x3 << APTIC_DRIVE_STRENGTH_SHIFT)
#define APTIC_WAIT_CONFIGURATION_SHIFT	8
#define APTIC_WAIT_CONFIGURATION_MASK	(0x1 << APTIC_WAIT_CONFIGURATION_SHIFT)
#define APTIC_MEM_TYPE_SHIFT			9
#define APTIC_MEM_TYPE_MASK				(0x1 << APTIC_MEM_TYPE_SHIFT)
#define APTIC_WAIT_POLARITY_SHIFT		10
#define APTIC_WAIT_POLARITY_MASK		(0x1 << APTIC_WAIT_POLARITY_SHIFT)
#define APTIC_LATENCY_COUNTER_SHIFT		11
#define APTIC_LATENCY_COUNTER_MASK		(0x7 << APTIC_LATENCY_COUNTER_SHIFT)
#define APTIC_INITIAL_LATENCY_SHIFT		14
#define APTIC_INITIAL_LATENCY_MASK		(0x1 << APTIC_INITIAL_LATENCY_SHIFT)
#define APTIC_OPERATING_MODE_SHIFT		15
#define APTIC_OPERATING_MODE_MASK		(0x1 << APTIC_OPERATING_MODE_SHIFT)
#define APTIC_REGISTER_SELECT_SHIFT		18
#define APTIC_REGISTER_SELECT_MASK		(0x3 << APTIC_REGISTER_SELECT_SHIFT)
