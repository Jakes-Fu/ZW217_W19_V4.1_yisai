...
const struct ddr_save_pattern dmc_off_val[] = {
	...
	{REG_DMC_CTRL_T_XSR,		0x004b004b},	//!
	{REG_DMC_CTRL_T_RDDATA_EN,	0x8},		//!
	{REG_DMC_CTRL_T_PHYWRLAT,	0x104},		//!
	{REG_DMC_CTRL_T_RCD,		0x8},		//!
	{REG_DMC_CTRL_T_REFI,		0x208},		//!
	{REG_DMC_CTRL_T_RFC,		0x00300030},	//!
...
const struct ddr_save_pattern dmc_cmd_off_val[] = {
	...
	{REG_DMC_CTRL_DIRECT_CMD, 0x10000602},//! MR2, RL=3, WL=1, LPDDR2-400
...
const struct ddr_save_pattern phy_off_val[] = {
	...
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_0_WR_AC,	0x13}, //! ac line edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_0_WR_DS0,	0x0e}, //! ds0 output edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_1_WR_DS0,	0x12}, //! ds0 input pos edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_2_WR_DS0,	0x0d}, //! ds0 input neg edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_3_WR_DS0,	0x0e}, //! ds0 gate edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_0_WR_DS1,	0x0e}, //! ds1 outupt edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_1_WR_DS1,	0x14}, //! ds1 input pos edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_2_WR_DS1,	0x0f}, //! ds1 input neg edge
	{REG_LPDDR_PHY_LPDDR_RF_CFG_DLL_DL_3_WR_DS1,	0x10}, //! ds1 gate edge
	...
	{REG_LPDDR_PHY_LPDDR_DRF_CFG_DQS_IE_SEL_F0,	0x6}, //!
	{REG_LPDDR_PHY_LPDDR_DRF_CFG_DQS_GATE_SEL_F0,	0x3c},//!
	{REG_LPDDR_PHY_LPDDR_DRF_CFG_DATA_IE_SEL_F0,	0x6}, //!
	{REG_LPDDR_PHY_LPDDR_DRF_CFG_READ_EN_SEL_F0,	0x5}, //!
