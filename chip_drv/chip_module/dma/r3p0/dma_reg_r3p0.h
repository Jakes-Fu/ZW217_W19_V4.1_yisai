 ...
 ******************************************************************************/
#ifndef _DMA_REG_R3P0_H_
#define _DMA_REG_R3P0_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **-------------------------------------------------------------------------- */
/**---------------------------------------------------------------------------*
...
//    FRG_LEN                    : [16:0 ] Fragment Length, with byte unit. £¨  
//                                  Max 64K bytes£©
//------------------------------------------------------------------------------
...
//                                  ¡°0¡±.
//    BLK_LEN                    : [15:0 ] Block Length, with byte unit. £¨Max  
//                                  64K bytes£©
//------------------------------------------------------------------------------
...
//    CHN_PRIORITY               : [13:12] Channel Request Priority. Four level 
//                                  of Priority supported as list : 
//    LLIST_CFG_VALID            : [8    ] If ¡°LLIST_EN¡± asserted, active high
...
//                                  jumps to ¡°WRAP_START_ADDR¡± address when   
//                                  the current address matches ¡°WRAP_END_ADDR?
//                                  ?address: 
//    ADDR_FIX_SEL               : [21   ] Selection of the side using Address  
//                                  Fix mode.
...
//                                  configure, BLK_CNT would be always equal to 
//                                  ¡°0¡±.
//    BLK_LEN                    : [16:0 ] Block Length, with byte unit. £¨Max  
//                                  64K bytes£©
//------------------------------------------------------------------------------
...
*/
#define DMA_CHx_SRCWRAP_MASK             (0x00800000)
#define DMA_CHx_SRCWRAP_DISABLE          (0x00000000)
#define DMA_CHx_SRCWRAP_ENABLE           (0x00800000)
...
*/
#define DMA_CHx_DESTWRAP_MASK            (0x00400000)
#define DMA_CHx_DESTWRAP_DISABLE         (0x00000000)
#define DMA_CHx_DESTWRAP_ENABLE          (0x00400000)
...
#define DMA_CHx_CFG_PRIORITY1		     (0x00010000)
#define DMA_CHx_CFG_PRIORITY2		     (0x00020000)
#define DMA_CHx_CFG_PRIORITY3            (0x00030000)
