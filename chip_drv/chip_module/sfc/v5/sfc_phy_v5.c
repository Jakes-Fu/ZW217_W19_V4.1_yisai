        ...
        switch (index)
        {
            case CMD_BUF_0:
                reg_sfc->cs1_cmd_buf0.mBits.cmd_buf0 = value;
                            #ifdef SFC_DEBUG
                            s_sfc_save_cmd0[s_sfc_save_cmd0_index++] = (0x1UL<<15) | value;
                            if(s_sfc_save_cmd0_index == SFC_DEBUG_BUF_LEN)
                            {
                                s_sfc_save_cmd0_index = 0;
                            }
...
PUBLIC void SFCDRV_SetInitAddr(int cs, INI_ADD_SEL_E start_addr)
{
    ...
    {
        reg_sfc->cs1_cmd_cfg.mBits.sts_ini_addr_sel =start_addr;
    }
}
...
PUBLIC uint32 SFCDRV_GetInitAddr(int cs)
{
    ...
    {
        start_addr = reg_sfc->cs1_cmd_cfg.mBits.sts_ini_addr_sel;
    }

    switch(start_addr)
    {
        case INI_CMD_BUF_7: start_addr=7; break;
        case INI_CMD_BUF_6: start_addr=6; break;
        case INI_CMD_BUF_5: start_addr=5; break;
        case INI_CMD_BUF_4: start_addr=4; break;
        default: start_addr=7; break;
    }
    return (start_addr);
}
...
PUBLIC uint32 SFCDRV_SetCS1StartAddr(uint32 start_addr)
{
    ...
    {
        case 0x00100000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x1; 
        break;

        case 0x00200000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x2; 
        break;

        case 0x00400000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x4; 
        break;

        case 0x00800000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x8; 
        break;

        case 0x01000000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x10; 
        break;

        case 0x02000000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x20; 
        break;

        case 0x04000000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x40; 
        break;

        case 0x08000000:
            *(volatile uint32 *)(SFC_CS1_START_ADDR) = 0x80; 
        break;
