 ...
 ******************************************************************************/
#ifndef _SFC_REG_V7_H_
#define _SFC_REG_V7_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **-------------------------------------------------------------------------  */
...
#define SFC_CS0_SPACE					 (SFC_REG_BASE + 0x0200)
#define SFC_IEN                          (SFC_REG_BASE + 0x0204)
#define SFC_INT_RAW                      (SFC_REG_BASE + 0x0208)
#define SFC_INT_STS                      (SFC_REG_BASE + 0x020C)
#define SFC_DLL_STS                      (SFC_REG_BASE + 0x0210)
#define SFC_FIFO_SYNC_SEL                (SFC_REG_BASE + 0x0214)
