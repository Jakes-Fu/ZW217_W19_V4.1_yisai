...
**---------------------------------------------------------------------------*/
/*----------System Count----------*/
#define SYST_ALARM                       (SYSTIMER_BASE + 0x0000)
#define SYST_VALUE                        (SYSTIMER_BASE + 0x0004)
#define SYST_INT                            (SYSTIMER_BASE + 0x0008)
#define SYST_VALUE_SHDW            (SYSTIMER_BASE + 0x000C)
