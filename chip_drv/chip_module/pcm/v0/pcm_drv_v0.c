...
LOCAL  void PCM_ResetRegist (void)
{
    ...
    REG32 (GR_SOFT_RST) |= (uint32) SWRST_IIS_RST;
...
LOCAL void PCM_DMATx_CallBack (uint32 num)
{
    ...
    DMA_HAL_ChnEnable (DMA_PCM_TX, SCI_FALSE);
    ...
    DMA_HAL_ChnConfig (DMA_PCM_TX, &s_tx_dma_cfg);

    {
        ...
        DMA_HAL_ChnEnable_Ex (DMA_PCM_TX, SCI_TRUE, cacheConfig, 1);
    }

    //    DMA_HAL_ChnEnable (DMA_PCM_TX, SCI_TRUE);
...
LOCAL void PCM_DMARx_CallBack (uint32 num)
{
    ...
    DMA_HAL_ChnEnable (DMA_PCM_RX, SCI_FALSE);
    ...
    DMA_HAL_ChnConfig (DMA_PCM_RX, &s_rx_dma_cfg);

    {
        ...
        DMA_HAL_ChnEnable_Ex (DMA_PCM_RX, SCI_TRUE, cacheConfig, 1);
    }
    //    DMA_HAL_ChnEnable (DMA_PCM_RX, SCI_TRUE);
}
...
LOCAL  void  PCM_TxDMA_Config (void)
{
    ...
    DMA_HAL_ChnIntConfig (DMA_PCM_TX, DMA_CHN_INT_TYPE_TRANSDONE, PCM_DMATx_CallBack);
...
{
    //DC Register DMA Call Back Function
    DMA_HAL_ChnIntConfig (DMA_PCM_RX, DMA_CHN_INT_TYPE_TRANSDONE, PCM_DMARx_CallBack);
...
PUBLIC ERR_PCM_E  PCM_Open (PCM_PARA_T *paramer)
{
    ...
    if (paramer)
    {
        ...
        else
        {
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,PCM_DRV_V0_590_112_2_17_23_6_0_1108,(uint8*)"");
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,PCM_DRV_V0_631_112_2_17_23_6_0_1109,(uint8*)"");
...
PUBLIC ERR_PCM_E PCM_Close (void)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,PCM_DRV_V0_662_112_2_17_23_6_0_1110,(uint8*)"");
