...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Sources/chip/branches/gallite441/hal/src/hal_i2c.c $ //
//    $Author: yangtt $                                                        // 
//    $Date: 2016-01-18 13:40:06 +0800 (Mon, 18 Jan 2016) $                     //   
//    $Revision: 27627 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
#define  hwp_i2cMaster   hwp_i2cMaster1
#endif

PRIVATE CONST CHAR* CONST g_halI2cErrStrIdOutOfRange = "I2C bus ID out of range: %d";
PRIVATE CONST CHAR* CONST g_halI2cErrStrIdOutOf8809MRange = "I2C bus ID 8809Z: %d";
...
#define HAL_I2C_TAKE_BUS(id)                                        \
    ...
    HAL_I2C_BUS_ID_T i = HAL_I2C_BUS_ID_1;                                                       \
    if (g_halI2cInUse[id])                                          \
    {                                                               \
    ...
    {                                                               \
        for (i = HAL_I2C_BUS_ID_1; i<HAL_I2C_BUS_ID_QTY; i++)                    \
        {                                                           \
            if (g_halI2cInUse[i])                                   \
            {                                                       \
                needFreqRes = FALSE;                                \
        ...
        {                                                           \
            ...
            hal_SysRequestFreq((HAL_SYS_FREQ_USER_ID_T)HAL_SYS_FREQ_I2C, HAL_SYS_FREQ_26M, hal_I2cUpdateDivider); \
        }                                                           \
...
#define HAL_I2C_RELEASE_BUS(id)                                     \
    ...
    {                                                               \
        ...
        hal_SysRequestFreq((HAL_SYS_FREQ_USER_ID_T)HAL_SYS_FREQ_I2C, HAL_SYS_FREQ_32K, NULL);\
    }                                                               \
...
PRIVATE HWP_I2C_MASTER_T* CONST g_halI2cMasterAddr[HAL_I2C_BUS_ID_QTY] =
{
    hwp_i2cMaster,
    hwp_i2cMaster2,
#if (CHIP_ASIC_ID == CHIP_ASIC_ID_8910M)
#else
    hwp_i2cMaster3,
#endif
};
...
PRIVATE VOID hal_I2cUpdateDivider(HAL_SYS_FREQ_T sysFreq)
{
    ...
    for(i=0; i<HAL_I2C_BUS_ID_QTY; i++)
    {
        if (!g_halI2cInUse[i])
        {
...
PUBLIC HAL_ERR_T hal_I2cOpen(HAL_I2C_BUS_ID_T id)
{
    ...
    #ifdef CHIP_DIE_8809M
    HAL_ASSERT(id != HAL_I2C_BUS_ID_1, g_halI2cErrStrIdOutOf8809MRange, id);
    #endif
