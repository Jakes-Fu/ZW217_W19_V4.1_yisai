...
#include "spi_reg_uws6121e.h"
#include "spi_phy_uws6121e.h"
...
HAL_APIFC_REQUEST_ID_T gc_halSpiIfcTxId[HAL_SPI_QTY];
CONST HAL_APIFC_REQUEST_ID_T gc_halSpiIfcRxId[HAL_SPI_QTY];
...
*********************************************************************************************************/
#if 0 //bringup_tmp
LOCAL int32 __SPI_PHY_RBytes (//bringup_tmp:__inline
    uint32          phy_id,              // port number of spi
