...
LOCAL void bm_open (int point)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,BUSMONITOR_PHY_V0_82_112_2_17_23_3_20_373,(uint8*)"");
...
LOCAL void bm_clean_point (int point)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,BUSMONITOR_PHY_V0_108_112_2_17_23_3_20_374,(uint8*)"");
...
LOCAL void bm_rw_callback (unsigned long data, unsigned long pc_before_fiq)
{
    ...
    MMU_DISABLE
    bm_close();
    sprintf (s_bm_inf_buf, "BUS MONITOR num%d: invalid memory read or write : pc = 0x%08lx", data, pc_before_fiq);
...
PUBLIC void bm_set_point (int point, const BM_POINT_SETTING *setting)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,BUSMONITOR_PHY_V0_218_112_2_17_23_3_20_375,(uint8*)"");
    ...
    CHIP_REG_OR (AHB_CHN_SEL, (setting->chn_sel << point));
