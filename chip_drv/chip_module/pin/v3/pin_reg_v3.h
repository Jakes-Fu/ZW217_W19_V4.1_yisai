...
#define PIN_TD_TXPD                         REG_ADDR(0x002C)
#define PIN_TD_RXPD                         REG_ADDR(0x0030)
#define PIN_GSM_TXPD                        REG_ADDR(0x0034)
#define PIN_GSM_RXPD                         REG_ADDR(0x0038)
...
#define ANA_PIN_GSM_RXPD                ANA_REG_ADDR(0x0054)
#define ANA_PIN_GSM_TXPD                ANA_REG_ADDR(0x0058)
#define ANA_PIN_TD_RXPD                 ANA_REG_ADDR(0x005C)
#define ANA_PIN_TD_TXPD                 ANA_REG_ADDR(0x0060)
