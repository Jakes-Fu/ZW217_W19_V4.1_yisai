...
#define CHAR_LINEIN_REC_EN              BIT_15
#define CHAR_LINEIN_REC_S_SHIFT         12
#define CHAR_LINEIN_REC_S_MASK          (0x7<<CHAR_LINEIN_REC_S_SHIFT)
...
///ANA_ADIE_CHIP_ID
#define ANA_V1_CHIP_ID          ((uint16)0)
#define ANA_V2_CHIP_ID          ((uint16)1)
