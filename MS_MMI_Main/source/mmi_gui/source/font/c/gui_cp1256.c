...
#ifndef _GUI_CP1256_C_
#define _GUI_CP1256_C_
 ...
 * CP1256
 */
LOCAL const uint16 s_cp1256_2uni[128] = {
  /* 0x80 */
...
LOCAL const uint8 s_cp1256_page00[96] = {
...
LOCAL const uint8 s_cp1256_page01[72] = {
...
LOCAL const uint8 s_cp1256_page06[208] = {
...
LOCAL const uint8 s_cp1256_page20[56] = {
...
/*****************************************************************************/
// 	Description : cp1256 to wchar
//	Global resource dependence : none
//  Author: James.Zhang
//	Note: 
/*****************************************************************************/
LOCAL BOOLEAN CP1256ToWchar(
                            uint8 ch,
                            wchar* wch_ptr //out
                            )
{
...
/*****************************************************************************/
// 	Description : wchar to cp1256 
//	Global resource dependence : none
//  Author: James.Zhang
//	Note: 
/*****************************************************************************/
LOCAL BOOLEAN WcharToCP1256(
                            uint8 *ch_ptr, //out
                            wchar w_char
                            )
{
    ...
    {
        ch = s_cp1256_page00[w_char-0x00a0];
    }
    else if (w_char >= 0x0150 && w_char < 0x0198)
    {
        ch = s_cp1256_page01[w_char-0x0150];
    }
    else if (w_char == 0x02c6)
    {
    		ch = 0x88;
    }
    else if (w_char >= 0x0608 && w_char < 0x06d8)
    {
        ch = s_cp1256_page06[w_char-0x0608];;
    }
    else if (w_char >= 0x2008 && w_char < 0x2040)
    {
        ch = s_cp1256_page20[w_char-0x2008];
    }
                               ...
                               )
{
    ...
    if ( PNULL == cp1256_ptr || PNULL == wstr_ptr || 0 == str_len )
    {
        return 0;
    }
    ...
    for ( i = 0; i < str_len; i++ )
    {
        if ( !CP1256ToWchar( cp1256_ptr[i], &wstr_ptr[i]) )
        {
            len = i;
            break;
        }
                               ...
                               )
{
    ...
    if ( PNULL == cp1256_ptr || PNULL == wstr_ptr || 0 == wstr_len )
    {
        return 0;
    }
    ...
    {
        if ( !WcharToCP1256( &cp1256_ptr[i], wstr_ptr[i] ) )
        {
            len = i;
            break;
        }
