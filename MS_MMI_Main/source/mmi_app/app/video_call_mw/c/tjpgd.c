...
{
  static int32_t M13 = (int32_t)(1.41421*4096);
  static int32_t M2 = (int32_t)(1.08239*4096);
  static int32_t M4 = (int32_t)(2.61313*4096);
  static int32_t M5 = (int32_t)(1.84776*4096);
  ...
  if (!JD_USE_SCALE || jd->scale != 3) {  /* Not for 1/8 scaling */
    ...
    for (iy = 0; iy < my; iy++) {
      ...
      for (ix = 0; ix < mx; ix++) {
        ...
        r = BYTECLIP(yy + t1);
        g = BYTECLIP(yy - (t2 + (t1 >> 1)));
        b = BYTECLIP(yy + t2 + (t2 << 2));
