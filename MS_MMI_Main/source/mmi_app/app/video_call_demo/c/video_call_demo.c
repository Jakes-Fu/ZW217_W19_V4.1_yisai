...
static void __action_cmd_start()
{
    avc_init_t   init = {0};
     ...
     * 第一步. 获取展锐网络参数net_id
     */
    net_id = MMIAPIPDP_GetPublicPdpLinkNetid();
    ...
    init.license.str_appid           = "<your appId>";//https://console.agora.io/projects?isTrusted=true 登陆您的账号后，在该路径创建项目。创建后请联系声网商务开通license
    init.license.str_customer_key    = "<your customer key>";//https://console.agora.io/restfulApi 登陆您的账号后，在该路径获取
    init.license.str_customer_secret = "<your customer secret>";//https://console.agora.io/restfulApi 登陆您的账号后，在该路径获取
    init.license.str_license_key     = "<your device IMEI>";//每个设备消耗一个license，该值指代设备，在该项目中必须全局唯一，类似IMEI
    ...
    config.msg_notify_cb     = avc_msg_notify_callback;//异步消息回调
    ...
    config.rotation          = CAPTURE_ROT_DEFAULT;//采集视频旋转
