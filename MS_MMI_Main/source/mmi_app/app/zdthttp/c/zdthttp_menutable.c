...
#define _MMIZDTHTTP_MENUTABLE_C_
/**--------------------------------------------------------------------------*
 **                         Include Files                                    *
 **--------------------------------------------------------------------------*/
...
const GUIMENU_ITEM_T	menu_zdthttp_test[]  =
{
    {ID_ZDTHTTP_MENU_TEST1, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},TXT_ZDTHTTP_TEST, 0, 0, 0, MENU_NULL},
    {ID_ZDTHTTP_MENU_TEST2, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},TXT_ZDTHTTP_TEST, 0, 0, 0, MENU_NULL},
};
...
const GUIMENU_GROUP_T mmizdthttp_menu_table[] = 
{
    {NULL},
...
//	Note:
/*****************************************************************************/
PUBLIC void MMIZDTHTTP_RegMenuGroup(void)
{
    MMI_RegMenuGroup(MMI_MODULE_ZDTHTTP, mmizdthttp_menu_table);
}
