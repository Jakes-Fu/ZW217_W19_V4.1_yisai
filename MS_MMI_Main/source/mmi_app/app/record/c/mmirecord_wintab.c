...
/*****************************************************************************/
//  Description : PlayStopButtonProc
//  Global resource dependence :
//  Author: chunyou.zhu
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E PlayStopButtonProc(void);

/*****************************************************************************/
//  Description : LeftButtonProc
//  Global resource dependence :
//  Author: chunyou.zhu
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E LeftButtonProc(void);

/*****************************************************************************/
//  Description : RightButtonProc
//  Global resource dependence :
//  Author: chunyou.zhu
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E RightButtonProc(void);

/*****************************************************************************/
//  Description : BackButtonProc
//  Global resource dependence :
//  Author: chunyou.zhu
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E BackButtonProc(void);

/*****************************************************************************/
//  Description : OptionButtonProc
//  Global resource dependence :
//  Author: chunyou.zhu
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E OptionButtonProc(void);
...
//  Note:
/*****************************************************************************/
LOCAL MMI_RESULT_E HandleRecordMainWinTpKeyDown(MMI_HANDLE_T win_handle,
        DPARAM     param
                                               );
...
{
    CREATE_BUTTON_CTRL(IMAGE_RECORD_VOLUME, MMIRECORD_VOLUME_BUTTON_CTRL_ID),
    CREATE_BUTTON_CTRL(IMAGE_RECORD_RECORD_BTN_PDA_UNSEL, MMIRECORD_LEFT_BUTTON_CTRL_ID),
    CREATE_BUTTON_CTRL(IMAGE_RECORD_LIST_BTN_UNSEL, MMIRECORD_RIGHT_BUTTON_CTRL_ID),
    //istyle button
    CREATE_BUTTON_CTRL(IMAGE_RECORD_BACK_BTN_UNSEL, MMIRECORD_BACK_BUTTON_CTRL_ID),
    CREATE_BUTTON_CTRL(IMAGE_RECORD_OPTION_BTN_UNSEL, MMIRECORD_OPTION_BUTTON_CTRL_ID),

    CREATE_BUTTON_CTRL(IMAGE_RECORD_PLAY_BTN_UNSEL, MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID),
...
LOCAL void DisplayRecordBG(MMI_WIN_ID_T win_id)
{
    ...
    {
        display_rect.top = MMI_STATUSBAR_HEIGHT;
    }
#endif
...
)
{
    ...
    case MSG_TP_PRESS_DOWN:
        HandleRecordMainWinTpKeyDown(record_win_data_ptr->win_handle, param);/*lint !e656*/
        break;
...
//  Note:
/*****************************************************************************/
PUBLIC void MMIRECORD_UpdateScreen(
    MMI_WIN_ID_T win_id,
...
LOCAL void DisplaySoftkey(MMI_WIN_ID_T win_id)
{
            ...
            || MMIRECORD_BUTTON_STATE_NORMAL == record_win_data_ptr->button_validate[MMIRECORD_BUTTON_RECORD_PAUSE])
    {
        ...
        softkey_mid_image = IMAGE_RECORD_OK_ICON;
...
{
#ifndef MMI_RECORD_MINI_SUPPORT
    MMIRECORD_BUTTON_E  btn_id_cur = MMIRECORD_BUTTON_VOLUME;
    ...
    for(btn_id_cur = MMIRECORD_BUTTON_VOLUME; btn_id_cur < MMIRECORD_BUTTON_MAX; btn_id_cur ++)
    {

        SCI_MEMSET(&buttonFg, 0, sizeof(GUI_BG_T));
        SCI_MEMSET(&buttonBg, 0, sizeof(GUI_BG_T));
        SCI_MEMSET(&buttonBg_press, 0, sizeof(GUI_BG_T));
        SCI_MEMSET(&button_grey, 0, sizeof(GUI_BG_T));
        SCI_MEMSET(&buttonFg_press, 0, sizeof(GUI_BG_T));
        buttonBg.bg_type = GUI_BG_NONE;
        buttonFg.bg_type = GUI_BG_IMG;
        button_grey.bg_type = GUI_BG_IMG;
        buttonBg_press.bg_type = GUI_BG_NONE;
        buttonFg_press.bg_type = GUI_BG_IMG;
        ctrl_id = 0;

        switch(btn_id_cur)
        {
        case MMIRECORD_BUTTON_RECORD:
            buttonFg.img_id = IMAGE_RECORD_RECORD_BTN_PDA_UNSEL;
            button_grey.img_id = IMAGE_RECORD_RECORD_BTN_PDA_DIS;
            buttonFg_press.img_id = IMAGE_RECORD_RECORD_BTN_PDA_FOCUS;
            buttonBg.bg_type = buttonBg_press.bg_type = GUI_BG_IMG;
            buttonBg.img_id  = buttonBg_press.img_id  = IMAGE_RECORD_RECORD_PDA_BG;

            if(MMIRECORD_BUTTON_STATE_HIDE != record_win_data_ptr->button_validate[btn_id_cur])  //left button alway visiable
            {
                ctrl_id = MMIRECORD_LEFT_BUTTON_CTRL_ID;
            }

            break;

        case MMIRECORD_BUTTON_RECORD_PAUSE:
            buttonFg.img_id = IMAGE_RECORD_RECORD_PAUSE_BTN_UNSEL;
            buttonFg_press.img_id = IMAGE_RECORD_RECORD_PAUSE_BTN_FOCUS;
            buttonBg.bg_type = buttonBg_press.bg_type = GUI_BG_IMG;
            buttonBg.img_id  = buttonBg_press.img_id  = IMAGE_RECORD_RECORD_PDA_BG;
        ...
        case MMIRECORD_BUTTON_RECORD_STOP:
            buttonFg.img_id = IMAGE_RECORD_STOP_BTN_UNSEL;
            button_grey.img_id = IMAGE_RECORD_STOP_BTN_DIS;
            buttonFg_press.img_id = IMAGE_RECORD_STOP_BTN_FOCUS;
            buttonBg.bg_type = buttonBg_press.bg_type = GUI_BG_IMG;
            buttonBg.img_id  = buttonBg_press.img_id  = IMAGE_RECORD_RECORD_PDA_BG;

            if(MMIRECORD_BUTTON_STATE_HIDE != record_win_data_ptr->button_validate[btn_id_cur])
            {
                ctrl_id = MMIRECORD_RIGHT_BUTTON_CTRL_ID;
            }

            break;

        case MMIRECORD_BUTTON_LIST:
            buttonFg.img_id = IMAGE_RECORD_LIST_BTN_UNSEL;
            button_grey.img_id = IMAGE_RECORD_LIST_BTN_DIS;
            buttonFg_press.img_id = IMAGE_RECORD_LIST_BTN_FOCUS;
            buttonBg.bg_type = buttonBg_press.bg_type = GUI_BG_IMG;
            buttonBg.img_id  = buttonBg_press.img_id  = IMAGE_RECORD_RECORD_PDA_BG;
        ...
        case MMIRECORD_BUTTON_BACK:
            buttonFg.img_id = IMAGE_RECORD_BACK_BTN_UNSEL;
            buttonFg_press.img_id = IMAGE_RECORD_BACK_BTN_FOCUS;
#if defined(MMI_ISTYLE_SUPPORT)
            if(MMITHEME_IsIstyle())
            {
                ctrl_id = MMIRECORD_BACK_BUTTON_CTRL_ID;
            }
#endif
            break;

        case MMIRECORD_BUTTON_OPTION:
            buttonFg.img_id = IMAGE_RECORD_OPTION_BTN_UNSEL;
            button_grey.img_id = IMAGE_RECORD_OPTION_BTN_DIS;
            buttonFg_press.img_id = IMAGE_RECORD_OPTION_BTN_FOCUS;
#if defined(MMI_ISTYLE_SUPPORT)
            if(MMITHEME_IsIstyle())
            {
                ctrl_id = MMIRECORD_OPTION_BUTTON_CTRL_ID;
            }
#endif
            break;

        case MMIRECORD_BUTTON_STOP:
            buttonFg.img_id = IMAGE_RECORD_PLAY_STOP_BTN_UNSEL;
            buttonFg_press.img_id = IMAGE_RECORD_PLAY_STOP_BTN_FOCUS;
            ...
            {
                ctrl_id = MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID;
            }

            break;

        case MMIRECORD_BUTTON_PLAY:
            buttonFg.img_id = IMAGE_RECORD_PLAY_BTN_UNSEL;
            buttonFg_press.img_id = IMAGE_RECORD_PLAY_BTN_FOCUSE;
        ...
        case MMIRECORD_BUTTON_VOLUME:
            if(0 == MMIAPISET_GetMultimVolume())
            {
                buttonFg.img_id = IMAGE_COMMON_PLAYER_BTN_VOL_MUTE;//IMAGE_RECORD_VOLUME_MUTE;
                buttonFg_press.img_id = IMAGE_COMMON_PLAYER_BTN_VOL_MUTE_FOCUS;
            }
            else
            {
                buttonFg.img_id = IMAGE_COMMON_PLAYER_BTN_VOL;//IMAGE_RECORD_VOLUME;
                buttonFg_press.img_id = IMAGE_COMMON_PLAYER_BTN_VOL_FOCUS;
            }
        ...
        if(0 != ctrl_id)
        {
            if(MMIRECORD_BUTTON_STATE_NORMAL == record_win_data_ptr->button_validate[btn_id_cur])
            {
                GUIBUTTON_SetFg(ctrl_id, &buttonFg);
                GUIBUTTON_SetPressedFg(ctrl_id, &buttonFg_press);
            ...
            else if(MMIRECORD_BUTTON_STATE_GRAY == record_win_data_ptr->button_validate[btn_id_cur])
            {
                GUIBUTTON_SetGrayed(ctrl_id, TRUE, PNULL, FALSE);
                GUIBUTTON_SetGrayedFg(ctrl_id, TRUE, &button_grey, FALSE);
                GUIBUTTON_SetVisible(ctrl_id, TRUE, FALSE);
            }
            else
            {
                GUIBUTTON_SetVisible(ctrl_id, FALSE, FALSE);
            }
...
PUBLIC void MMIRECORD_LoadRecordMenu(MMI_HANDLE_T parent_handle)
{
...
#if defined (MMS_SUPPORT) || defined (BLUETOOTH_SUPPORT) //NEWMS00183056           
    //send file sub context menu button
    SCI_MEMSET(&button_info, 0, sizeof(button_info));
    button_info.is_static   = TRUE;
    button_info.group_id = MENU_MULTIM_SEND_FILE;
    ...
    SCI_MEMSET(&button_info, 0, sizeof(button_info));
    button_info.is_static   = TRUE;
    button_info.group_id = MENU_RECORD_STORE_STATUS;
    button_info.button_style = GUIMENU_BUTTON_STYLE_CANCEL;
    GUIMENU_SetButtonStyle(ctrl_id, &button_info);

    //file-format style sub context menu button  andy.he_record
    SCI_MEMSET(&button_info, 0, sizeof(button_info));
    button_info.is_static   = TRUE;
    button_info.group_id = MENU_RECORD_STORE_FORMAT;
    button_info.button_style = GUIMENU_BUTTON_STYLE_CANCEL;
    GUIMENU_SetButtonStyle(ctrl_id, &button_info);

#if defined (MMS_SUPPORT) || defined (BLUETOOTH_SUPPORT)//NEWMS00183056
    //send file sub context menu button title
    SCI_MEMSET(&title_info, 0, sizeof(title_info));
    SCI_MEMSET(&title_str, 0, sizeof(title_str));
    MMI_GetLabelTextByLang(TXT_SEND, &title_str);
    title_info.is_static    = TRUE;
    title_info.group_id     = MENU_MULTIM_SEND_FILE;
    title_info.title_ptr    = &title_str;
    title_info.sub_title_ptr = PNULL;
    GUIMENU_SetMenuTitleEx(ctrl_id, &title_info);
#endif
    //store status sub context menu button title
    SCI_MEMSET(&title_info, 0, sizeof(title_info));
    SCI_MEMSET(&title_str, 0, sizeof(title_str));
    MMI_GetLabelTextByLang(STXT_STORE_MEDIUM, &title_str);
    title_info.is_static    = TRUE;
    title_info.group_id     = MENU_RECORD_STORE_STATUS;
    title_info.title_ptr    = &title_str;
    title_info.sub_title_ptr = PNULL;
    GUIMENU_SetMenuTitleEx(ctrl_id, &title_info);

    //file-format style sub context menu button title  andy.he_record
    SCI_MEMSET(&title_info, 0, sizeof(title_info));
    SCI_MEMSET(&title_str, 0, sizeof(title_str));
    MMI_GetLabelTextByLang(TXT_FILE_FORMAT, &title_str);
    title_info.is_static    = TRUE;
    title_info.group_id     = MENU_RECORD_STORE_FORMAT;
    title_info.title_ptr    = &title_str;
    title_info.sub_title_ptr = PNULL;
    GUIMENU_SetMenuTitleEx(ctrl_id, &title_info);
    ...
    else*/
    {
            ...
            && record_win_data_ptr->is_insert_record)
        {
            if(MMIRECORD_IsSupport(MMIRECORD_WORK_FORMAT_MP3)
                && (record_win_data_ptr->record_all_support_type & MMIRECORD_WORK_FORMAT_MP3)
                )
            {
            ...
            if(MMIRECORD_IsSupport(MMIRECORD_WORK_FORMAT_AMR)
                && (record_win_data_ptr->record_all_support_type & MMIRECORD_WORK_FORMAT_AMR)
                )
            {
...
LOCAL BOOLEAN SetFormParam(MMI_WIN_ID_T win_id)
{
    ...
    if(MMITHEME_IsIstyle())
    {
        GUIBUTTON_SetVisible(MMIRECORD_BACK_BUTTON_CTRL_ID, TRUE, FALSE);
        GUIBUTTON_SetVisible(MMIRECORD_OPTION_BUTTON_CTRL_ID, TRUE, FALSE);
    }
    else
#endif		
    {
        GUIBUTTON_SetVisible(MMIRECORD_BACK_BUTTON_CTRL_ID, FALSE, FALSE);
        GUIBUTTON_SetVisible(MMIRECORD_OPTION_BUTTON_CTRL_ID, FALSE, FALSE);
    }

    GUIBUTTON_PermitBorder(MMIRECORD_LEFT_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_PermitBorder(MMIRECORD_RIGHT_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_PermitBorder(MMIRECORD_BACK_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_PermitBorder(MMIRECORD_OPTION_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_PermitBorder(MMIRECORD_VOLUME_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_PermitBorder(MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID, FALSE);

    GUIBUTTON_SetRunSheen(MMIRECORD_LEFT_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_SetRunSheen(MMIRECORD_RIGHT_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_SetRunSheen(MMIRECORD_BACK_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_SetRunSheen(MMIRECORD_OPTION_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_SetRunSheen(MMIRECORD_VOLUME_BUTTON_CTRL_ID, FALSE);
    GUIBUTTON_SetRunSheen(MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID, FALSE);

    GUIBUTTON_SetCallBackFunc(MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID, PlayStopButtonProc);
    GUIBUTTON_SetCallBackFunc(MMIRECORD_LEFT_BUTTON_CTRL_ID, LeftButtonProc);
    GUIBUTTON_SetCallBackFunc(MMIRECORD_RIGHT_BUTTON_CTRL_ID, RightButtonProc);
    GUIBUTTON_SetCallBackFunc(MMIRECORD_BACK_BUTTON_CTRL_ID, BackButtonProc);
    GUIBUTTON_SetCallBackFunc(MMIRECORD_OPTION_BUTTON_CTRL_ID, OptionButtonProc);

#ifndef TOUCH_PANEL_SUPPORT
    IGUICTRL_SetState(MMK_GetCtrlPtr(MMIRECORD_LEFT_BUTTON_CTRL_ID), GUICTRL_STATE_KEYMODE_ACTIVE, TRUE);
    IGUICTRL_SetState(MMK_GetCtrlPtr(MMIRECORD_RIGHT_BUTTON_CTRL_ID), GUICTRL_STATE_KEYMODE_ACTIVE, TRUE);
    IGUICTRL_SetState(MMK_GetCtrlPtr(MMIRECORD_VOLUME_BUTTON_CTRL_ID), GUICTRL_STATE_KEYMODE_ACTIVE, TRUE);
    IGUICTRL_SetState(MMK_GetCtrlPtr(MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID), GUICTRL_STATE_KEYMODE_ACTIVE, TRUE);
    MMK_SetAtvCtrl(win_id,  MMIRECORD_LEFT_BUTTON_CTRL_ID);
#endif
    GUIWIN_SetSoftkeyTextId(win_id,  STXT_OPTION, TXT_NULL, STXT_RETURN, FALSE);
    ...
    rect.left = record_win_data_ptr->position.volume_button_x;
    rect.top = record_win_data_ptr->position.volume_button_y;
    rect.right = record_win_data_ptr->position.volume_button_x + record_win_data_ptr->position.volume_button_w;
    rect.bottom = record_win_data_ptr->position.volume_button_y + record_win_data_ptr->position.volume_button_h;
    GUIBUTTON_SetRect(MMIRECORD_VOLUME_BUTTON_CTRL_ID, &rect);

    rect.left = record_win_data_ptr->position.left_button_x;
    rect.top = record_win_data_ptr->position.left_button_y;
    rect.right = record_win_data_ptr->position.left_button_x + record_win_data_ptr->position.left_button_w;
    rect.bottom = record_win_data_ptr->position.left_button_y + record_win_data_ptr->position.left_button_h;
    GUIBUTTON_SetRect(MMIRECORD_LEFT_BUTTON_CTRL_ID, &rect);

    rect.left = record_win_data_ptr->position.right_button_x;
    rect.top = record_win_data_ptr->position.right_button_y;
    rect.right = record_win_data_ptr->position.right_button_x + record_win_data_ptr->position.right_button_w;
    rect.bottom = record_win_data_ptr->position.right_button_y + record_win_data_ptr->position.right_button_h;
    GUIBUTTON_SetRect(MMIRECORD_RIGHT_BUTTON_CTRL_ID, &rect);

    rect.left = record_win_data_ptr->position.istyle_back_button_x;
    rect.top = record_win_data_ptr->position.istyle_back_button_y;
    rect.right = record_win_data_ptr->position.istyle_back_button_x + record_win_data_ptr->position.istyle_back_button_w;
    rect.bottom = record_win_data_ptr->position.istyle_back_button_y + record_win_data_ptr->position.istyle_back_button_h;
    GUIBUTTON_SetRect(MMIRECORD_BACK_BUTTON_CTRL_ID, &rect);

    rect.left = record_win_data_ptr->position.istyle_option_button_x;
    rect.top = record_win_data_ptr->position.istyle_option_button_y;
    rect.right = record_win_data_ptr->position.istyle_option_button_x + record_win_data_ptr->position.istyle_option_button_w;
    rect.bottom = record_win_data_ptr->position.istyle_option_button_y + record_win_data_ptr->position.istyle_option_button_h;
    GUIBUTTON_SetRect(MMIRECORD_OPTION_BUTTON_CTRL_ID, &rect);

    rect.left = record_win_data_ptr->position.play_stop_button_x;
    rect.top = record_win_data_ptr->position.play_stop_button_y;
    rect.right = record_win_data_ptr->position.play_stop_button_x + record_win_data_ptr->position.play_stop_button_w - 1;
    rect.bottom = record_win_data_ptr->position.play_stop_button_y + record_win_data_ptr->position.play_stop_button_h - 1;
    GUIBUTTON_SetRect(MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID, &rect);
...
LOCAL void SetPortraitAndLandscapeFormParam(MMI_WIN_ID_T win_id)
{
    ...
    GUIRES_GetImgWidthHeight(&img_point_width, PNULL, IMAGE_RECORD_NUMBER_POINT, MMIRECORD_MAINPLAY_WIN_ID);
...
//#endif
    ...
    if(MMITHEME_IsMainScreenLandscape())
    {
        ...
        record_win_data_ptr->position.need_refresh_bg_h = MMI_MAINSCREEN_WIDTH - MMI_STATUSBAR_HEIGHT;
    }
    else
    {
        record_win_data_ptr->position.need_refresh_bg_x = 0;
        ...
        record_win_data_ptr->position.need_refresh_bg_h = MMI_MAINSCREEN_HEIGHT - MMI_STATUSBAR_HEIGHT;
    }
    ...
    if(MMITHEME_IsMainScreenLandscape())
    {
        record_win_data_ptr->position.need_refresh_bg_h = MMI_MAINSCREEN_WIDTH - MMI_STATUSBAR_HEIGHT - MMI_FULLSCREEN_SOFTKEY_BAR_HEIGHT;
    }
    else
    {
        record_win_data_ptr->position.need_refresh_bg_h = MMI_MAINSCREEN_HEIGHT - MMI_STATUSBAR_HEIGHT - MMI_FULLSCREEN_SOFTKEY_BAR_HEIGHT;
    }
...
LOCAL MMI_RESULT_E PlayStopButtonProc(void)
{
    ...
    MMK_SetAtvCtrl(win_handle,  MMIRECORD_PLAY_STOP_BUTTON_CTRL_ID);
...
LOCAL MMI_RESULT_E LeftButtonProc(void)
{
    ...
    MMK_SetAtvCtrl(win_handle,  MMIRECORD_LEFT_BUTTON_CTRL_ID);
...
LOCAL MMI_RESULT_E RightButtonProc(void)
{
    ...
    MMK_SetAtvCtrl(win_handle,  MMIRECORD_RIGHT_BUTTON_CTRL_ID);
    ...
    else if(MMIRECORD_BUTTON_STATE_NORMAL == record_win_data_ptr->button_validate[MMIRECORD_BUTTON_LIST])
    {
                                               ...
                                               )
{
    ...
    progress_bar_rect.left = record_win_data_ptr->position.progress_bg_x;
    progress_bar_rect.top = record_win_data_ptr->position.progress_bg_y - 6;
    progress_bar_rect.right = record_win_data_ptr->position.progress_bg_x + record_win_data_ptr->position.progress_bg_w;
    progress_bar_rect.bottom = record_win_data_ptr->position.progress_bg_y + record_win_data_ptr->position.progress_bg_h + 6;

    if(GUI_PointIsInRect(tp_point, progress_bar_rect))
    {
        percent = (uint16)(100 * (tp_point.x - record_win_data_ptr->position.progress_bg_x) / record_win_data_ptr->position.progress_bg_w);

        if(MMIRECORD_PlaySeek(percent))
        {
            record_win_data_ptr->is_begin = FALSE;
