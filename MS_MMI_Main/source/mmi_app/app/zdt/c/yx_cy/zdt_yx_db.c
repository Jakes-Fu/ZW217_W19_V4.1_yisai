...
#define YX_DB_SET_VERSION_NO 3
//#define YX_DB_IP_DOMAIN "dzxsz.yn139jy.com"
//#define YX_DB_IP_DOMAIN_PORT 40001
//#define YX_DB_IP_DOMAIN "cardlbs.hejiaoyu.com.cn"

#define YX_DB_IP_DOMAIN "183.220.196.169"
#define YX_DB_IP_DOMAIN_PORT 8899
//#define YX_DB_IP_DOMAIN "1.119.6.170"
//#define YX_DB_IP_DOMAIN_PORT 9124
//cardapi.hejiaoyu.com.cn
//#define YX_DB_APP_DOMAIN "cardapi.hejiaoyu.com.cn"
//#define YX_DB_APP_DOMAIN_PORT 80
#define YX_DB_APP_DOMAIN "api.hdkt100.net"
#define YX_DB_APP_DOMAIN_PORT 8088
...
BOOLEAN YX_DB_SET_Default(void)
{
    ...
    SCI_MEMCPY(yx_DB_Set_Rec.reg_ip_domain,YX_DB_IP_DOMAIN,strlen(YX_DB_IP_DOMAIN));
    yx_DB_Set_Rec.reg_ip_port = YX_DB_IP_DOMAIN_PORT;
    SCI_MEMCPY(yx_DB_Set_Rec.ip_domain,YX_DB_IP_DOMAIN,strlen(YX_DB_IP_DOMAIN));
    yx_DB_Set_Rec.ip_port = YX_DB_IP_DOMAIN_PORT;
    SCI_MEMCPY(yx_DB_Set_Rec.app_domain,YX_DB_APP_DOMAIN,strlen(YX_DB_APP_DOMAIN));
    yx_DB_Set_Rec.app_port = YX_DB_APP_DOMAIN_PORT;
    
    yx_DB_Set_Rec.version = YX_DB_SET_VERSION_NO;
    
    yx_DB_Set_Rec.time_interval = 600;
    yx_DB_Set_Rec.heart_interval = 300;
...
char * YX_DB_GetIpDomain(void)
{
    return yx_DB_Set_Rec.ip_domain;
}
#endif
...
YX_PB_LIST_Type yx_PbList_Reclist[YX_NEW_DB_MAX_NUM] = {0};
BOOLEAN num_is_sos(char* num)
{
	uint8 i=0;
	for(i=0;i<YX_DB_SOS_MAX_SUM;i++)
	{
		if(0==strcmp((char *)num,yx_DB_Sos_Reclist[i].sos_num))
		{
			return TRUE;
		}
	}
...
uint16 Get_Pb_List(void)
{
	...
	for(i=0;i<YX_DB_SOS_MAX_SUM;i++)
	{
		if(yx_DB_Sos_Reclist[i].db_id != 0 && SCI_STRLEN(yx_DB_Sos_Reclist[i].sos_num) > 0)
		{
                yx_PbList_Reclist[count].type = 1;
                yx_PbList_Reclist[count].db_id = yx_DB_Sos_Reclist[i].db_id;
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_num,yx_DB_Sos_Reclist[i].sos_num,SCI_STRLEN(yx_DB_Sos_Reclist[i].sos_num));
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_name,yx_DB_Sos_Reclist[i].sos_name,SCI_STRLEN(yx_DB_Sos_Reclist[i].sos_name));
                count++;
		}
	}
	...
	for(i=0;i<YX_DB_SPD_MAX_SUM;i++)
	{
		if(yx_DB_Spd_Reclist[i].db_id != 0 && SCI_STRLEN(yx_DB_Spd_Reclist[i].spd_num) > 0)
		{
                yx_PbList_Reclist[count].type = 2;
                yx_PbList_Reclist[count].db_id = yx_DB_Spd_Reclist[i].db_id;
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_num,yx_DB_Spd_Reclist[i].spd_num,SCI_STRLEN(yx_DB_Spd_Reclist[i].spd_num));
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_name,yx_DB_Spd_Reclist[i].spd_name,SCI_STRLEN(yx_DB_Spd_Reclist[i].spd_name));
                count++;
		}
	}
	for(i=0;i<YX_DB_WHITE_MAX_SUM;i++)
	{
		if(yx_DB_White_Reclist[i].db_id != 0 && SCI_STRLEN(yx_DB_White_Reclist[i].white_num) > 0)
		{
                yx_PbList_Reclist[count].type = 3;
                yx_PbList_Reclist[count].db_id = yx_DB_White_Reclist[i].db_id;
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_num,yx_DB_White_Reclist[i].white_num,SCI_STRLEN(yx_DB_White_Reclist[i].white_num));
                SCI_MEMCPY(yx_PbList_Reclist[count].pblist_name,yx_DB_White_Reclist[i].white_name,SCI_STRLEN(yx_DB_White_Reclist[i].white_name));
                count++;
		}
	}
	return count;
...
BOOLEAN YX_DB_REGIONAL_Fence_Check(GPS_DATA_T * gps_info)
{
    ...
    res = YX_DB_REGIONAL_Fence_CheckExt(new_latitude,new_longitude);
    return res;
}
...
BOOLEAN YX_DB_Default_Init(void)
{
   #if 1
   {
    const char * test_num = "0=18948735889+e5b08fe8b596!1=!2=15994730009+e5b08fe8b596!3=10000+e5b08fe8b596!4=10086+e5b08fe8b596!5=10081+e5b08fe8b596!";
    const char * wtest_num = "18948735889!@6C6F7765=18948735888=0000-2359+!@2@1+2+3+4+5+6+0";
    YX_Net_Receive_SET_NORMAL_BUTTON(&g_yx_app,test_num,strlen(test_num));
    YX_Net_Receive_SET_INCOMING_CALL(&g_yx_app,wtest_num,strlen(wtest_num));
   }
   #else
