#ifndef __WDP_MD5_H__
#define __WDP_MD5_H__
#include "sci_types.h"
...
PUBLIC void SG_MD5Init (SGMD5_CTX *context);
PUBLIC void SG_MD5Update(SGMD5_CTX *context,unsigned char * input,unsigned int  inputLen);
PUBLIC void SG_MD5Final (unsigned char digest[32],SGMD5_CTX *context);
