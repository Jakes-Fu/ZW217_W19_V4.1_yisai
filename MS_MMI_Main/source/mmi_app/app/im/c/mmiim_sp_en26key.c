...
LOCAL BOOLEAN HandleSysMsgNoInput(
    MMIIM_SP_EN26K_DATA_T *data_ptr,
...
/*==============================================================================
Function Name: SetBarCap
Description: SetBarCap
Author: Lianxiang.Zhou
Global resource dependence: NONE
Note:
==============================================================================*/
LOCAL void SetBarCap(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void DrawUI(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void ReDrawUI(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void CommitChar(MMIIM_SP_EN26K_DATA_T *data_ptr, wchar c);
...
Note:
==============================================================================*/
LOCAL void CommitStr(MMIIM_SP_EN26K_DATA_T *data_ptr, wchar *str, uint32 len);
...
Note:
==============================================================================*/
LOCAL BOOLEAN ChangeRect(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void SetToNoInput(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void SetToInputing(MMIIM_SP_EN26K_DATA_T *data_ptr);
...
Note:
==============================================================================*/
LOCAL void SetToSelecting(MMIIM_SP_EN26K_DATA_T *data_ptr);


GUIIM_KERNEL_APIS_T const g_guiim_sp_en26k_apis =
{
    Initialize,
    Terminate,
    HandleMsg,
...
LOCAL void* Initialize(GUIIM_INIT_KERNEL_T *param_ptr)
{
    MMIIM_SP_EN26K_DATA_T *data_ptr = PNULL;
    ...
    core_handle = SPIM_SPELLS_InitEnglish(&init_params);
    ...
    data_ptr = (MMIIM_SP_EN26K_DATA_T*)SCI_ALLOC_APP(sizeof(MMIIM_SP_EN26K_DATA_T));
    SCI_MEMSET(data_ptr, 0, sizeof(MMIIM_SP_EN26K_DATA_T));
	...
	win_rect = MMITHEME_GetClientRectEx(param_ptr->win_handle);
...
LOCAL BOOLEAN Terminate(void *handle)
{
    MMIIM_SP_EN26K_DATA_T *data_ptr = (MMIIM_SP_EN26K_DATA_T*)handle;
    ...
    SPIM_SPELLS_Term(data_ptr->core_handle);
...
)
{
    ...
    case MMIIM_SP_MSG_KEY_PRESS:
        ...
        case MMIIM_SP_KEY_Z:
            ...
            api_result = SPIM_SPELLS_Handle(data_ptr->core_handle,
...
)
{
    ...
    case MMIIM_SP_MSG_KEY_LONG_PRESS:
        ...
        {
        case MMIIM_SP_KEY_CANCEL:
            (void)SPIM_SPELLS_Handle(data_ptr->core_handle,
...
LOCAL void SetBarCap(MMIIM_SP_EN26K_DATA_T *data_ptr)
{
    ...
    case GUIIM_MODE_LOWER:
        MMIIM_SP_TextBarLower(&data_ptr->bar_edit);
        MMIIM_SP_TextBarLower(&data_ptr->bar_cand);
        break;

    case GUIIM_MODE_LEAD_UPPER:
        MMIIM_SP_TextBarLeadUpper(&data_ptr->bar_edit);
        MMIIM_SP_TextBarLeadUpper(&data_ptr->bar_cand);
        break;

    case GUIIM_MODE_UPPER:
        MMIIM_SP_TextBarUpper(&data_ptr->bar_edit);
        MMIIM_SP_TextBarUpper(&data_ptr->bar_cand);
        break;
...
LOCAL void CommitStr(MMIIM_SP_EN26K_DATA_T *data_ptr, wchar *str, uint32 len)
{
    ...
    //set the cap mode
    if (GUIIM_MODE_LEAD_UPPER == data_ptr->init_param.method_param_ptr->im_def_ptr->capital)
    {
        notify_pack.data.commit_data.commit[0] = toupper(str[0]);

        for (i = 1; i < len; i++)
        {
            notify_pack.data.commit_data.commit[i] = str[i];
        }
    }
    else if (GUIIM_MODE_UPPER == data_ptr->init_param.method_param_ptr->im_def_ptr->capital)
    {
        for (i = 0; i < len; i++)
        {
            notify_pack.data.commit_data.commit[i] = toupper(str[i]);
        }
    }
    else
    {
...
#else
GUIIM_KERNEL_APIS_T const g_guiim_sp_en26k_apis = {0};
