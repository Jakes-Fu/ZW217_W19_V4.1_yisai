...
LOCAL void* Initialize(GUIIM_INIT_KERNEL_T *param_ptr)
{
    ...
    data_ptr->bar_rect_0.top = data_ptr->bar_rect_0.bottom - MMIIM_SP_TEXT_BAR_HEIGHT + 1;
    //rect1
    data_ptr->bar_rect_1 = win_rect;
    data_ptr->bar_rect_1.bottom = data_ptr->bar_rect_0.top  - 1;
    data_ptr->bar_rect_1.top = data_ptr->bar_rect_1.bottom - MMIIM_SP_TEXT_BAR_HEIGHT + 1;
    //rect2
