...
//*maskMakers[0] = Mask_mask0;
//*maskMakers[1] = Mask_mask1;
//*maskMakers[2] = Mask_mask2;
//*maskMakers[3] = Mask_mask3;
//*maskMakers[4] = Mask_mask4;
//*maskMakers[5] = Mask_mask5;
//*maskMakers[6] = Mask_mask0;
//*maskMakers[7] = Mask_mask7;
#define maskNum (8)
//typedef int MaskMaker(int, const unsigned char *, unsigned char *);
//static MaskMaker *
static int( *maskMakers[maskNum])(int, const unsigned char *, unsigned char *) ={
//maskMakers[maskNum]) = {
...
unsigned char *Mask_mask(int width, unsigned char *frame, QRecLevel level)
{
    ...
    mask = (unsigned char *)SCI_ALLOC_APP(w2);
    if(mask == NULL) 
    {
        SCI_TRACE_LOW(" Mask_mask mask == NULL ");
        return NULL;
    }
    bestMask = NULL;

    for(i=0; i<maskNum; i++) //		n1 = n2 = n3 = n4 = 0;
    {    
        demerit = 0;
