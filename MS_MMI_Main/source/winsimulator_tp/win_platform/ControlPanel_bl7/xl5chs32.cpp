...
//added by mxzhu
VARIANT Workbook::Worksheets()
{
	VARIANT result;
	GetProperty(0x1ee,VT_VARIANT,(void*)&result);
	return result;
}
...
VARIANT Worksheet::Cells(const VARIANT& RowIndex, const VARIANT& ColumnIndex)
{
	...
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0xee, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, parms,
		&RowIndex, &ColumnIndex);
	//InvokeHelper(0xee, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
	//	&RowIndex, &ColumnIndex);
	return result;
...
//added by mxzhu
VARIANT Worksheet::GetCells()
{
	VARIANT result;
	InvokeHelper(0xee, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
	return result;
}
