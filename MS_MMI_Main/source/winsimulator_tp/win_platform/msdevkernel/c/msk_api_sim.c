...
/***************************************************************************
  ...
  Author:       Raislin.Kong
  Date:         2003.2
  Description:  c files define the api functions that sim module will export
                in the window platform.
***************************************************************************/
/***************************************************************************
                                ...
                                )
{
    return SIMSER_UpdateEFRecord_static(file_name,record_num,
        record_mode,ef_mapping,erasure_record, card_num);
}
