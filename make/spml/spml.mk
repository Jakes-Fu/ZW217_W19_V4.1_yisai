...
MINCPATH =  CAF/Template/include \
  ...
  $(MMI_DIR)/source/mmi_spml/source/autofit/h 
...
MSRCPATH =  $(MMI_DIR)/source/mmi_spml/source/bidi/c \
  ...
  $(MMI_DIR)/source/mmi_spml/source/autofit/c
...
SOURCES  =  spml_api.c spml_bidi.c spml_bidi_types.c spml_font.c spml_font_map.c spml_gc.c  \
  ...
  spml_util.c spml_image.c spml_outline.c spml_afhints.c spml_aflatin.c spml_afcjk.c \
  spml_afindic.c spml_autofit.c
