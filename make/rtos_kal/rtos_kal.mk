...
MCFLAG_OPT 		= -D__APCS_SWST -D__APCS_INTERWORK -D__TARGET_FPU_NONE
MCFLAG_OPT      += -DDEBUG_KAL -DKAL_ON_THREADX -DDEBUG_LEVEL=4 -DCORRUPTION_CHECK -DTARGET_ARM
...
MINCPATH =  RTOS/source/threadx/thumb \
			 RTOS/source/src_kal/inc
					
MSRCPATH =  RTOS/source/src_kal/c RTOS/source/threadx/thumb
...
SOURCES     	= tx_tcr.s tx_tcs.s tx_tic.s tx_timin.s tx_ts.s tx_tsb.s tx_tsr.s \
					...
					tx_scle.c tx_sd.c tx_sg.c tx_si.c tx_sig.c tx_sp.c tx_spri.c tx_ta.c tx_taa.c tx_tc.c \
					tx_threadx_stack_error_handler.c tx_threadx_stack_error_notify.c	
else
SOURCES     	=
endif
				
SOURCES        += threadx_mem.c threadx_os.c threadx_rst.c os_api.c \
