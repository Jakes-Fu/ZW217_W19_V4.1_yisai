...
if($number ne 13){
    die "\nInvalid parameters, param number must be 13.\n\n";
}
...
#ARGV[$index+7]:dspcode
#-----------------------------------------------#
if ( (${ARGV[$index+3]} eq "") && (${ARGV[$index+7]} eq "") && (${ARGV[$index+8]} eq ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
   ["FDL2"          , ${ARGV[$index+1]}  , 0x0101   , 1        , 0        , 0x14000000    , 0xFFFFFFFF  ],
...
elsif ( (${ARGV[$index+3]} eq "") && (${ARGV[$index+7]} eq "") && (${ARGV[$index+8]} ne ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
   ...
   ["PS"            , ${ARGV[$index+4]}  , 1        , 1        , 0        , 0x80000003    , 0xFFFFFFFF  ],
   ["MMIRes"        , ${ARGV[$index+5]}  , 1        , 1        , 1        , 0x90000004    , 0xFFFFFFFF  ],
   ["EraseUdisk"    , ""                 , 0        , 1        , 0        , 0x90000005    , 0xFFFFFFFF  ],
   ["UDISK"         , ${ARGV[$index+6]}  , 1        , 1        , 1        , 0x90000006    , 0xFFFFFFFF  ],
   ["FLASH"         , ""                 , 0        , 1        , 0        , 0x90000003    , 0xFFFFFFFF  ],
   ["PhaseCheck"    , ""                 , 0        , 1        , 0        , 0x90000002    , 0xFFFFFFFF  ],
   #config must be the last one
...
elsif ( (${ARGV[$index+3]} ne "") && (${ARGV[$index+7]} eq "") && (${ARGV[$index+8]} eq ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
...
elsif ( (${ARGV[$index+3]} ne "") && (${ARGV[$index+7]} eq "") && (${ARGV[$index+8]} ne ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
...
elsif ( (${ARGV[$index+3]} eq "") && (${ARGV[$index+7]} ne "") && (${ARGV[$index+8]} eq ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
   ...
   ["PS"            , ${ARGV[$index+4]}  , 1        , 1        , 0        , 0x80000003    , 0xFFFFFFFF  ],
   ["MMIRes"        , ${ARGV[$index+5]}  , 1        , 1        , 1        , 0x90000004    , 0xFFFFFFFF  ],
   ["DSPCode"       , ""                 , 1        , 2        , 1        , 0x90000009    , 0xFFFFFFFF  ],
   ["EraseUdisk"    , ""                 , 0        , 0        , 1        , 0x90000005    , 0xFFFFFFFF  ],
   ["UDISK"         , ${ARGV[$index+6]}  , 1        , 1        , 1        , 0x90000006    , 0xFFFFFFFF  ],
   ["FLASH"         , ""                 , 0        , 1        , 0        , 0x90000003    , 0xFFFFFFFF  ],
   ["PhaseCheck"    , ""                 , 0        , 1        , 0        , 0x90000002    , 0xFFFFFFFF  ],
...
elsif ( (${ARGV[$index+3]} eq "") && (${ARGV[$index+7]} ne "") && (${ARGV[$index+8]} ne ""))
{
@param = (
   #ID              , file_path          , file_flag, check_flag, omit_flag, addr1        , addr2 
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x40004000    , 0xFFFFFFFF  ],
