...
if($number ne 10){
    die "\nInvalid parameters, param number must be 10.\n\n";
}
...
@param = (
   ...
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x34000000		, 0xFFFFFFFF  ],
   ["NV"            , ${ARGV[$index+1]}  , 1        , 1        , 0        , 0x90000001		, 0xFFFFFFFF  ],
   ["PS"    				, ${ARGV[$index+3]}  , 1        , 1        , 0        , 0x80000003		, 0xFFFFFFFF  ],
   ["MMIRes"    		, ${ARGV[$index+4]}  , 1        , 1        , 1        , 0x90000004		, 0xFFFFFFFF  ],
   ["EraseUdisk" 		, ""                 , 0        , 1        , 0        , 0x90000005		, 0xFFFFFFFF  ],
   ["UDISK"    			, ${ARGV[$index+5]}  , 1        , 1        , 1        , 0x90000006		, 0xFFFFFFFF  ],
...
@param = (
   ...
   ["FDL"           , ${ARGV[$index+0]}  , 0x0101   , 1        , 0        , 0x34000000		, 0xFFFFFFFF  ],
   ["NV"            , ${ARGV[$index+1]}  , 1        , 1        , 0        , 0x90000001		, 0xFFFFFFFF  ],
   ["BOOTLOADER"    , ${ARGV[$index+2]}  , 1   			, 1        , 0       	, 0x80000000		, 0xFFFFFFFF  ],
   ["PS"    				, ${ARGV[$index+3]}  , 1        , 1        , 0        , 0x80000003		, 0xFFFFFFFF  ],
   ["MMIRes"    		, ${ARGV[$index+4]}  , 1        , 1        , 1        , 0x90000004		, 0xFFFFFFFF  ],
   ["EraseUdisk" 		, ""                 , 0        , 1        , 0        , 0x90000005		, 0xFFFFFFFF  ],
   ["UDISK"    			, ${ARGV[$index+5]}  , 1        , 1        , 1        , 0x90000006		, 0xFFFFFFFF  ],
