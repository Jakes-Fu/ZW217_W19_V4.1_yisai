...
**                               Micro Define                                **
**---------------------------------------------------------------------------*/
#define KPD_CTRL 				0x87000000
#define KPD_INT_RAW_STATUS 	    0x87000008
#define KPD_INT_CLR 		    0x87000010
#define KPD_POLARITY 			0x87000018
#define KPD_DEBOUNCE_CNT 		0x8700001c
#define KPD_CLK_DIVIDE_CNT 		0x87000028
#define KEY_STATUS 				0x8700002c
#define KEY_STATUS_MASK         (0x77)
...
#define KPD_ROW_EN_MSK                  (0x07 << KPD_ROW_EN_SHIFT)
#define KPD_COL_EN_SHIFT                20
#define KPD_COL_EN_MSK                  (0x1F << KPD_COL_EN_SHIFT)

#define KPD_FIRST_ROW_EN                4
#define KPD_FIRST_COL_EN                3
