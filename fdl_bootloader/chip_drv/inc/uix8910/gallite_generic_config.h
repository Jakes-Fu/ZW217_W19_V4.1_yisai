...
#ifdef CT_ASM
#error "You are trying to use in an assembly code the normal H description of 'gallite_generic_config'."
#endif
...
#define USB_OPTION                              (1)
/// Ap Ifc Number of generic channel (range 2 to 7)
#define AP_IFC_NB_STD_CHANNEL                   (7)
/// Aon Ifc Number of generic channel (range 2 to 7)
#define AON_IFC_NB_STD_CHANNEL                  (2)
/// Gge Ifc Number of generic channel (range 2 to 7)
#define SYS_IFC_NB_STD_CHANNEL                  (2)
/// audio Ifc Number of generic channel (range 0 to 4)
