...
#ifndef _CP_CLKRST_ASM_H_
#define _CP_CLKRST_ASM_H_

//THIS FILE HAS BEEN GENERATED WITH COOLWATCHER. PLEASE EDIT WITH CARE !

#ifndef CT_ASM
#error "You are trying to use in a normal C code the assembly H description of 'cp_clkrst'."
#endif
...
#define REG_CLKRST_BASE_HI         BASE_HI(REG_CLKRST_BASE)
#define REG_CLKRST_BASE_LO         BASE_LO(REG_CLKRST_BASE)

#define REG_CLKRST_CLKSEL          REG_CLKRST_BASE_LO + 0x00000000
#define REG_CLKRST_CLKSEL_SET      REG_CLKRST_BASE_LO + 0x00000004
#define REG_CLKRST_CLKSEL_CLR      REG_CLKRST_BASE_LO + 0x00000008
#define REG_CLKRST_CLKDIV_ZSP      REG_CLKRST_BASE_LO + 0x0000000C
#define REG_CLKRST_CLKDIV_LTE      REG_CLKRST_BASE_LO + 0x00000010
#define REG_CLKRST_CLKEN_BB_SYSCTRL REG_CLKRST_BASE_LO + 0x00000014
#define REG_CLKRST_CLKEN_BB_SYSCTRL_SET REG_CLKRST_BASE_LO + 0x00000018
#define REG_CLKRST_CLKEN_BB_SYSCTRL_CLR REG_CLKRST_BASE_LO + 0x0000001C
#define REG_CLKRST_CLKEN_ZSP       REG_CLKRST_BASE_LO + 0x00000020
#define REG_CLKRST_CLKEN_ZSP_SET   REG_CLKRST_BASE_LO + 0x00000024
#define REG_CLKRST_CLKEN_ZSP_CLR   REG_CLKRST_BASE_LO + 0x00000028
#define REG_CLKRST_CLKEN_LTE       REG_CLKRST_BASE_LO + 0x0000002C
#define REG_CLKRST_CLKEN_LTE_SET   REG_CLKRST_BASE_LO + 0x00000030
#define REG_CLKRST_CLKEN_LTE_CLR   REG_CLKRST_BASE_LO + 0x00000034
#define REG_CLKRST_CLKEN_ZSPCORE_MODE REG_CLKRST_BASE_LO + 0x00000038
#define REG_CLKRST_CLKEN_ZSP_AXIDMA_MODE REG_CLKRST_BASE_LO + 0x0000003C
#define REG_CLKRST_RSTCTRL_BB_SYSCTRL REG_CLKRST_BASE_LO + 0x00000040
#define REG_CLKRST_RSTCTRL_BB_SYSCTRL_SET REG_CLKRST_BASE_LO + 0x00000044
#define REG_CLKRST_RSTCTRL_BB_SYSCTRL_CLR REG_CLKRST_BASE_LO + 0x00000048
#define REG_CLKRST_RSTCTRL_ZSP     REG_CLKRST_BASE_LO + 0x0000004C
#define REG_CLKRST_RSTCTRL_ZSP_SET REG_CLKRST_BASE_LO + 0x00000050
#define REG_CLKRST_RSTCTRL_ZSP_CLR REG_CLKRST_BASE_LO + 0x00000054
#define REG_CLKRST_RSTCTRL_LTE     REG_CLKRST_BASE_LO + 0x00000058
#define REG_CLKRST_RSTCTRL_LTE_SET REG_CLKRST_BASE_LO + 0x0000005C
#define REG_CLKRST_RSTCTRL_LTE_CLR REG_CLKRST_BASE_LO + 0x00000060
#define REG_CLKRST_ZSP_SOFT_RST    REG_CLKRST_BASE_LO + 0x00000064
#define REG_CLKRST_LTE_SOFT_RST    REG_CLKRST_BASE_LO + 0x00000068
#define REG_CLKRST_ZSP_AXILPCNT    REG_CLKRST_BASE_LO + 0x0000006C
#define REG_CLKRST_ZSP_BUSLPMC     REG_CLKRST_BASE_LO + 0x00000070
#define REG_CLKRST_ZSP_BUSLPMC_SET REG_CLKRST_BASE_LO + 0x00000074
#define REG_CLKRST_ZSP_BUSLPMC_CLR REG_CLKRST_BASE_LO + 0x00000078
#define REG_CLKRST_ZSP_BUSFORCELPMC REG_CLKRST_BASE_LO + 0x0000007C
#define REG_CLKRST_ZSP_BUSFORCELPMC_SET REG_CLKRST_BASE_LO + 0x00000080
#define REG_CLKRST_ZSP_BUSFORCELPMC_CLR REG_CLKRST_BASE_LO + 0x00000084
#define REG_CLKRST_CLKEN_MAILBOX_MODE REG_CLKRST_BASE_LO + 0x00000088
#define REG_CLKRST_CLKEN_LTE_INTF  REG_CLKRST_BASE_LO + 0x0000008C
#define REG_CLKRST_CLKEN_LTE_INTF_SET REG_CLKRST_BASE_LO + 0x00000090
#define REG_CLKRST_CLKEN_LTE_INTF_CLR REG_CLKRST_BASE_LO + 0x00000094
#define REG_CLKRST_LTE_AUTOGATE_MODE REG_CLKRST_BASE_LO + 0x00000098
#define REG_CLKRST_LTE_AUTOGATE_EN REG_CLKRST_BASE_LO + 0x0000009C
#define REG_CLKRST_LTE_AUTOGATE_EN_SET REG_CLKRST_BASE_LO + 0x000000A0
#define REG_CLKRST_LTE_AUTOGATE_EN_CLR REG_CLKRST_BASE_LO + 0x000000A4
#define REG_CLKRST_LTE_AUTOGATE_DELAY_NUM REG_CLKRST_BASE_LO + 0x000000A8
