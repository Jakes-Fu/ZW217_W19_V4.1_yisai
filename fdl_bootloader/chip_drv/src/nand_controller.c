...
LOCAL ERR_NF_E NANDCTL_ONDIE_ECCCorrect(void);
/******************************************************************************
                        Functions
******************************************************************************/
...
LOCAL void NFC_WAIT_COMMAND_FINISH()
{
    ...
    if (s_nandctl_ptr->cmd& (BIT_31))
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,NAND_CONTROLLER_161_112_2_18_1_0_7_0,(uint8*)"");
...
PUBLIC ERR_NF_E NANDCTL_SetParam (uint32 ahb_clk)
{
    ...
    if ( ( (nandctl_ptr->cmd>>31) &0x1) && ( (counter+NF_TIMEOUT_VAL) < (SCI_GetTickCount())))
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,NAND_CONTROLLER_881_112_2_18_1_0_8_1,(uint8*)"");
        SCI_RestoreIRQ();
        return ERR_NF_FAIL;
    }
...
RESET_LOOP:
    ...
    // NFC_WAIT_COMMAND_FINISH();
    {
        ...
        {
            //SCI_TRACE_LOW:"NFC timeout happened!"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,NAND_CONTROLLER_1120_112_2_18_1_0_9_2,(uint8*)"");
            TM_SendTestPointRequest (0x6e616e64, 2);
