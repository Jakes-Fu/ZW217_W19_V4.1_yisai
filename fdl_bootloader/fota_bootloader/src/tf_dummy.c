...
{
    HWP_TIMER_T *timer_ctl_1;
    HWP_TIMER_AP_T *timer_ctl_2;
    uint32 val = 0;
    ...
    switch(timer_id)
    {
        case TIMER_1:
        {
            timer_ctl_1 = (HWP_TIMER_AP_T*)(REG_TIMER1_BASE);
            val = timer_ctl_1->HWTimer_CurVal;
            break;
        }
        case TIMER_2:
        {
            timer_ctl_2 = (HWP_TIMER_AP_T*)(REG_TIMER2_BASE);
...
/*****************************************************************************/
PUBLIC void SCI_Sleep(uint32 ms_delay)
{
    uint32 wait_time = 0;
    uint32 wait_time2 = 0;
...
void GPIO_SetValue (uint32 gpio_id, BOOLEAN b_on)
{

}

void GPIO_EnableIntCtl (uint32 gpio_id)
{

}

void GPIO_DisableIntCtl (uint32 gpio_id)
{

}

void GPIO_SetDirection (uint32  gpio_id, BOOLEAN directions)
{

}

BOOLEAN halEfuseSingleRead(uint32 block_index, uint32 *val)
{
    return TRUE;
}
