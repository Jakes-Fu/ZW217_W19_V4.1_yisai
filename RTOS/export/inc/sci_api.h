...
/*****************************************************************************/
PUBLIC void *SCI_Mem16Cpy(    /*lint -esym(765, SCI_Mem16Cpy)*/  // None
...
/*****************************************************************************/
PUBLIC void *SCI_Mem16Set(  /*lint -esym(765, SCI_Mem16Set)*/// None
...
******************************************************************************/
  ...
  #define SCI_CREATE_SIGNAL(_SIG_PTR, _SIG_CODE, _SIG_SIZE, _SENDER) \
		...
		SCI_Create_Signal((xSignalHeader)(_SIG_PTR), _SIG_CODE, _SIG_SIZE, _SENDER);
#else
  #define SCI_CREATE_SIGNAL(_SIG_PTR, _SIG_CODE, _SIG_SIZE, _SENDER) \
		(_SIG_PTR) = (void*)SCI_ALLOC_BASE(_SIG_SIZE);\
