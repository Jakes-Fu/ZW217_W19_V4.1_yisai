...
)
{
    ...
    {
        hAtcVoiceRing    = AUDIO_CreateNormalHandle(hVoiceCodec,    SCI_NULL, hAUDDEVDUAL,     SCI_NULL, AudioDummyNotifyCallback);
    ...
    else
    {
        ...
        AUDIO_CloseHandle(hAtcVoiceRing);
        hAtcVoiceRing = INVALID_HANDLE;
    }
