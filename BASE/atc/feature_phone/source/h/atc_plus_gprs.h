 ...
 ******************************************************************************/
 ...
 #define MAX_PDP_TYPE_LEN 7   //longest str: ipv4v6
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessAttResult(
                        ATC_CONFIG_T        *atc_config_ptr,
...
//    Note : 
/******************************************************************************/ 
extern void ATC_HandleDataReqPendingList(uint8  nsapi);
...
//    Note : 
/******************************************************************************/
extern void ATC_FreeDataReqPendingList(uint8  nsapi);
...
extern ATC_STATUS ATC_ProcessCGEQOS(// return the handle result
                 ATC_CONFIG_T        *atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
);
#endif
