...
typedef enum
{
    ATC_GET_CVS_MODE_NUM = 0,   // 0: get CVS mode total number
    ATC_GET_CVS_MODE_NAME,      // 1: get CVS mode name
    ATC_GET_CVS_MODE_MEM_DATA,  // 2: get CVS parameter from memory
    ATC_SET_CVS_MODE_MEM_DATA,  // 3: set CVS parameter to memory
    ATC_GET_CVS_MODE_NV_DATA,   // 4: get CVS parameter from flash
    ATC_SET_CVS_MODE_NV_DATA    // 5: set CVS parameter to flash
}ATC_CVS_MODE_OPT_TYPE_E;
