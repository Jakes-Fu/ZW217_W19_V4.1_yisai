...
#define AT_CLCK_DATA            0X02
#define AT_CLCK_FAX              0X04
...
#define AT_CUSD_DEFAULTALPHABET    0X0f
...
#define  ATC_USSD_MAX_STRING_LENGTH   (MN_SS_MAX_USSD_STRING_LENGTH_BEFORE_ENCODE*4+1)
/*******************************************************************************
 **                              Type declaration                              *
 ******************************************************************************/
...
typedef enum
{
    ATC_VOICE,              // voice service
    ATC_DATA,               // data service
    ATC_FAX,                // fax service
    ATC_CS_DATA_SYNC,     //data circuit sync
    ATC_ALL_CLASSES         // all the basic services
} ATC_CLASS_E;
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessWaitingInd(
    ATC_CONFIG_T              *atc_config_ptr,
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessClirSuppRejInd(
    ATC_CONFIG_T              *atc_config_ptr,
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessCallDeflectInd(
    ATC_CONFIG_T              *atc_config_ptr,
...
/*****************************************************************************/
//  Description : This function check if there is a outgoing call
//  Global resource dependence : none
//  Author:       minqian qian
//  Note:
/*****************************************************************************/
extern BOOLEAN CheckPresentOutgoingCall(
    ATC_CALLS_STATE_T   *call_state_ptr,
    uint8               *call_id
);
...
//  Note: NA
/*****************************************************************************/
extern BOOLEAN ATC_InterrogateCFService(
    MN_SS_CODE_E ss_code,
    MN_DUAL_SYS_E   dual_sys
);
...
//  Note:
/*****************************************************************************/
extern void ATC_RestoreGsmSSConfig(MN_DUAL_SYS_E  dual_sys);
...
//  Note:
/*****************************************************************************/
extern BOOLEAN ATC_EnableVoiceCodec(                   // If succeed, return SCI_TRUE, else return error value
...
//  Note
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessFDNServiceInd(
    ATC_CONFIG_T                   *atc_config_ptr,
...
//  command format:
//                AT+SCCBS=<operate mode>[,<ccbs index>,<class>]
//  Global resource dependence : none
//  Author:       Haoming Lu
//  Note:
/*****************************************************************************/
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessCCBSActInd(
    ATC_CONFIG_T * atc_config_ptr,
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessCCBSRecallInd(
    ATC_CONFIG_T * atc_config_ptr,
...
//  Note:
/*****************************************************************************/
extern ATC_STATUS ATC_ProcessCCBSEraseCnf(
    ATC_CONFIG_T * atc_config_ptr,
