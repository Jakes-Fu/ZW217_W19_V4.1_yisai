...
// ATC thread define.
#define   P_ATC_STACK_SIZE              5120
static uint32    P_ATC_THREAD_ADDR[P_ATC_STACK_SIZE >> 2];
#define   P_ATC_QUEUE_NUM               200
static uint32    P_ATC_QUEUE_ADDR[P_ATC_QUEUE_NUM *SCI_QUEUE_ITEM_SIZE];



// Create static thread macro.
#define CREATE_PS_STATIC_THREAD(NAME, THREAD_ENTRY, PRIO) \
SCI_CREATE_STATIC_THREAD( NAME, "T_"#NAME, THREAD_ENTRY, 0, 0, \
...
{
    CREATE_PS_STATIC_THREAD(P_ATC, ATC_Task, PRI_BASE_ATC_TASK);
    return 0;
}
