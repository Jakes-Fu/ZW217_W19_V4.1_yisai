...
)
{
    ...
    SCI_ASSERT(NULL != ptr);/*assert verified: check null pointer*/
    SCI_ASSERT(ATC_MAX_HEAP_NUM > g_atc_cur_heap_index);/*assert verified: check valid value*/
    SCI_ASSERT(NULL != g_atc_heap_base_ptr[g_atc_cur_heap_index]);/*assert verified: check null pointer*/
    SCI_ASSERT(NULL != g_atc_heap_end_ptr[g_atc_cur_heap_index]);/*assert verified: check null pointer*/
    SCI_ASSERT(NULL != g_atc_heap_free_ptr[g_atc_cur_heap_index]);/*assert verified: check null pointer*/
...
)
{
    ...
    SCI_ASSERT(NULL == g_atc_heap_end_ptr[g_atc_cur_heap_index]);/*assert verified: check null pointer*/
    SCI_ASSERT(NULL == g_atc_heap_free_ptr[g_atc_cur_heap_index]);/*assert verified: check null pointer*/
    SCI_ASSERT(0 == g_atc_heap_size[g_atc_cur_heap_index]);/*assert verified: check valid value*/
