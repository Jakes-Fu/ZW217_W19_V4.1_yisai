...
#define FULLCLOSED_FROM_TIMEOUT   4  /* async-select full closed caused by TIMEOUT */
...
#define  SO_INFORCLOSE   0x1018   /*set/get infor app close flag*/
...
#define TCP_RETRIES          0x2009     /* set tcp retries times */
