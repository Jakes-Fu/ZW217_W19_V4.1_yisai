...
#define WB_BOOL BOOLEAN
#define WB_UTINY uint8
#define WB_TINY char
#define WB_ULONG uint32
#define WB_LONG int32
...
#define WBXML_STRCASECMP(a,b) CFLCHAR_StrICmp((WB_TINY*)a,(WB_TINY*)b)
...
#define WBXML_LOW_MEMORY_SUPPORT
#define WBXML_SUPPORT_OTA_SETTINGS
#ifndef WBXML_LOW_MEMORY_SUPPORT
