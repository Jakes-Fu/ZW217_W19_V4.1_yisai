...
void Map252_Write(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
  ...
  case 0xB000:
    ...
    pGData->PPUBANK[ 0 ] = VROMPAGE(Map252_Reg[0] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;	
  case 0xB004:
  ...
  case 0xB008:
    ...
    pGData->PPUBANK[ 1 ] = VROMPAGE(Map252_Reg[1] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xB00C:
  ...
  case 0xC000:
    ...
    pGData->PPUBANK[ 2 ] = VROMPAGE(Map252_Reg[2] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xC004:
  ...
  case 0xC008:
    ...
    pGData->PPUBANK[ 3 ] = VROMPAGE(Map252_Reg[3] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xC00C:
  ...
  case 0xD000:
    ...
    pGData->PPUBANK[ 4 ] = VROMPAGE(Map252_Reg[4] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xD004:
  ...
  case 0xD008:
    ...
    pGData->PPUBANK[ 5 ] = VROMPAGE(Map252_Reg[5] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xD00C:
  ...
  case 0xE000:
    ...
    pGData->PPUBANK[ 6 ] = VROMPAGE(Map252_Reg[6] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xE004:
  ...
  case 0xE008:
    ...
    pGData->PPUBANK[ 7 ] = VROMPAGE(Map252_Reg[7] % (NesHeader.byVRomSize<<3));
    InfoNES_SetupChr(pGData);
    break;
  case 0xE00C:
