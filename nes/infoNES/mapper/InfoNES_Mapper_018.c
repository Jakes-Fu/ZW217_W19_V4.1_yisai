...
void Map18_Write(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
  switch( wAddr )
  {
    ...
    case 0x8000:
      ...
      pGData->ROMBANK0 = ROMPAGE( Map18_Regs[ 0 ] % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    case 0x8002:
      ...
      pGData->ROMBANK1 = ROMPAGE( Map18_Regs[ 1 ] % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    case 0x9000:
      ...
      pGData->ROMBANK2 = ROMPAGE( Map18_Regs[ 2 ] % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    case 0xA000:
      ...
      pGData->PPUBANK[ 0 ] = VROMPAGE( Map18_Regs[ 3 ] % ( NesHeader.byVRomSize << 3 ) );
    ...
    case 0xA002:
      ...
      pGData->PPUBANK[ 1 ] = VROMPAGE( Map18_Regs[ 4 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);         
      break;
    ...
    case 0xB000:
      ...
      pGData->PPUBANK[ 2 ] = VROMPAGE( Map18_Regs[ 5 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);      
      break;
    ...
    case 0xB002:
      ...
      pGData->PPUBANK[ 3 ] = VROMPAGE( Map18_Regs[ 6 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);         
      break;
    ...
    case 0xC000:
      ...
      pGData->PPUBANK[ 4 ] = VROMPAGE( Map18_Regs[ 7 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);      
      break;
    ...
    case 0xC002:
      ...
      pGData->PPUBANK[ 5 ] = VROMPAGE( Map18_Regs[ 8 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);         
      break;
    ...
    case 0xD000:
      ...
      pGData->PPUBANK[ 6 ] = VROMPAGE( Map18_Regs[ 9 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);      
      break;
    ...
    case 0xD002:
      ...
      pGData->PPUBANK[ 7 ] = VROMPAGE( Map18_Regs[ 10 ] % ( NesHeader.byVRomSize << 3 ) );
      InfoNES_SetupChr(pGData);         
      break;
    ...
    case 0xF002:
      switch ( byData & 0x03 )
      {
        ...
        case 1:
          ...
          break;
        case 2:
          InfoNES_Mirroring(pGData, 3 );   /* One Screen 0x2000 */
          break;
      }    
      break;
  }
