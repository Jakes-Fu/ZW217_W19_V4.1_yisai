...
void Map5_Init(Nes_Global_T *pGData)
{
  ...
  Map5_Wram = (BYTE *)NesMallocFromWRE(0x2000 * 8 * sizeof (BYTE));
  if (NULL == Map5_Wram)
  	return;
  Map5_Ex_Ram = (BYTE *)NesMallocFromWRE(0x400 * sizeof (BYTE));
  if (NULL == Map5_Ex_Ram)
  	return;
  Map5_Ex_Vram = (BYTE *)NesMallocFromWRE(0x400 * sizeof (BYTE));
  if (NULL == Map5_Ex_Vram)
  	return;
  Map5_Ex_Nam = (BYTE *)NesMallocFromWRE(0x400 * sizeof (BYTE));
  if (NULL == Map5_Ex_Nam)
  	return;
  ...
  /* Set ROM Banks */
  pGData->ROMBANK0 = ROMLASTPAGE( 0 );
  pGData->ROMBANK1 = ROMLASTPAGE( 0 );
  pGData->ROMBANK2 = ROMLASTPAGE( 0 );
...
void Map5_Apu(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
  ...
  switch ( wAddr )
  {
    ...
    case 0x5105:
      for ( nPage = 0; nPage < 4; nPage++ )
      {
        ...
        switch ( byNamReg )
        {
          case 0:
#if 1
            pGData->PPUBANK[ nPage + 8 ] = VRAMPAGE( 0 );
#else
            pGData->PPUBANK[ nPage + 8 ] = CRAMPAGE( 8 );
#endif
            break;
          case 1:
#if 1
            pGData->PPUBANK[ nPage + 8 ] = VRAMPAGE( 1 );
#else
            pGData->PPUBANK[ nPage + 8 ] = CRAMPAGE( 9 );
#endif
            break;
          case 2:
            pGData->PPUBANK[ nPage + 8 ] = Map5_Ex_Vram;
            break;
          case 3:
            pGData->PPUBANK[ nPage + 8 ] = Map5_Ex_Nam;
            break;
        }
      }
      break;
    ...
    case 0x5113:
      ...
      pGData->SRAMBANK = Map5_ROMPAGE( byData & 0x07 );
      break;
...
/*-------------------------------------------------------------------*/
void Map5_Sram(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
...
void Map5_HSync(Nes_Global_T *pGData)
{
  ...
  {
    if ( pGData->PPU_Scanline == Map5_IRQ_Line )
    {
...
void Map5_RenderScreen(Nes_Global_T *pGData, BYTE byMode )
{
  ...
  switch ( Map5_Chr_Size )
  {
    case 0:
      ...
      pGData->PPUBANK[ 0 ] = VROMPAGE( dwPage[ 7 ] + 0 );
      pGData->PPUBANK[ 1 ] = VROMPAGE( dwPage[ 7 ] + 1 );
      pGData->PPUBANK[ 2 ] = VROMPAGE( dwPage[ 7 ] + 2 );
      pGData->PPUBANK[ 3 ] = VROMPAGE( dwPage[ 7 ] + 3 );
      pGData->PPUBANK[ 4 ] = VROMPAGE( dwPage[ 7 ] + 4 );
      pGData->PPUBANK[ 5 ] = VROMPAGE( dwPage[ 7 ] + 5 );
      pGData->PPUBANK[ 6 ] = VROMPAGE( dwPage[ 7 ] + 6 );
      pGData->PPUBANK[ 7 ] = VROMPAGE( dwPage[ 7 ] + 7 );
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 1:
      ...
      pGData->PPUBANK[ 0 ] = VROMPAGE( dwPage[ 3 ] + 0 );
      pGData->PPUBANK[ 1 ] = VROMPAGE( dwPage[ 3 ] + 1 );
      pGData->PPUBANK[ 2 ] = VROMPAGE( dwPage[ 3 ] + 2 );
      pGData->PPUBANK[ 3 ] = VROMPAGE( dwPage[ 3 ] + 3 );
      pGData->PPUBANK[ 4 ] = VROMPAGE( dwPage[ 7 ] + 0 );
      pGData->PPUBANK[ 5 ] = VROMPAGE( dwPage[ 7 ] + 1 );
      pGData->PPUBANK[ 6 ] = VROMPAGE( dwPage[ 7 ] + 2 );
      pGData->PPUBANK[ 7 ] = VROMPAGE( dwPage[ 7 ] + 3 );
     InfoNES_SetupChr(pGData);
      break;
    ...
    case 2:
      ...
      pGData->PPUBANK[ 0 ] = VROMPAGE( dwPage[ 1 ] + 0 );
      pGData->PPUBANK[ 1 ] = VROMPAGE( dwPage[ 1 ] + 1 );
      pGData->PPUBANK[ 2 ] = VROMPAGE( dwPage[ 3 ] + 0 );
      pGData->PPUBANK[ 3 ] = VROMPAGE( dwPage[ 3 ] + 1 );
      pGData->PPUBANK[ 4 ] = VROMPAGE( dwPage[ 5 ] + 0 );
      pGData->PPUBANK[ 5 ] = VROMPAGE( dwPage[ 5 ] + 1 );
      pGData->PPUBANK[ 6 ] = VROMPAGE( dwPage[ 7 ] + 0 );
      pGData->PPUBANK[ 7 ] = VROMPAGE( dwPage[ 7 ] + 1 );
      InfoNES_SetupChr(pGData);
      break;
    ...
    default:
      ...
      pGData->PPUBANK[ 0 ] = VROMPAGE( dwPage[ 0 ] );
      pGData->PPUBANK[ 1 ] = VROMPAGE( dwPage[ 1 ] );
      pGData->PPUBANK[ 2 ] = VROMPAGE( dwPage[ 2 ] );
      pGData->PPUBANK[ 3 ] = VROMPAGE( dwPage[ 3 ] );
      pGData->PPUBANK[ 4 ] = VROMPAGE( dwPage[ 4 ] );
      pGData->PPUBANK[ 5 ] = VROMPAGE( dwPage[ 5 ] );
      pGData->PPUBANK[ 6 ] = VROMPAGE( dwPage[ 6 ] );
      pGData->PPUBANK[ 7 ] = VROMPAGE( dwPage[ 7 ] );
      InfoNES_SetupChr(pGData);
      break;
  }
}
...
void Map5_Sync_Prg_Banks( Nes_Global_T *pGData )
{
  switch( Map5_Prg_Size )
  {
    case 0:
      ...
      pGData->ROMBANK0 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7c) + 0 ) % ( NesHeader.byRomSize << 1 ) );
      pGData->ROMBANK1 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7c) + 1 ) % ( NesHeader.byRomSize << 1 ) );
      pGData->ROMBANK2 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7c) + 2 ) % ( NesHeader.byRomSize << 1 ) );
      pGData->ROMBANK3 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7c) + 3 ) % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    case 1:
      if ( Map5_Prg_Reg[ 5 ] & 0x80 )
      {
        Map5_Wram_Reg[ 4 ] = 0xff;
        Map5_Wram_Reg[ 5 ] = 0xff;
        pGData->ROMBANK0 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7e) + 0 ) % ( NesHeader.byRomSize << 1 ) );
        pGData->ROMBANK1 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7e) + 1 ) % ( NesHeader.byRomSize << 1 ) );
      } else {
        Map5_Wram_Reg[ 4 ] = ( Map5_Prg_Reg[ 5 ] & 0x06 ) + 0;
        Map5_Wram_Reg[ 5 ] = ( Map5_Prg_Reg[ 5 ] & 0x06 ) + 1;
        pGData->ROMBANK0 = Map5_ROMPAGE( Map5_Wram_Reg[ 4 ] );
        pGData->ROMBANK1 = Map5_ROMPAGE( Map5_Wram_Reg[ 5 ] );
      }

      Map5_Wram_Reg[ 6 ] = 0xff;
      pGData->ROMBANK2 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7e) + 0 ) % ( NesHeader.byRomSize << 1 ) );
      pGData->ROMBANK3 = ROMPAGE( ( (Map5_Prg_Reg[7] & 0x7e) + 1 ) % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    case 2:
      if ( Map5_Prg_Reg[ 5 ] & 0x80 )
      {
        Map5_Wram_Reg[ 4 ] = 0xff;
        Map5_Wram_Reg[ 5 ] = 0xff;
        pGData->ROMBANK0 = ROMPAGE( ( (Map5_Prg_Reg[5] & 0x7e) + 0 ) % ( NesHeader.byRomSize << 1 ) );
        pGData->ROMBANK1 = ROMPAGE( ( (Map5_Prg_Reg[5] & 0x7e) + 1 ) % ( NesHeader.byRomSize << 1 ) );
      } else {
        Map5_Wram_Reg[ 4 ] = ( Map5_Prg_Reg[ 5 ] & 0x06 ) + 0;
        Map5_Wram_Reg[ 5 ] = ( Map5_Prg_Reg[ 5 ] & 0x06 ) + 1;
        pGData->ROMBANK0 = Map5_ROMPAGE( Map5_Wram_Reg[ 4 ] );
      ...
      {
        Map5_Wram_Reg[ 6 ] = 0xff;
        pGData->ROMBANK2 = ROMPAGE( (Map5_Prg_Reg[6] & 0x7f) % ( NesHeader.byRomSize << 1 ) );
      } else {
        Map5_Wram_Reg[ 6 ] = Map5_Prg_Reg[ 6 ] & 0x07;
        pGData->ROMBANK2 = Map5_ROMPAGE( Map5_Wram_Reg[ 6 ] );
      }

      pGData->ROMBANK3 = ROMPAGE( (Map5_Prg_Reg[7] & 0x7f) % ( NesHeader.byRomSize << 1 ) );
      break;
    ...
    default:
      ...
      {
        Map5_Wram_Reg[ 4 ] = 0xff;
        pGData->ROMBANK0 = ROMPAGE( (Map5_Prg_Reg[4] & 0x7f) % ( NesHeader.byRomSize << 1 ) );
      } else {
      ...
      {
        Map5_Wram_Reg[ 5 ] = 0xff;
        pGData->ROMBANK1 = ROMPAGE( (Map5_Prg_Reg[5] & 0x7f) % ( NesHeader.byRomSize << 1 ) );
      } else {
