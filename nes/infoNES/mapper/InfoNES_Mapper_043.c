...
void Map43_Init(Nes_Global_T *pGData)
{
  ...
  /* Set SRAM Banks */
  pGData->SRAMBANK = ROMPAGE( 2 );

  /* Set ROM Banks */
  pGData->ROMBANK0 = ROMPAGE( 1 );
  pGData->ROMBANK1 = ROMPAGE( 0 );
  pGData->ROMBANK2 = ROMPAGE( 4 );
  pGData->ROMBANK3 = ROMPAGE( 9 );
...
BYTE Map43_ReadApu(Nes_Global_T *pGData, WORD wAddr )
{
  ...
  {
    return pGData->ROM[ 0x2000*8 + 0x1000 + (wAddr - 0x5000) ];
  }
  return (BYTE)(wAddr >> 8);
}
	...
	if( (wAddr&0xF0FF) == 0x4022 ) 
  {
		switch( byData&0x07 ) 
    {
        ...
        pGData->ROMBANK2 = ROMPAGE( 4 );
				break;
			case	0x01:
        pGData->ROMBANK2 = ROMPAGE( 3 );
				break;
			case	0x05:
        pGData->ROMBANK2 = ROMPAGE( 7 );
				break;
			case	0x06:
        pGData->ROMBANK2 = ROMPAGE( 5 );
				break;
			case	0x07:
        pGData->ROMBANK2 = ROMPAGE( 6 );
				break;
		}
	}
}
