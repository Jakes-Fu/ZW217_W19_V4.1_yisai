...
void Map232_Write(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
  ...
  pGData->ROMBANK0 = ROMPAGE((((Map232_Regs[0]|Map232_Regs[1])<<1)+0) % (NesHeader.byRomSize<<1));
  pGData->ROMBANK1 = ROMPAGE((((Map232_Regs[0]|Map232_Regs[1])<<1)+1) % (NesHeader.byRomSize<<1));
  pGData->ROMBANK2 = ROMPAGE((((Map232_Regs[0]|0x03)<<1)+0) % (NesHeader.byRomSize<<1));
  pGData->ROMBANK3 = ROMPAGE((((Map232_Regs[0]|0x03)<<1)+1) % (NesHeader.byRomSize<<1));
}
