...
{
  Map19_Chr_Ram = (BYTE *)NesMallocFromWRE(0x2000 * sizeof (BYTE));
  if (NULL == Map19_Chr_Ram)
  	return;
  /* Initialize Mapper */
  ...
  if ( NesHeader.byVRomSize > 0 )
  {
    ...
    pGData->PPUBANK[ 0 ] = VROMPAGE( dwLastPage - 8 );
    pGData->PPUBANK[ 1 ] = VROMPAGE( dwLastPage - 7 );
    pGData->PPUBANK[ 2 ] = VROMPAGE( dwLastPage - 6 );
    pGData->PPUBANK[ 3 ] = VROMPAGE( dwLastPage - 5 );
    pGData->PPUBANK[ 4 ] = VROMPAGE( dwLastPage - 4 );
    pGData->PPUBANK[ 5 ] = VROMPAGE( dwLastPage - 3 );
    pGData->PPUBANK[ 6 ] = VROMPAGE( dwLastPage - 2 );
    pGData->PPUBANK[ 7 ] = VROMPAGE( dwLastPage - 1 );
  ...
  switch ( wAddr & 0xf800 )
  {
    case 0x8000:  /* $8000-87ff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 0 ] = Map19_VROMPAGE( 0 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0x8800:  /* $8800-8fff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 1 ] = Map19_VROMPAGE( 1 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0x9000:  /* $9000-97ff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 2 ] = Map19_VROMPAGE( 2 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0x9800:  /* $9800-9fff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 3 ] = Map19_VROMPAGE( 3 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0xa000:  /* $a000-a7ff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 4 ] = Map19_VROMPAGE( 4 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0xa800:  /* $a800-afff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 5 ] = Map19_VROMPAGE( 5 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0xb000:  /* $b000-b7ff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 6 ] = Map19_VROMPAGE( 6 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0xb800:  /* $b800-bfff */
      if ( byData < 0xe0 || Map19_Regs[ 0 ] == 1 )
      {
        ...
        pGData->PPUBANK[ 7 ] = Map19_VROMPAGE( 7 );
      }
      InfoNES_SetupChr(pGData);
      break;
    ...
    case 0xc000:  /* $c000-c7ff */
      ...
      {
        byData %= ( NesHeader.byVRomSize << 3 );
        pGData->PPUBANK[ NAME_TABLE0 ] = VROMPAGE( byData );
      } else {
        pGData->PPUBANK[ NAME_TABLE0 ] = VRAMPAGE( byData & 0x01 );
      }
      break;
    ...
    case 0xc800:  /* $c800-cfff */
      ...
      {
        byData %= ( NesHeader.byVRomSize << 3 );
        pGData->PPUBANK[ NAME_TABLE1 ] = VROMPAGE( byData );
      } else {
        pGData->PPUBANK[ NAME_TABLE1 ] = VRAMPAGE( byData & 0x01 );
      }
      break;
    ...
    case 0xd000:  /* $d000-d7ff */
      ...
      {
        byData %= ( NesHeader.byVRomSize << 3 );
        pGData->PPUBANK[ NAME_TABLE2 ] = VROMPAGE( byData );
      } else {
        pGData->PPUBANK[ NAME_TABLE2 ] = VRAMPAGE( byData & 0x01 );
      }
      break;
    ...
    case 0xd800:  /* $d800-dfff */
      ...
      {
        byData %= ( NesHeader.byVRomSize << 3 );
        pGData->PPUBANK[ NAME_TABLE3 ] = VROMPAGE( byData );
      } else {
        pGData->PPUBANK[ NAME_TABLE3 ] = VRAMPAGE( byData & 0x01 );
      }
      break;
