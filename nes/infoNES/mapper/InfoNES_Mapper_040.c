...
void Map40_Init(Nes_Global_T *pGData)
{
  ...
  /* Set ROM Banks */
  pGData->ROMBANK0 = ROMPAGE( 4 );
  pGData->ROMBANK1 = ROMPAGE( 5 );
  pGData->ROMBANK2 = ROMPAGE( 0 );
  pGData->ROMBANK3 = ROMPAGE( 7 );
...
void Map40_Write(Nes_Global_T *pGData, WORD wAddr, BYTE byData )
{
  switch ( wAddr & 0xe000 )
  {
    ...
    case 0xe000:
      /* Set ROM Banks */
      pGData->ROMBANK2 = ROMPAGE ( ( byData & 0x07 ) % ( NesHeader.byRomSize << 1 ) );
      break;
  }
}
