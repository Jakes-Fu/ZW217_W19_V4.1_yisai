...
typedef struct
{
    ...
    cmiot_uint32 download_package_type;
    cmiot_char   new_version[CMIOT_VERSION_NAME_MAX + 1];
...
cmiot_int8 cmiot_check_version_http(char version[CMIOT_VERSION_NAME_MAX]);
cmiot_int8 cmiot_only_upgrade_http(void);
