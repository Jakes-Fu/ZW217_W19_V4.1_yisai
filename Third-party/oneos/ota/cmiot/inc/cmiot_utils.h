...
cmiot_uint16 cmiot_base64_encode(const cmiot_uint8 *source, cmiot_char *dest, cmiot_uint32 src_len);
cmiot_uint16 cmiot_base64_decode(const cmiot_uint8 *source, cmiot_char *dest);
