...
#endif                               /* cmiot_weak */
#define CMIOT_ASM           __asm    /* !< asm keyword for ARMCLANG Compiler */
#define CMIOT_INLINE        __inline /* !< inline keyword for ARMCLANG Compiler */
...
#define CMIOT_VERSION_NAME_MAX     128
...
#define E_CMIOT_CTW_INIT_FAIL -6
#define E_CMIOT_PAKAGE_TOO_LARGE -7
#define E_CMIOT_NEW_VERSION_EXIST -8
