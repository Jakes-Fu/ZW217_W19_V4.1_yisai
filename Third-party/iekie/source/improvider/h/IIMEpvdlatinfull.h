...
IIME_FORWARD_STRUCT(IIMELatinFullProvider);

typedef void (*PFNGETMULTITYPE)(IIMELatinFullProvider *pThis, LDB_CHAR key, LDB_CHAR prev_char, LDB_CHAR* pMultiList, int* pCount);
typedef int (*PFNISVALIDATEINPUT)(IIMELatinFullProvider *pThis, LDB_CHAR c);

struct tagIIMELatinFullProvider
{
