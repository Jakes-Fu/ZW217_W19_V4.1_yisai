 ...
 *                      Makes the context ready for ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_seed)() or
 *                      ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_free)().
 *
 ...
 */
void ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_prediction_resistance)( mbedtls_ctr_drbg_context *ctx,
                                         int resistance );
 ...
 */
void ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_entropy_len)( mbedtls_ctr_drbg_context *ctx,
                               size_t len );
 ...
 */
void ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_reseed_interval)( mbedtls_ctr_drbg_context *ctx,
                                   int interval );
 ...
 *                      MBEDTLS_ERR_CTR_DRBG_REQUEST_TOO_BIG
 */
int ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_random)( void *p_rng,
                     unsigned char *output, size_t output_len );
...
int ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_seed_entropy_len)( mbedtls_ctr_drbg_context *,
