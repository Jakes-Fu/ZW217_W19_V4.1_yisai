...
#define aes_crypt_cbc ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_crypt_cbc)
#define aes_crypt_cfb128 ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_crypt_cfb128)
#define aes_crypt_cfb8 ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_crypt_cfb8)
#define aes_crypt_ctr ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_crypt_ctr)
#define aes_crypt_ecb ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_crypt_ecb)
#define aes_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_free)
#define aes_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_init)
#define aes_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_self_test)
#define aes_setkey_dec ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_setkey_dec)
#define aes_setkey_enc ALIPAY_MBEDTLS_SYMBOL(mbedtls_aes_setkey_enc)
...
#define asn1_find_named_data ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_find_named_data)
#define asn1_free_named_data ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_free_named_data)
#define asn1_free_named_data_list ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_free_named_data_list)
#define asn1_get_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_alg)
#define asn1_get_alg_null ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_alg_null)
#define asn1_get_bitstring ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_bitstring)
#define asn1_get_bitstring_null ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_bitstring_null)
#define asn1_get_bool ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_bool)
#define asn1_get_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_int)
#define asn1_get_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_len)
#define asn1_get_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_mpi)
#define asn1_get_sequence_of ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_sequence_of)
#define asn1_get_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_get_tag)
#define asn1_named_data mbedtls_asn1_named_data
#define asn1_sequence mbedtls_asn1_sequence
#define asn1_store_named_data ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_store_named_data)
#define asn1_write_algorithm_identifier ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_algorithm_identifier)
#define asn1_write_bitstring ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_bitstring)
#define asn1_write_bool ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_bool)
#define asn1_write_ia5_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_ia5_string)
#define asn1_write_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_int)
#define asn1_write_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_len)
#define asn1_write_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_mpi)
#define asn1_write_null ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_null)
#define asn1_write_octet_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_octet_string)
#define asn1_write_oid ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_oid)
#define asn1_write_printable_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_printable_string)
#define asn1_write_raw_buffer ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_raw_buffer)
#define asn1_write_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_asn1_write_tag)
#define base64_decode ALIPAY_MBEDTLS_SYMBOL(mbedtls_base64_decode)
#define base64_encode ALIPAY_MBEDTLS_SYMBOL(mbedtls_base64_encode)
#define base64_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_base64_self_test)
#define blowfish_context mbedtls_blowfish_context
#define blowfish_crypt_cbc ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_crypt_cbc)
#define blowfish_crypt_cfb64 ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_crypt_cfb64)
#define blowfish_crypt_ctr ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_crypt_ctr)
#define blowfish_crypt_ecb ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_crypt_ecb)
#define blowfish_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_free)
#define blowfish_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_init)
#define blowfish_setkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_blowfish_setkey)
#define camellia_context mbedtls_camellia_context
#define camellia_crypt_cbc ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_crypt_cbc)
#define camellia_crypt_cfb128 ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_crypt_cfb128)
#define camellia_crypt_ctr ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_crypt_ctr)
#define camellia_crypt_ecb ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_crypt_ecb)
#define camellia_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_free)
#define camellia_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_init)
#define camellia_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_self_test)
#define camellia_setkey_dec ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_setkey_dec)
#define camellia_setkey_enc ALIPAY_MBEDTLS_SYMBOL(mbedtls_camellia_setkey_enc)
#define ccm_auth_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_ccm_auth_decrypt)
#define ccm_context mbedtls_ccm_context
#define ccm_encrypt_and_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_ccm_encrypt_and_tag)
#define ccm_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ccm_free)
#define ccm_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ccm_init)
#define ccm_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_ccm_self_test)
#define cipher_auth_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_auth_decrypt)
#define cipher_auth_encrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_auth_encrypt)
#define cipher_base_t mbedtls_cipher_base_t
#define cipher_check_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_check_tag)
#define cipher_context_t mbedtls_cipher_context_t
#define cipher_crypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_crypt)
#define cipher_definition_t mbedtls_cipher_definition_t
#define cipher_definitions ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_definitions)
#define cipher_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_finish)
#define cipher_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_free)
#define cipher_get_block_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_block_size)
#define cipher_get_cipher_mode ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_cipher_mode)
#define cipher_get_iv_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_iv_size)
#define cipher_get_key_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_key_bitlen)
#define cipher_get_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_name)
#define cipher_get_operation ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_operation)
#define cipher_get_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_get_type)
#define cipher_id_t mbedtls_cipher_id_t
#define cipher_info_from_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_info_from_string)
#define cipher_info_from_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_info_from_type)
#define cipher_info_from_values ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_info_from_values)
#define cipher_info_t mbedtls_cipher_info_t
#define cipher_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_init)
#define cipher_init_ctx ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_setup)
#define cipher_list ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_list)
#define cipher_mode_t mbedtls_cipher_mode_t
#define cipher_padding_t mbedtls_cipher_padding_t
#define cipher_reset ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_reset)
#define cipher_set_iv ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_set_iv)
#define cipher_set_padding_mode ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_set_padding_mode)
#define cipher_setkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_setkey)
#define cipher_type_t mbedtls_cipher_type_t
#define cipher_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_update)
#define cipher_update_ad ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_update_ad)
#define cipher_write_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_write_tag)
#define ctr_drbg_context mbedtls_ctr_drbg_context
#define ctr_drbg_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_free)
#define ctr_drbg_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_init)
#define ctr_drbg_random ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_random)
#define ctr_drbg_random_with_add ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_random_with_add)
#define ctr_drbg_reseed ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_reseed)
#define ctr_drbg_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_self_test)
#define ctr_drbg_set_entropy_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_entropy_len)
#define ctr_drbg_set_prediction_resistance ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_prediction_resistance)
#define ctr_drbg_set_reseed_interval ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_set_reseed_interval)
#define ctr_drbg_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_update)
#define ctr_drbg_update_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_update_seed_file)
#define ctr_drbg_write_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_ctr_drbg_write_seed_file)
#define debug_print_buf ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_buf)
#define debug_print_crt ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_crt)
#define debug_print_ecp ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_ecp)
#define debug_print_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_mpi)
#define debug_print_msg ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_msg)
#define debug_print_ret ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_print_ret)
#define debug_set_threshold ALIPAY_MBEDTLS_SYMBOL(mbedtls_debug_set_threshold)
#define des3_context mbedtls_des3_context
#define des3_crypt_cbc ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_cbc)
#define des3_crypt_ecb ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_ecb)
#define des3_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_free)
#define des3_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_init)
#define des3_set2key_dec ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set2key_dec)
#define des3_set2key_enc ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set2key_enc)
#define des3_set3key_dec ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set3key_dec)
#define des3_set3key_enc ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set3key_enc)
#define des_context mbedtls_des_context
#define des_crypt_cbc ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_cbc)
#define des_crypt_ecb ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_ecb)
#define des_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_free)
#define des_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_init)
#define des_key_check_key_parity ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_key_check_key_parity)
#define des_key_check_weak ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_key_check_weak)
#define des_key_set_parity ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_key_set_parity)
#define des_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_self_test)
#define des_setkey_dec ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey_dec)
#define des_setkey_enc ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey_enc)
#define dhm_calc_secret ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_calc_secret)
#define dhm_context mbedtls_dhm_context
#define dhm_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_free)
#define dhm_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_init)
#define dhm_make_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_make_params)
#define dhm_make_public alipay_mbedtls_dhm_make_public
#define dhm_parse_dhm ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_parse_dhm)
#define dhm_parse_dhmfile ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_parse_dhmfile)
#define dhm_read_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_read_params)
#define dhm_read_public ALIPAY_MBEDTLS_SYMBOL(mbedtls_dhm_read_public)
#define dhm_self_test mbedtls_dhm_self_test
#define ecdh_calc_secret ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_calc_secret)
#define ecdh_compute_shared ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_compute_shared)
#define ecdh_context mbedtls_ecdh_context
#define ecdh_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_free)
#define ecdh_gen_public ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_gen_public)
#define ecdh_get_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_get_params)
#define ecdh_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_init)
#define ecdh_make_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_make_params)
#define ecdh_make_public ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_make_public)
#define ecdh_read_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_read_params)
#define ecdh_read_public ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdh_read_public)
#define ecdh_side mbedtls_ecdh_side
#define ecdsa_context mbedtls_ecdsa_context
#define ecdsa_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_free)
#define ecdsa_from_keypair ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_from_keypair)
#define ecdsa_genkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_genkey)
#define ecdsa_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_info)
#define ecdsa_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_init)
#define ecdsa_read_signature ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_read_signature)
#define ecdsa_sign ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_sign)
#define ecdsa_sign_det ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_sign_det)
#define ecdsa_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_verify)
#define ecdsa_write_signature ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_write_signature)
#define ecdsa_write_signature_det ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecdsa_write_signature_det)
#define eckey_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_eckey_info)
#define eckeydh_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_eckeydh_info)
#define ecp_check_privkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_check_privkey)
#define ecp_check_pub_priv ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_check_pub_priv)
#define ecp_check_pubkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_check_pubkey)
#define ecp_copy ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_copy)
#define ecp_curve_info mbedtls_ecp_curve_info
#define ecp_curve_info_from_grp_id ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_curve_info_from_grp_id)
#define ecp_curve_info_from_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_curve_info_from_name)
#define ecp_curve_info_from_tls_id ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_curve_info_from_tls_id)
#define ecp_curve_list ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_curve_list)
#define ecp_gen_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_gen_key)
#define ecp_gen_keypair ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_gen_keypair)
#define ecp_group mbedtls_ecp_group
#define ecp_group_copy ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_copy)
#define ecp_group_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_free)
#define ecp_group_id mbedtls_ecp_group_id
#define ecp_group_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_init)
#define ecp_grp_id_list ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_grp_id_list)
#define ecp_is_zero ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_is_zero)
#define ecp_keypair mbedtls_ecp_keypair
#define ecp_keypair_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_keypair_free)
#define ecp_keypair_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_keypair_init)
#define ecp_mul ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_mul)
#define ecp_point mbedtls_ecp_point
#define ecp_point_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)
#define ecp_point_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)
#define ecp_point_read_binary ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_read_binary)
#define ecp_point_read_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_read_string)
#define ecp_point_write_binary ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_write_binary)
#define ecp_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_self_test)
#define ecp_set_zero ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_set_zero)
#define ecp_tls_read_group ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_read_group)
#define ecp_tls_read_point ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_read_point)
#define ecp_tls_write_group ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_group)
#define ecp_tls_write_point ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_point)
#define ecp_use_known_dp ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_load)
#define entropy_add_source ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_add_source)
#define entropy_context mbedtls_entropy_context
#define entropy_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_free)
#define entropy_func ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_func)
#define entropy_gather ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_gather)
#define entropy_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_init)
#define entropy_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_self_test)
#define entropy_update_manual ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_update_manual)
#define entropy_update_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_update_seed_file)
#define entropy_write_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_entropy_write_seed_file)
#define error_strerror ALIPAY_MBEDTLS_SYMBOL(mbedtls_strerror)
#define f_source_ptr mbedtls_entropy_f_source_ptr
#define gcm_auth_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_auth_decrypt)
#define gcm_context mbedtls_gcm_context
#define gcm_crypt_and_tag ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_crypt_and_tag)
#define gcm_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_finish)
#define gcm_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_free)
#define gcm_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_init)
#define gcm_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_self_test)
#define gcm_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_starts)
#define gcm_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_gcm_update)
#define get_timer mbedtls_timing_get_timer
#define hardclock mbedtls_timing_hardclock
#define hardclock_poll ALIPAY_MBEDTLS_SYMBOL(mbedtls_hardclock_poll)
#define havege_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_havege_free)
#define havege_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_havege_init)
#define havege_poll ALIPAY_MBEDTLS_SYMBOL(mbedtls_havege_poll)
...
#define hmac_drbg_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_free)
#define hmac_drbg_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_init)
#define hmac_drbg_random ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_random)
#define hmac_drbg_random_with_add ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_random_with_add)
#define hmac_drbg_reseed ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_reseed)
#define hmac_drbg_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_self_test)
#define hmac_drbg_set_entropy_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_set_entropy_len)
#define hmac_drbg_set_prediction_resistance ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_set_prediction_resistance)
#define hmac_drbg_set_reseed_interval ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_set_reseed_interval)
#define hmac_drbg_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_update)
#define hmac_drbg_update_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_update_seed_file)
#define hmac_drbg_write_seed_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_hmac_drbg_write_seed_file)
#define hr_time mbedtls_timing_hr_time
#define key_exchange_type_t mbedtls_key_exchange_type_t
#define md ALIPAY_MBEDTLS_SYMBOL(mbedtls_md)
#define md2 ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2)
#define md2_context mbedtls_md2_context
#define md2_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_finish)
#define md2_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_free)
#define md2_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_info)
#define md2_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_init)
#define md2_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_process)
#define md2_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_self_test)
#define md2_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_starts)
#define md2_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_md2_update)
#define md4 ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4)
#define md4_context mbedtls_md4_context
#define md4_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_finish)
#define md4_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_free)
#define md4_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_info)
#define md4_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_init)
#define md4_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_process)
#define md4_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_self_test)
#define md4_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_starts)
#define md4_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_md4_update)
#define md5 ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5)
#define md5_context mbedtls_md5_context
#define md5_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_finish)
#define md5_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_free)
#define md5_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_info)
#define md5_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_init)
#define md5_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_process)
#define md5_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_self_test)
#define md5_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_starts)
#define md5_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_md5_update)
#define md_context_t mbedtls_md_context_t
#define md_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_file)
#define md_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_finish)
#define md_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_free)
#define md_get_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_get_name)
#define md_get_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_get_size)
#define md_get_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_get_type)
#define md_hmac ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_hmac)
#define md_hmac_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_hmac_finish)
#define md_hmac_reset ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_hmac_reset)
#define md_hmac_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_hmac_starts)
#define md_hmac_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_hmac_update)
#define md_info_from_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_info_from_string)
#define md_info_from_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_info_from_type)
#define md_info_t mbedtls_md_info_t
#define md_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_init)
#define md_init_ctx ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_init_ctx)
#define md_list ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_list)
#define md_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_process)
#define md_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_starts)
#define md_type_t mbedtls_md_type_t
#define md_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_update)
...
#define mpi_add_abs ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_abs)
#define mpi_add_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_int)
#define mpi_add_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_mpi)
#define mpi_cmp_abs ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_cmp_abs)
#define mpi_cmp_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_cmp_int)
#define mpi_cmp_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_cmp_mpi)
#define mpi_copy ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_copy)
#define mpi_div_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_div_int)
#define mpi_div_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_div_mpi)
#define mpi_exp_mod ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_exp_mod)
#define mpi_fill_random ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_fill_random)
#define mpi_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)
#define mpi_gcd ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_gcd)
#define mpi_gen_prime ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_gen_prime)
#define mpi_get_bit ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_get_bit)
#define mpi_grow ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_grow)
#define mpi_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)
#define mpi_inv_mod ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_inv_mod)
#define mpi_is_prime ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_is_prime)
#define mpi_lsb ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lsb)
#define mpi_lset ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lset)
#define mpi_mod_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mod_int)
#define mpi_mod_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mod_mpi)
#define mpi_msb ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_bitlen)
#define mpi_mul_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_int)
#define mpi_mul_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_mpi)
#define mpi_read_binary ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)
#define mpi_read_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_file)
#define mpi_read_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_string)
#define mpi_safe_cond_assign ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_safe_cond_assign)
#define mpi_safe_cond_swap ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_safe_cond_swap)
#define mpi_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_self_test)
#define mpi_set_bit ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_set_bit)
#define mpi_shift_l ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_l)
#define mpi_shift_r ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_r)
#define mpi_shrink ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shrink)
#define mpi_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_size)
#define mpi_sub_abs ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_abs)
#define mpi_sub_int ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_int)
#define mpi_sub_mpi ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_mpi)
#define mpi_swap ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_swap)
#define mpi_write_binary ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_write_binary)
#define mpi_write_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_write_file)
#define mpi_write_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_write_string)
...
#define oid_get_attr_short_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_attr_short_name)
#define oid_get_cipher_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_cipher_alg)
#define oid_get_ec_grp ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_ec_grp)
#define oid_get_extended_key_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_extended_key_usage)
#define oid_get_md_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_md_alg)
#define oid_get_numeric_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_numeric_string)
#define oid_get_oid_by_ec_grp ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_oid_by_ec_grp)
#define oid_get_oid_by_md ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_oid_by_md)
#define oid_get_oid_by_pk_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_oid_by_pk_alg)
#define oid_get_oid_by_sig_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_oid_by_sig_alg)
#define oid_get_pk_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_pk_alg)
#define oid_get_pkcs12_pbe_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_pkcs12_pbe_alg)
#define oid_get_sig_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_sig_alg)
#define oid_get_sig_alg_desc ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_sig_alg_desc)
#define oid_get_x509_ext_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_oid_get_x509_ext_type)
...
#define pem_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_pem_free)
#define pem_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_pem_init)
#define pem_read_buffer ALIPAY_MBEDTLS_SYMBOL(mbedtls_pem_read_buffer)
#define pem_write_buffer ALIPAY_MBEDTLS_SYMBOL(mbedtls_pem_write_buffer)
#define pk_can_do ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_can_do)
#define pk_check_pair ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_check_pair)
#define pk_context mbedtls_pk_context
#define pk_debug ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_debug)
#define pk_debug_item mbedtls_pk_debug_item
#define pk_debug_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_debug_type)
#define pk_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_decrypt)
#define pk_ec ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_ec)
#define pk_encrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_encrypt)
#define pk_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_free)
#define pk_get_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_get_len)
#define pk_get_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_get_name)
#define pk_get_size ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_get_bitlen)
#define pk_get_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_get_type)
#define pk_info_from_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_info_from_type)
#define pk_info_t mbedtls_pk_info_t
#define pk_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_init)
#define pk_init_ctx ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_setup)
#define pk_init_ctx_rsa_alt ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_setup_rsa_alt)
#define pk_load_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_load_file)
#define pk_parse_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_parse_key)
#define pk_parse_keyfile ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_parse_keyfile)
#define pk_parse_public_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_parse_public_key)
#define pk_parse_public_keyfile ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_parse_public_keyfile)
#define pk_parse_subpubkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_parse_subpubkey)
#define pk_rsa ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_rsa)
...
#define pk_sign ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_sign)
#define pk_type_t mbedtls_pk_type_t
#define pk_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_verify)
#define pk_verify_ext ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_verify_ext)
#define pk_write_key_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_write_key_der)
#define pk_write_key_pem ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_write_key_pem)
#define pk_write_pubkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_write_pubkey)
#define pk_write_pubkey_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_write_pubkey_der)
#define pk_write_pubkey_pem ALIPAY_MBEDTLS_SYMBOL(mbedtls_pk_write_pubkey_pem)
...
#define pkcs12_derivation ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs12_derivation)
#define pkcs12_pbe ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs12_pbe)
#define pkcs12_pbe_sha1_rc4_128 ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs12_pbe_sha1_rc4_128)
#define pkcs5_pbes2 ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs5_pbes2)
#define pkcs5_pbkdf2_hmac ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs5_pbkdf2_hmac)
#define pkcs5_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_pkcs5_self_test)
#define platform_entropy_poll ALIPAY_MBEDTLS_SYMBOL(mbedtls_platform_entropy_poll)
#define platform_set_exit ALIPAY_MBEDTLS_SYMBOL(mbedtls_platform_set_exit)
#define platform_set_fprintf ALIPAY_MBEDTLS_SYMBOL(mbedtls_platform_set_fprintf)
#define platform_set_printf ALIPAY_MBEDTLS_SYMBOL(mbedtls_platform_set_printf)
#define platform_set_snprintf ALIPAY_MBEDTLS_SYMBOL(mbedtls_platform_set_snprintf)
...
#define polarssl_strerror ALIPAY_MBEDTLS_SYMBOL(mbedtls_strerror)
#define ripemd160 ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160)
#define ripemd160_context mbedtls_ripemd160_context
#define ripemd160_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_finish)
#define ripemd160_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_free)
#define ripemd160_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_info)
#define ripemd160_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_init)
#define ripemd160_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_process)
#define ripemd160_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_self_test)
#define ripemd160_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_starts)
#define ripemd160_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_ripemd160_update)
#define rsa_alt_context mbedtls_rsa_alt_context
#define rsa_alt_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_alt_info)
#define rsa_check_privkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_check_privkey)
#define rsa_check_pub_priv ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_check_pub_priv)
#define rsa_check_pubkey ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_check_pubkey)
#define rsa_context mbedtls_rsa_context
#define rsa_copy ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_copy)
#define rsa_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_free)
#define rsa_gen_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_gen_key)
#define rsa_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_info)
#define rsa_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_init)
#define rsa_pkcs1_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_pkcs1_decrypt)
#define rsa_pkcs1_encrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_pkcs1_encrypt)
#define rsa_pkcs1_sign ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_pkcs1_sign)
#define rsa_pkcs1_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_pkcs1_verify)
#define rsa_private ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_private)
#define rsa_public ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_public)
#define rsa_rsaes_oaep_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsaes_oaep_decrypt)
#define rsa_rsaes_oaep_encrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsaes_oaep_encrypt)
#define rsa_rsaes_pkcs1_v15_decrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsaes_pkcs1_v15_decrypt)
#define rsa_rsaes_pkcs1_v15_encrypt ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsaes_pkcs1_v15_encrypt)
#define rsa_rsassa_pkcs1_v15_sign ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsassa_pkcs1_v15_sign)
#define rsa_rsassa_pkcs1_v15_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsassa_pkcs1_v15_verify)
#define rsa_rsassa_pss_sign ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsassa_pss_sign)
#define rsa_rsassa_pss_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsassa_pss_verify)
#define rsa_rsassa_pss_verify_ext ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_rsassa_pss_verify_ext)
#define rsa_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_self_test)
#define rsa_set_padding ALIPAY_MBEDTLS_SYMBOL(mbedtls_rsa_set_padding)
#define safer_memcmp mbedtls_ssl_safer_memcmp
#define set_alarm mbedtls_set_alarm
#define sha1 ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1)
#define sha1_context mbedtls_sha1_context
#define sha1_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_finish)
#define sha1_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_free)
#define sha1_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_info)
#define sha1_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_init)
#define sha1_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_process)
#define sha1_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_self_test)
#define sha1_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_starts)
#define sha1_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha1_update)
#define sha224_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha224_info)
#define sha256 ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256)
#define sha256_context mbedtls_sha256_context
#define sha256_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_finish)
#define sha256_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_free)
#define sha256_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_info)
#define sha256_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_init)
#define sha256_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_process)
#define sha256_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_self_test)
#define sha256_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_starts)
#define sha256_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha256_update)
#define sha384_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha384_info)
#define sha512 ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512)
#define sha512_context mbedtls_sha512_context
#define sha512_finish ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_finish)
#define sha512_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_free)
#define sha512_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_info)
#define sha512_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_init)
#define sha512_process ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_process)
#define sha512_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_self_test)
#define sha512_starts ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_starts)
#define sha512_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_sha512_update)
...
#define ssl_cache_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_free)
#define ssl_cache_get ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_get)
#define ssl_cache_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_init)
#define ssl_cache_set ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_set)
#define ssl_cache_set_max_entries ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_set_max_entries)
#define ssl_cache_set_timeout ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_cache_set_timeout)
#define ssl_check_cert_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_check_cert_usage)
#define ssl_ciphersuite_from_id ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_from_id)
#define ssl_ciphersuite_from_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_from_string)
#define ssl_ciphersuite_t mbedtls_ssl_ciphersuite_t
#define ssl_ciphersuite_uses_ec ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_uses_ec)
#define ssl_ciphersuite_uses_psk ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_uses_psk)
#define ssl_close_notify ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_close_notify)
...
#define ssl_derive_keys ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_derive_keys)
#define ssl_dtls_replay_check ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_dtls_replay_check)
#define ssl_dtls_replay_update ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_dtls_replay_update)
#define ssl_fetch_input ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_fetch_input)
#define ssl_flight_item mbedtls_ssl_flight_item
#define ssl_flush_output ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_flush_output)
#define ssl_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_free)
#define ssl_get_alpn_protocol ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_alpn_protocol)
#define ssl_get_bytes_avail ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_bytes_avail)
#define ssl_get_ciphersuite ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite)
#define ssl_get_ciphersuite_id ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite_id)
#define ssl_get_ciphersuite_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite_name)
#define ssl_get_ciphersuite_sig_pk_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite_sig_pk_alg)
#define ssl_get_peer_cert ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_peer_cert)
#define ssl_get_record_expansion ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_record_expansion)
#define ssl_get_session ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_session)
#define ssl_get_verify_result ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_verify_result)
#define ssl_get_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_version)
#define ssl_handshake ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake)
#define ssl_handshake_client_step ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake_client_step)
#define ssl_handshake_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake_free)
#define ssl_handshake_params mbedtls_ssl_handshake_params
#define ssl_handshake_server_step ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake_server_step)
#define ssl_handshake_step ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake_step)
#define ssl_handshake_wrapup ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_handshake_wrapup)
#define ssl_hdr_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_hdr_len)
#define ssl_hs_hdr_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_hs_hdr_len)
#define ssl_hw_record_activate mbedtls_ssl_hw_record_activate
#define ssl_hw_record_finish mbedtls_ssl_hw_record_finish
#define ssl_hw_record_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_hw_record_init)
...
#define ssl_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_init)
#define ssl_key_cert mbedtls_ssl_key_cert
#define ssl_legacy_renegotiation ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_legacy_renegotiation)
#define ssl_list_ciphersuites ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_list_ciphersuites)
#define ssl_md_alg_from_hash ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_md_alg_from_hash)
#define ssl_optimize_checksum ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_optimize_checksum)
#define ssl_own_cert ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_own_cert)
#define ssl_own_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_own_key)
#define ssl_parse_certificate ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_parse_certificate)
#define ssl_parse_change_cipher_spec ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_parse_change_cipher_spec)
#define ssl_parse_finished ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_parse_finished)
#define ssl_pk_alg_from_sig ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_pk_alg_from_sig)
...
#define ssl_psk_derive_premaster ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_psk_derive_premaster)
#define ssl_read ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_read)
#define ssl_read_record ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_read_record)
#define ssl_read_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_read_version)
#define ssl_recv_flight_completed ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_recv_flight_completed)
#define ssl_renegotiate ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_renegotiate)
#define ssl_resend ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_resend)
#define ssl_reset_checksum ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_reset_checksum)
#define ssl_send_alert_message ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_send_alert_message)
#define ssl_send_fatal_handshake_failure ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_send_fatal_handshake_failure)
#define ssl_send_flight_completed ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_send_flight_completed)
#define ssl_session mbedtls_ssl_session
#define ssl_session_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_session_free)
#define ssl_session_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_session_init)
#define ssl_session_reset ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_session_reset)
#define ssl_set_alpn_protocols ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_alpn_protocols)
#define ssl_set_arc4_support ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_arc4_support)
#define ssl_set_authmode ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_authmode)
#define ssl_set_bio ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_set_bio)
#define ssl_set_ca_chain ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_ca_chain)
#define ssl_set_cbc_record_splitting ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_cbc_record_splitting)
#define ssl_set_ciphersuites ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_ciphersuites)
#define ssl_set_ciphersuites_for_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_ciphersuites_for_version)
#define ssl_set_client_transport_id ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_set_client_transport_id)
#define ssl_set_curves ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_curves)
#define ssl_set_dbg ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dbg)
#define ssl_set_dh_param ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dh_param)
#define ssl_set_dh_param_ctx ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dh_param_ctx)
#define ssl_set_dtls_anti_replay ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dtls_anti_replay)
#define ssl_set_dtls_badmac_limit ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dtls_badmac_limit)
#define ssl_set_dtls_cookies ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_dtls_cookies)
#define ssl_set_encrypt_then_mac ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_encrypt_then_mac)
#define ssl_set_endpoint ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_endpoint)
#define ssl_set_extended_master_secret ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_extended_master_secret)
#define ssl_set_fallback ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_fallback)
#define ssl_set_handshake_timeout ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_handshake_timeout)
#define ssl_set_hostname ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_set_hostname)
#define ssl_set_max_frag_len ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_max_frag_len)
#define ssl_set_max_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_max_version)
#define ssl_set_min_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_min_version)
#define ssl_set_own_cert ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_own_cert)
#define ssl_set_psk ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_psk)
#define ssl_set_psk_cb ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_psk_cb)
#define ssl_set_renegotiation ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_renegotiation)
#define ssl_set_renegotiation_enforced ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_renegotiation_enforced)
#define ssl_set_renegotiation_period ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_renegotiation_period)
#define ssl_set_rng ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_rng)
#define ssl_set_session ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_set_session)
#define ssl_set_session_cache ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_session_cache)
#define ssl_set_session_tickets ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_session_tickets)
#define ssl_set_sni ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_sni)
#define ssl_set_transport ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_transport)
#define ssl_set_truncated_hmac ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_truncated_hmac)
#define ssl_set_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_conf_verify)
#define ssl_sig_from_pk ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_sig_from_pk)
#define ssl_states mbedtls_ssl_states
#define ssl_transform mbedtls_ssl_transform
#define ssl_transform_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_transform_free)
#define ssl_write ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write)
#define ssl_write_certificate ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write_certificate)
#define ssl_write_change_cipher_spec ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write_change_cipher_spec)
#define ssl_write_finished ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write_finished)
#define ssl_write_record ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write_record)
#define ssl_write_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_write_version)
#define supported_ciphers ALIPAY_MBEDTLS_SYMBOL(mbedtls_cipher_supported)
...
#define version_check_feature ALIPAY_MBEDTLS_SYMBOL(mbedtls_version_check_feature)
#define version_get_number ALIPAY_MBEDTLS_SYMBOL(mbedtls_version_get_number)
#define version_get_string ALIPAY_MBEDTLS_SYMBOL(mbedtls_version_get_string)
#define version_get_string_full ALIPAY_MBEDTLS_SYMBOL(mbedtls_version_get_string_full)
...
#define x509_crl_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_free)
#define x509_crl_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_info)
#define x509_crl_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_init)
#define x509_crl_parse ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_parse)
#define x509_crl_parse_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_parse_der)
#define x509_crl_parse_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crl_parse_file)
#define x509_crt mbedtls_x509_crt
#define x509_crt_check_extended_key_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_check_extended_key_usage)
#define x509_crt_check_key_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_check_key_usage)
#define x509_crt_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_free)
#define x509_crt_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_info)
#define x509_crt_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_init)
#define x509_crt_parse ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_parse)
#define x509_crt_parse_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_parse_der)
#define x509_crt_parse_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_parse_file)
#define x509_crt_parse_path ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_parse_path)
#define x509_crt_revoked ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_is_revoked)
#define x509_crt_verify ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_crt_verify)
#define x509_csr mbedtls_x509_csr
#define x509_csr_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_free)
#define x509_csr_info ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_info)
#define x509_csr_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_init)
#define x509_csr_parse ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_parse)
#define x509_csr_parse_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_parse_der)
#define x509_csr_parse_file ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_csr_parse_file)
#define x509_dn_gets ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_dn_gets)
#define x509_get_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_alg)
#define x509_get_alg_null ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_alg_null)
#define x509_get_ext ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_ext)
#define x509_get_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_name)
#define x509_get_rsassa_pss_params ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_rsassa_pss_params)
#define x509_get_serial ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_serial)
#define x509_get_sig ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_sig)
#define x509_get_sig_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_sig_alg)
#define x509_get_time ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_get_time)
#define x509_key_size_helper ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_key_size_helper)
#define x509_name mbedtls_x509_name
#define x509_self_test ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_self_test)
#define x509_sequence mbedtls_x509_sequence
#define x509_serial_gets ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_serial_gets)
#define x509_set_extension ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_set_extension)
#define x509_sig_alg_gets ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_sig_alg_gets)
#define x509_string_to_names ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_string_to_names)
#define x509_time mbedtls_x509_time
#define x509_time_expired ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_time_is_past)
#define x509_time_future ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_time_is_future)
#define x509_write_extensions ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_write_extensions)
#define x509_write_names ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_write_names)
#define x509_write_sig ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509_write_sig)
#define x509write_cert mbedtls_x509write_cert
#define x509write_crt_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_der)
#define x509write_crt_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_free)
#define x509write_crt_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_init)
#define x509write_crt_pem ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_pem)
#define x509write_crt_set_authority_key_identifier ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_authority_key_identifier)
#define x509write_crt_set_basic_constraints ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_basic_constraints)
#define x509write_crt_set_extension ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_extension)
#define x509write_crt_set_issuer_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_issuer_key)
#define x509write_crt_set_issuer_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_issuer_name)
#define x509write_crt_set_key_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_key_usage)
#define x509write_crt_set_md_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_md_alg)
#define x509write_crt_set_ns_cert_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_ns_cert_type)
#define x509write_crt_set_serial ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_serial)
#define x509write_crt_set_subject_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_subject_key)
#define x509write_crt_set_subject_key_identifier ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_subject_key_identifier)
#define x509write_crt_set_subject_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_subject_name)
#define x509write_crt_set_validity ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_validity)
#define x509write_crt_set_version ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_crt_set_version)
#define x509write_csr mbedtls_x509write_csr
#define x509write_csr_der ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_der)
#define x509write_csr_free ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_free)
#define x509write_csr_init ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_init)
#define x509write_csr_pem ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_pem)
#define x509write_csr_set_extension ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_extension)
#define x509write_csr_set_key ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_key)
#define x509write_csr_set_key_usage ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_key_usage)
#define x509write_csr_set_md_alg ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_md_alg)
#define x509write_csr_set_ns_cert_type ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_ns_cert_type)
#define x509write_csr_set_subject_name ALIPAY_MBEDTLS_SYMBOL(mbedtls_x509write_csr_set_subject_name)
