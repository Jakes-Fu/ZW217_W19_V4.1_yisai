...
const mbedtls_ssl_ciphersuite_t *ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_from_string)( const char *ciphersuite_name );
const mbedtls_ssl_ciphersuite_t *ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_from_id)( int ciphersuite_id );

#if defined(MBEDTLS_PK_C)
mbedtls_pk_type_t ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite_sig_pk_alg)( const mbedtls_ssl_ciphersuite_t *info );
mbedtls_pk_type_t ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_get_ciphersuite_sig_alg)( const mbedtls_ssl_ciphersuite_t *info );
#endif

int ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_uses_ec)( const mbedtls_ssl_ciphersuite_t *info );
int ALIPAY_MBEDTLS_SYMBOL(mbedtls_ssl_ciphersuite_uses_psk)( const mbedtls_ssl_ciphersuite_t *info );
