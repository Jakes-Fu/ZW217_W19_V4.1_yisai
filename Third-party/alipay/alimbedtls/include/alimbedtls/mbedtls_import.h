...
//#include "common.h"//added by tiger.han of sprd
 ...
 * @note None.
 */
void *ALIPAY_MBEDTLS_SYMBOL(HAL_MutexCreate)(_IN_ const char *name_ptr);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_MutexDestroy)(_IN_ void *mutex);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_MutexLock)(_IN_ void *mutex);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_MutexUnlock)(_IN_ void *mutex);
 ...
 */
void *ALIPAY_MBEDTLS_SYMBOL(HAL_Malloc)(_IN_ uint32_t size);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_Free)(_IN_ void *ptr);
 ...
 * @note None.
 */
uint32_t ALIPAY_MBEDTLS_SYMBOL(HAL_UptimeMs)(void);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_SleepMs)(_IN_ uint32_t ms);
 ...
 * @note None.
 */
void ALIPAY_MBEDTLS_SYMBOL(HAL_Printf)(_IN_ const char *fmt, ...);
 ...
 */
char *ALIPAY_MBEDTLS_SYMBOL(HAL_GetPartnerID)(char pid_str[]);
 ...
 */
uintptr_t ALIPAY_MBEDTLS_SYMBOL(HAL_TCP_Establish)(const char *host, uint16_t port);
 ...
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_TCP_Destroy)(uintptr_t fd);
 ...
 * @see None.
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_TCP_Write)(uintptr_t fd, const char *buf, uint32_t len, uint32_t timeout_ms);
 ...
 * @see None.
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_TCP_Read_Timeout)(uintptr_t fd, char *buf, uint32_t len, uint32_t timeout_ms);
 ...
 * @note None.
 */
uintptr_t ALIPAY_MBEDTLS_SYMBOL(HAL_SSL_Establish)(
            const char *host,
            uint16_t port,
            const char *ca_crt,
            size_t ca_crt_len);
 ...
 * @return < 0, fail; 0, success.
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_SSL_Destroy)(uintptr_t handle);
 ...
 * @see None.
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_SSL_Write)(uintptr_t handle, const char *buf, int len, int timeout_ms);
 ...
 * @see None.
 */
int32_t ALIPAY_MBEDTLS_SYMBOL(HAL_SSL_Read)(uintptr_t handle, char *buf, int len, int timeout_ms);


unsigned int  ALIPAY_MBEDTLS_SYMBOL(HAL_time)(void);//cheng.du add
