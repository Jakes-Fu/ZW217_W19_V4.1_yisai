...
void ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( uint32_t SK[32], const unsigned char key[MBEDTLS_DES_KEY_SIZE] )
{
    int i;
    uint32_t X, Y, T;
...
{
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( ctx->sk, key );
                          ...
                          const unsigned char key[MBEDTLS_DES_KEY_SIZE*2] )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( esk, key );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( dsk + 32, key + 8 );
                          ...
                          const unsigned char key[24] )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( esk, key );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( dsk + 32, key +  8 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey)( esk + 64, key + 16 );
                    ...
                    unsigned char *output )
{
    ...
    if( mode == MBEDTLS_DES_ENCRYPT )
    {
        while( length > 0 )
        {
            ...
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_ecb)( ctx, output, output );
            memcpy( iv, output, 8 );
    ...
    else /* MBEDTLS_DES_DECRYPT */
    {
        ...
        {
            memcpy( temp, input, 8 );
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_ecb)( ctx, input, output );
                     ...
                     unsigned char *output )
{
    ...
    if( mode == MBEDTLS_DES_ENCRYPT )
    {
        while( length > 0 )
        {
            ...
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_ecb)( ctx, output, output );
            memcpy( iv, output, 8 );
    ...
    else /* MBEDTLS_DES_DECRYPT */
    {
        ...
        {
            memcpy( temp, input, 8 );
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_ecb)( ctx, input, output );
...
int ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_self_test)( int verbose )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_init)( &ctx );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_init)( &ctx3 );
    /*
     * ECB mode
     */
    for( i = 0; i < 6; i++ )
    {
        ...
        {
        case 0:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey_dec)( &ctx, des3_test_keys );
            break;

        case 1:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_setkey_enc)( &ctx, des3_test_keys );
            break;

        case 2:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set2key_dec)( &ctx3, des3_test_keys );
            break;

        case 3:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set2key_enc)( &ctx3, des3_test_keys );
            break;

        case 4:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set3key_dec)( &ctx3, des3_test_keys );
            break;

        case 5:
            ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_set3key_enc)( &ctx3, des3_test_keys );
            break;
        ...
        {
            if( u == 0 )
                ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_ecb)( &ctx, buf, buf );
            else
                ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_ecb)( &ctx3, buf, buf );
        }
    ...
    for( i = 0; i < 6; i++ )
    {
        ...
        if( v == MBEDTLS_DES_DECRYPT )
        {
            ...
            {
                if( u == 0 )
                    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_crypt_cbc)( &ctx, v, 8, iv, buf, buf );
                else
                    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_crypt_cbc)( &ctx3, v, 8, iv, buf, buf );
            }
        }
        else
        {
...
exit:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des_free)( &ctx );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_des3_free)( &ctx3 );
