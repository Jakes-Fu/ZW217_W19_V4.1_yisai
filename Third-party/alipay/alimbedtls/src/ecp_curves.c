...
static int ecp_use_curve25519( mbedtls_ecp_group *grp )
{
    ...
    /* Actually ( A + 2 ) / 4 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_string)( &grp->A, 16, "01DB42" ) );

    /* P = 2^255 - 19 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lset)( &grp->P, 1 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_l)( &grp->P, 255 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_int)( &grp->P, &grp->P, 19 ) );
    grp->pbits = ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_bitlen)( &grp->P );

    /* Y intentionaly not set, since we use x/z coordinates.
     * This is used as a marker to identify Montgomery curves! */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lset)( &grp->G.X, 9 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lset)( &grp->G.Z, 1 ) );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &grp->G.Y );
...
static int ecp_mod_p192( mbedtls_mpi *N )
{
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_grow)( N, 6 * WIDTH ) );
...
#define INIT( b )                                           \
    ...
    memset( Cp, 0, C.n * sizeof( mbedtls_mpi_uint ) );                \
                                                            \
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_grow)( N, b * 2 / 8 / sizeof( mbedtls_mpi_uint ) ) ); \
    LOAD32;
...
static inline int fix_negative( mbedtls_mpi *N, signed char c, mbedtls_mpi *C, size_t bits )
{
    ...
    /* N = - ( C - N ) */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_abs)( N, C, N ) );
    N->s = -1;
...
static int ecp_mod_p521( mbedtls_mpi *N )
{
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_r)( &M, 521 % ( 8 * sizeof( mbedtls_mpi_uint ) ) ) );
    ...
    /* N = A0 + A1 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_abs)( N, N, &M ) );
...
static int ecp_mod_p255( mbedtls_mpi *N )
{
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_r)( &M, 255 % ( 8 * sizeof( mbedtls_mpi_uint ) ) ) );
    M.n++; /* Make room for multiplication by 19 */

    /* N = A0 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_set_bit)( N, 255, 0 ) );
    for( i = P255_WIDTH; i < N->n; i++ )
        N->p[i] = 0;

    /* N = A0 + 19 * A1 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_int)( &M, &M, 19 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_abs)( N, N, &M ) );
                                   ...
                                   size_t adjust, size_t shift, mbedtls_mpi_uint mask )
{
    ...
    if( shift != 0 )
        MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_shift_r)( &M, shift ) );
    ...
    /* N = A0 + R * A1 */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_mpi)( &M, &M, &R ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_abs)( N, N, &M ) );
