...
void mbedtls_ecjpake_init( mbedtls_ecjpake_context *ctx )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &ctx->Xm1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &ctx->Xm2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &ctx->Xp1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &ctx->Xp2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &ctx->Xp  );

    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &ctx->xm1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &ctx->xm2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &ctx->s   );
}
...
void mbedtls_ecjpake_free( mbedtls_ecjpake_context *ctx )
{
    ...
    ctx->md_info = NULL;
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_free)( &ctx->grp );

    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &ctx->Xm1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &ctx->Xm2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &ctx->Xp1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &ctx->Xp2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &ctx->Xp  );

    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &ctx->xm1 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &ctx->xm2 );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &ctx->s   );
}
                           ...
                           size_t len )
{
    ...
    if( ( ctx->md_info = ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_info_from_type)( hash ) ) == NULL )
        return( MBEDTLS_ERR_MD_FEATURE_UNAVAILABLE );

    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_group_load)( &ctx->grp, curve ) );

    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)( &ctx->s, secret, len ) );
                                    ...
                                    const mbedtls_ecp_point *P )
{
    ...
    ret = ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_write_binary)( grp, P, pf,
                                          &len, *p + 4, end - ( *p + 4 ) );
    if( ret != 0 )
        return( ret );
                         ...
                         mbedtls_mpi *h )
{
    ...
    *p++ = (unsigned char)( ( id_len       ) & 0xFF );
    ...
    /* Compute hash */
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_md)( md_info, buf, p - buf, hash );

    /* Turn it into an integer mod n */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)( h, hash,
                                        ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_get_size)( md_info ) ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mod_mpi)( h, h, &grp->N ) );
                             ...
                             const unsigned char *end )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &V );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &VV );
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_read_point)( grp, &V, p, end - *p ) );
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)( &r, *p, r_len ) );
    *p += r_len;
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_muladd)( (mbedtls_ecp_group *) grp,
                     &VV, &h, X, &r, G ) );

    if( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_cmp)( &VV, &V ) != 0 )
    {
...
cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &V );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &VV );
                              ...
                              void *p_rng )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &V );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &v );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &h );

    /* Compute signature */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_gen_keypair_base)( (mbedtls_ecp_group *) grp,
                                                   G, &v, &V, f_rng, p_rng ) );
    MBEDTLS_MPI_CHK( ecjpake_hash( md_info, grp, pf, G, &V, X, id, &h ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_mpi)( &h, &h, x ) ); /* x*h */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_sub_mpi)( &h, &v, &h ) ); /* v - x*h */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mod_mpi)( &h, &h, &grp->N ) ); /* r */

    /* Write it out */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_point)( grp, &V,
                pf, &len, *p, end - *p ) );
    *p += len;

    len = ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_size)( &h ); /* actually r */
    ...
    *(*p)++ = (unsigned char)( len & 0xFF );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_write_binary)( &h, *p, len ) ); /* r */
    *p += len;

cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &V );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &v );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &h );
                             ...
                             const unsigned char *end )
{
     ...
     * } ECJPAKEKeyKP;
     */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_read_point)( grp, X, p, end - *p ) );
    if( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_is_zero)( X ) )
    {
                              ...
                              void *p_rng )
{
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_gen_keypair_base)( (mbedtls_ecp_group *) grp, G, x, X,
                                                   f_rng, p_rng ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_point)( grp, X,
                pf, &len, *p, end - *p ) );
    *p += len;
                             ...
                             const mbedtls_ecp_point *C )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &one );

    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_lset)( &one, 1 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_muladd)( grp, R, &one, A, &one, B ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_muladd)( grp, R, &one, R, &one, C ) );

cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &one );
                                            ...
                                            size_t len )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &G );
    ...
    {
        MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_read_group)( &grp, &p, len ) );
...
cleanup:
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &G );
                               ...
                               void *p_rng )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &b );

    /* b = s + rnd-128-bit * N */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_fill_random)( &b, 16, f_rng, p_rng ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_mpi)( &b, &b, N ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_add_mpi)( &b, &b, S ) );

    /* R = sign * X * b mod N */
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mul_mpi)( R, X, &b ) );
    R->s *= sign;
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_mod_mpi)( R, R, N ) );

cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &b );
                            ...
                            void *p_rng )
{
    ...
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &G );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &Xm );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &xm );
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_mul)( &ctx->grp, &Xm, &xm, &G, f_rng, p_rng ) );
    ...
    if( ctx->role == MBEDTLS_ECJPAKE_SERVER )
    {
        ...
        MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_group)( &ctx->grp, &ec_len,
                                                      p, end - p ) );
        p += ec_len;
    }
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_tls_write_point)( &ctx->grp, &Xm,
...
cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &G );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &Xm );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &xm );
                            ...
                            void *p_rng )
{
    ...
    *olen = ALIPAY_MBEDTLS_SYMBOL(mbedtls_md_get_size)( ctx->md_info );
    if( len < *olen )
        return( MBEDTLS_ERR_ECP_BUFFER_TOO_SMALL );

    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_init)( &K );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &m_xm2_s );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_init)( &one );
    ...
    MBEDTLS_MPI_CHK( ecjpake_mul_secret( &m_xm2_s, -1, &ctx->xm2, &ctx->s,
                                         &ctx->grp.N, f_rng, p_rng ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_muladd)( &ctx->grp, &K,
                                         &one, &ctx->Xp,
                                         &m_xm2_s, &ctx->Xp2 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_mul)( &ctx->grp, &K, &ctx->xm2, &K,
                                      f_rng, p_rng ) );

    /* PMS = SHA-256( K.X ) */
    x_bytes = ( ctx->grp.pbits + 7 ) / 8;
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_write_binary)( &K.X, kx, x_bytes ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_md)( ctx->md_info, kx, x_bytes, buf ) );

cleanup:
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_point_free)( &K );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &m_xm2_s );
    ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_free)( &one );
                              ...
                              const unsigned char *xm2, size_t len2 )
{
    ...
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)( &ctx->xm1, xm1, len1 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_mpi_read_binary)( &ctx->xm2, xm2, len2 ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_mul)( &ctx->grp, &ctx->Xm1, &ctx->xm1,
                                      &ctx->grp.G, NULL, NULL ) );
    MBEDTLS_MPI_CHK( ALIPAY_MBEDTLS_SYMBOL(mbedtls_ecp_mul)( &ctx->grp, &ctx->Xm2, &ctx->xm2,
                                      &ctx->grp.G, NULL, NULL ) );
