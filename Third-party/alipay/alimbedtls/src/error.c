...
#include "alimbedtls/net_sockets.h"
#endif
...
#include "alimbedtls/xtea.h"
#endif


void ALIPAY_MBEDTLS_SYMBOL(mbedtls_strerror)( int ret, char *buf, size_t buflen )
{
    size_t len;
    int use_ret;
