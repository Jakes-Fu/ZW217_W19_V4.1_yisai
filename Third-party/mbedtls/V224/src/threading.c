...
void threading_mutex_init( mbedtls_threading_mutex_t *mutex )
{
    ...
    mutex->mutex = SCI_CreateMutex(mutex_str,SCI_NO_INHERIT);
    SCI_DEBUG("threading_mutex_init  -*mutex:0x%x--name:%s ", mutex->mutex, mutex_str);
}
...
void threading_mutex_free( mbedtls_threading_mutex_t *mutex )
{
    ...
    SCI_DEBUG("threading_mutex_free  , *mutex:0x%x",  mutex->mutex);
...
int threading_mutex_lock( mbedtls_threading_mutex_t *mutex )
{
    ...
    SCI_DEBUG("threading_mutex_lock   *mutex:0x%x", mutex->mutex);

    ret = SCI_GetMutex(mutex->mutex, SCI_WAIT_FOREVER);
...
int threading_mutex_unlock( mbedtls_threading_mutex_t *mutex )
{
    ...
    SCI_DEBUG("threading_mutex_unlock   *mutex:0x%x", mutex->mutex);

    ret = SCI_PutMutex(mutex->mutex);
