 ...
 * @note None.
 */
void *HAL_MutexCreate(_IN_ const char *name_ptr);
 ...
 * @see None.
 */
int32_t HAL_TCP_Read_Timeout(uintptr_t fd, char *buf, uint32_t len, uint32_t timeout_ms);
...
unsigned int  HAL_time(void);//cheng.du add
