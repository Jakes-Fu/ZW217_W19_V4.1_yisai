...
#define MBEDTLS_ERR_SSL_QUIT_FORCED                  -0x5900  //midify by xiameng.yang  for lwm2m
#endif
/*
 * Various constants
 */
...
#else
#define MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MIN    100000
#define MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MAX   6000000
#endif
/**
