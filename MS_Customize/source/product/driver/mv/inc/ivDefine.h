 ...
 *	资源地址、尺寸类型及数据类型大小常量
 */
typedef ivInt32  ivLogStatus; 
typedef ivInt32  ivResStatus; 
typedef ivUInt32 ivResAddress;
typedef ivUInt32 ivResSize;

#define ivRES_READ_OK		0
#define ivRES_READ_FAILD	1

#define ivLOG_WRITE_OK      0
#define ivLOG_WRITE_FAILD   1  
...
struct tagResPackDesc
{
	...
	ivCBReadBGRes		pfnRead;			/* read resource callback entry */
