...
//replace LGDP4531 with new lcd driver if new lcd is used
#define LCD_DRV_IC R61581
...
{
    1000,        //vsync width
    30,30,30,    //whp, wlp, wcs
    250,170,170  //rhp, rlp, rcs
};
...
{0x00, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 
 0x9B, 0xA6, 0xB1, 0xBC ,0xD7, 0xE2, 0xED, 0xF8 ,0x100};
...
{
#if LCD_RESET_CONNECT_TO_SEINE_LCM_RESET
...
{
    {3, 0, 0x002A, 0  },	    // Horizontal GRAM Start Address
    {3, 0, 0x002A, 239},	    // Horizontal GRAM End Address
    {3, 0, 0x002B, 0  },	    // Vertical GRAM Start Address
    {3, 0, 0x002B, 319},	    // Vertical GRAM End Address
       
	{1, 0, 0x002C, 0x0000},		// send data.
	{0, 0, 0x0000, 0x0000}
};
...
PUBLIC void SEINE_LCD_GET_CONFIG(LCD_DRV_IC)(uint32 **cfg_pptr, uint32 *len_ptr)
{
    ...
    for(i=0; i<11; i++)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,R61581_SEINE_DRV_337_112_2_18_0_34_53_2065,(uint8*)"uu", i, len[i]);
    }

    //SCI_TRACE_LOW:"Total len %u, index len %u"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,R61581_SEINE_DRV_340_112_2_18_0_34_53_2066,(uint8*)"uu", total_len, sizeof(LCD_COM_CFG));
