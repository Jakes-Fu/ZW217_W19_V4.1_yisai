...
#define LCD_DRV_IC LGDP4531

#if defined( PRODUCT_DRIVER_SEINE_8100_p11) 
#define LCD_RESET_CONNECT_TO_SEINE_LCM_RESET    0
#else
#define LCD_RESET_CONNECT_TO_SEINE_LCM_RESET    1
#endif
...
PUBLIC void SEINE_LCD_GET_CONFIG(LCD_DRV_IC)(uint32 **cfg_pptr, uint32 *len_ptr)
{
    ...
    for(i=0; i<11; i++)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,LGDP4531_SEINE_DRV_345_112_2_18_0_34_52_2061,(uint8*)"uu", i, len[i]);
    }

    //SCI_TRACE_LOW:"Total len %u, index len %u"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,LGDP4531_SEINE_DRV_348_112_2_18_0_34_52_2062,(uint8*)"uu", total_len, sizeof(LCD_COM_CFG));
