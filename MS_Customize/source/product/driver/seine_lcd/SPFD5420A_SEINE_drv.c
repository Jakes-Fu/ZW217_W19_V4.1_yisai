...
{
	#if 0
    {3, 0, 0x0002, 0  },	    // Horizontal GRAM Start Address
    {3, 0, 0x0003, 0},	    // Horizontal GRAM End Address
    {3, 0, 0x0004, 0  },	    // Vertical GRAM Start Address
    {3, 0, 0x0005, 239},	    // Vertical GRAM End Address
    
    {3, 0, 0x0006, 0  },	    // Horizontal GRAM Start Address
    {3, 0, 0x0007, 0},	    // Horizontal GRAM End Address
    {3, 0, 0x0008, 1  },	    // Vertical GRAM Start Address
    {3, 0, 0x0009, 63},	    // Vertical GRAM End Address
...
240 is lcd width, 400 is lcd height, replace them with new lcd width and height
*/
...
PUBLIC void SEINE_LCD_GET_CONFIG(LCD_DRV_IC)(uint32 **cfg_pptr, uint32 *len_ptr)
{
    ...
    for(i=0; i<11; i++)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SPFD5420A_SEINE_DRV_305_112_2_18_0_34_54_2067,(uint8*)"uu", i, len[i]);
    }

    //SCI_TRACE_LOW:"Total len %u, index len %u"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SPFD5420A_SEINE_DRV_308_112_2_18_0_34_54_2068,(uint8*)"uu", total_len, sizeof(LCD_COM_CFG));
