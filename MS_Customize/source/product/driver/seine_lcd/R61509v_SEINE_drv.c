...
{
    {3, 0, 0x0210, 0  },	    // Horizontal GRAM Start Address
    {3, 0, 0x0211, 239},	    // Horizontal GRAM End Address
    {3, 0, 0x0212, 0  },	    // Vertical GRAM Start Address
    {3, 0, 0x0213, 399},	    // Vertical GRAM End Address
    
    {3, 0, 0x0200, 0x0000},     // GRAM horizontal Address
    {3, 0, 0x0201, 0x0000},     // GRAM Vertical Address
...
{
#if MCU_FMARK_MODE
    {3, 0, 0x0090, 0x8000},  //frequency of fmark should be about 30
#endif
    {1, 0, 0x0202, 0x0000},
    {0, 0, 0x0000, 0x0000}
};
...
PUBLIC void SEINE_LCD_GET_CONFIG(LCD_DRV_IC)(uint32 **cfg_pptr, uint32 *len_ptr)
{
    ...
    offset_ptr     = (uint32*)(&(lcd_cfg_ptr->lcd_init_offset));
    ...
    for(i=0; i<11; i++)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,R61509V_SEINE_DRV_286_112_2_18_0_34_52_2063,(uint8*)"uu", i, len[i]);
    }

    //SCI_TRACE_LOW:"Total len %u, index len %u"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,R61509V_SEINE_DRV_289_112_2_18_0_34_52_2064,(uint8*)"uu", total_len, sizeof(LCD_COM_CFG));
