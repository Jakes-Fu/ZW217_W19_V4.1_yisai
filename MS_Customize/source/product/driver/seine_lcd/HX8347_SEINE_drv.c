...
PUBLIC void SEINE_LCD_GET_CONFIG(LCD_DRV_IC)(uint32 **cfg_pptr, uint32 *len_ptr)
{
    ...
    for(i=0; i<11; i++)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,HX8347_SEINE_DRV_287_112_2_18_0_34_50_2057,(uint8*)"uu", i, len[i]);
    }

    //SCI_TRACE_LOW:"Total len %u, index len %u"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,HX8347_SEINE_DRV_290_112_2_18_0_34_50_2058,(uint8*)"uu", total_len, sizeof(LCD_COM_CFG));
