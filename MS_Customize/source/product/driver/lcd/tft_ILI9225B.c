...
#define QCIF_LCD_WIDTH  176
#define QCIF_LCD_HEIGHT 220
	...
	)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,TFT_ILI9225B_397_112_2_18_0_33_41_1775,(uint8*)"d", is_sleep);
...
LOCAL void ILI9225B_Close(void)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,TFT_ILI9225B_421_112_2_18_0_33_41_1776,(uint8*)"");
...
PUBLIC LCD_OPERATIONS_T* ILI9225B_GetOperations(void)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,TFT_ILI9225B_571_112_2_18_0_33_41_1777,(uint8*)"");
...
/* Note: Config here reference to LCMspec.*/
LOCAL const LCD_TIMING_U s_ILI9225B_spitiming =
{
    39000000,//SPI_CLK_39MHZ,        // clk frequency support (unit:MHz)
    0,//SPI_CLK_IDLE_LOW,     // CPOL: 0--SPI_CLK_IDLE_LOW, 1--SPI_CLK_IDLE_HIGH
    0,//SPI_SAMPLING_RISING,  // CPHA: 0--SPI_SAMPLING_RISING,  1--SPI_SAMPLING_FALLING 
    
    16,                    // tx bit length: 8/16bits refer to lcm driver ic 
    0,
    0,
};
...
const LCD_SPEC_T g_lcd_ILI9225B = {
	...
	BUS_MODE_8080,
	WIDTH_16, 
	(LCD_TIMING_U*)&s_ILI9225B_spitiming, 
