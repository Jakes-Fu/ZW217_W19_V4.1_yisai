/******************************************************************************
 ** File Name:      normcp_m36l0r7050t4zaq.c							                                             *
 ** Author:           Yiyue.he										                                                   *
 ** DATE:            13/08/2009                                                								*
 ...
 ** 13/08/2009     	Yiyue.He         	 Create.                                   							*
 ******************************************************************************/
typedef union m69kb048ab_psram_bcr{
	struct m69kb048ab_psram_bcr_bits_map {
...
}M69KB048AB_PSRAM_BCR_U;

//no need ,reserved for future description
typedef union m69kB048ab_psram_rcr{
	struct m69kB048ab_psram_rcr_bits_map {
...
}M69KB048AB_PSRAM_RCR_U;

typedef union m58lr128ktb_norflash_cr{
	struct m58lr128ktb_norflash_cr_bits_map {
		volatile  uint	operating_mode		:BIT_RANGE(15,15);
...
}M58LR128KTB_NORFLASH_CR_U;


#pragma arm section code = "NORMCP_SPEC_FUNC_IN_SRAM"
LOCAL void m58lr128ktb_flash_cr_set_func(uint32 flash_addr_offset, uint32 cr, uint32 no_use)
{
...
#if 0
LOCAL void m69kb048ab_psram_cr_set_func(uint32 sram_addr_offset,uint32 sram_bcr_value,uint32 sram_rcr_value)
{
...
LOCAL BOOLEAN m69kb048ab_psram_cr_cfg_func(
	SRAM_CFG_FUNC_INPARAM_PTR		sram_cfg_input_ptr,
	SRAM_CFG_FUNC_OUTPARAM_PTR		sram_cfg_output_ptr
	)
{	
	M69KB048AB_PSRAM_BCR_U sram_bcr;
	M69KB048AB_PSRAM_RCR_U sram_rcr;	//just uint32 type for rcr is enough	
	...
	)
{
	...
	flash_cfg_output_ptr->cs_cr_set_func = m58lr128ktb_flash_cr_set_func;
...
const NORMCP_SPEC_T g_normcp_m36l0r7050t4zaq_spec  = //also for m36l0r7060b4zaq_spec
{
	...
	{	85,			7,			85,			25,		},{		70,			7,			4,		0,	},	{86},
	//sram
	{	70,			5,			70,			20,		},{		70,			5,			0,		0,	},	{83},

	m69kb048ab_psram_cr_cfg_func,
	
	m58lr128ktb_flash_cr_cfg_func	
};

const NORMCP_SPEC_T g_normcp_m36l0r7050t4zaq_spec_1  = //also for m36l0r7060b4zaq_spec
{
	0x0020,		//Manufacturer ID
	0x88C4,
	0x1,
...
const NORMCP_SPEC_T g_normcp_m36l0r7050b4zaq_spec  = //also for m36l0r7060b4zaq_spec
{
	0x0020,		//Manufacturer ID
	0x88C5,
	0x0,
...
const NORMCP_SPEC_T g_normcp_m36l0r7050b4zaq_spec_1  = //also for m36l0r7060b4zaq_spec
{
	0x0020,		//Manufacturer ID
	0x88C5,
	0x1,
