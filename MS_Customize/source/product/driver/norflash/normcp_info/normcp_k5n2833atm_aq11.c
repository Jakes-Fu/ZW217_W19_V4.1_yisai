/******************************************************************************
 ** File Name:      normcp_k5n2833atm_aq11.c							                                             *
 ** Author:         	Yiyue.He										                                                   *
 ** DATE:            13/08/2009                                                								*
 ...
 ******************************************************************************/
typedef union k5n2833atm_aq11_utsram2_bcr{
	struct k5n2833atm_aq11_utsram2_bcr_bits_map {
...
}k5n2833atm_aq11_UTSRAM2_BCR_U;

typedef union k5n2833atm_aq11_utsram2_rcr{
	struct k5n2833atm_aq11_utsram2_rcr_bits_map {
...
}k5n2833atm_aq11_UTSRAM2_RCR_U;

typedef union k5n2833atm_aq11_norflash_cr{
	struct k5n2833atm_aq11_flash1_cr_bits_map {
...
}k5n2833atm_aq11_NORFLASH_CR_U;


#pragma arm section code = "NORMCP_SPEC_FUNC_IN_SRAM"
LOCAL void k5n2833atm_aq11_flash_cr_set_func(uint32 flash_addr_offset, uint32 cr, uint32 crII)
{
...
#if 0
LOCAL void k5n2833atm_aq11_sram_cr_set_func(uint32 sram_addr_offset,uint32 sram_bcr_value,uint32 sram_rcr_value)
{
...
LOCAL BOOLEAN k5n2833atm_aq11_sram_cr_cfg_func(
	SRAM_CFG_FUNC_INPARAM_PTR		sram_cfg_input_ptr,
	SRAM_CFG_FUNC_OUTPARAM_PTR		sram_cfg_output_ptr
	)
{	
	k5n2833atm_aq11_UTSRAM2_BCR_U sram_bcr;
	k5n2833atm_aq11_UTSRAM2_RCR_U sram_rcr;		

	//@default value
	sram_bcr.sram_bcr_value = 0x8980F;
	sram_rcr.sram_rcr_value = 0x0;
	...
	)
{
	...
	flash_cfg_output_ptr->cs_cr_set_func = k5n2833atm_aq11_flash_cr_set_func;
...
const NORMCP_SPEC_T g_normcp_k5n2833atm_aq11_spec  = //also for k5n2833atm_af66 k5n2833ata_aq11 k5n2833ata_af66 
{
	...
	{	70,			5,			NULL,		NULL,	},{		70,			5,			0,		0,	},	{80},
	//sram
	{	70,			5,			NULL,		NULL,	},{		70,			5,			0,		0,	},	{104},

	k5n2833atm_aq11_sram_cr_cfg_func,
	
	k5n2833atm_aq11_flash_cr_cfg_func	

};

const NORMCP_SPEC_T g_normcp_k5n2866ate_bq12_spec  = 
{
	0x00EC,		//Manufacturer ID
	0x2404,
	0x1,
	...
	//flash
	/*read time |	(r)adv width | page read time | page cycle || write time | (w)adv width |	ce#-we# | we-ce	  || max sync freq */
	{	70,			5,			NULL,		NULL,	},{		70,			9,			0,		0,	},	{108},
	//sram
	{	80,			5,			NULL,		NULL,	},{		70,			5,			12,		0,	},	{104},
...
const NORMCP_SPEC_T g_normcp_k5n2833abm_aq11_spec  = //also for k5n2833abm_af66 k5n2833aba_aq11 k5n2833aba_af66 
{
	0x00EC,		//Manufacturer ID
	0x2405,
	0x0,
