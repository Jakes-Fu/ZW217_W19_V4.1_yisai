...
typedef union PF38F3040L0YUQ3_psram_bcr{
	struct PF38F3040L0YUQ3_psram_bcr_bits_map {
...
}PF38F3040L0YUQ3_PSRAM_BCR_U;


typedef union PF38F3040L0YUQ3_psram_rcr{
	struct PF38F3040L0YUQ3_psram_rcr_bits_map {
...
}PF38F3040L0YUQ3_PSRAM_RCR_U;

typedef union PF38F3040L0YUQ3_norflash_cr{
	struct PF38F3040L0YUQ3_norflash_cr_bits_map {
		volatile  uint	operating_mode		:BIT_RANGE(15,15);
...
}PF38F3040L0YUQ3_NORFLASH_CR_U;

#pragma arm section code = "NORMCP_SPEC_FUNC_IN_SRAM"
LOCAL void PF38F3040L0YUQ3_flash_cr_set_func(uint32 flash_addr_offset, uint32 cr, uint32 no_use)
{
...
LOCAL BOOLEAN PF38F3040L0YUQ3_psram_cr_cfg_func(
	SRAM_CFG_FUNC_INPARAM_PTR		sram_cfg_input_ptr,
	SRAM_CFG_FUNC_OUTPARAM_PTR		sram_cfg_output_ptr
	)
{	
	PF38F3040L0YUQ3_PSRAM_BCR_U sram_bcr;
	PF38F3040L0YUQ3_PSRAM_RCR_U sram_rcr;	//just uint32 type for rcr is enough	
	...
	{		
		...
		// Wait state
		sram_bcr.bits_map.latency_counter = (sram_cfg_input_ptr->clk <= 54)? 2:3;
	...
	)
{
	...
	flash_cfg_output_ptr->cs_cr_set_func = PF38F3040L0YUQ3_flash_cr_set_func;
...
//@checked
const NORMCP_SPEC_T g_normcp_PF38F3040L0YUQ3_spec  = 
{
	...
	{	85,			7,		NULL,			NULL,			0	},{	70,			7,			0,		0,	},	{54},
	//sram
	{	70,		    5,		NULL,			NULL,			0	},{	70,			5,			0,		0,	},	{54},

	PF38F3040L0YUQ3_psram_cr_cfg_func,
	
	PF38F3040L0YUQ3_flash_cr_cfg_func	

};
const NORMCP_SPEC_T g_normcp_PF38F3040L0YUQ3_B_spec  = 
{
	0x89,		//Manufacturer ID
	0x8835,	
	0x0,
...
const NORMCP_SPEC_T g_normcp_PF38F4050L0YUQ3_spec  = 
{
	0x89,		//Manufacturer ID
	0x880A,	
	0x0,
	...
	FLASH_WRITE_SINGLE_MODE |	FLASH_WRITE_BUFFER_MODE,

	FLASH_WRITE_BUFFER_LEN_64,   //confirm: 32 word
	
	ROW_LEN_128, 				//confirm: 16 word
...
//@checked
const NORMCP_SPEC_T g_normcp_PF38F4050L0YUQ3_B_spec  = 
{
	0x89,		//Manufacturer ID
	0x8836,	
	0x0,
