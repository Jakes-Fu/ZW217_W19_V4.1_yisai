/******************************************************************************
 ** File Name:      normcp_PF38F3050M0Y0YE.c		                              *
 ** Author:           hanjun.liu							                                *
 ** DATE:            28/010/2009                               								*
...
typedef union PF38F3050M0Y0YE_psram_bcr{
	struct PF38F3050M0Y0YE_psram_bcr_bits_map {
...
}PF38F3050M0Y0YE_PSRAM_BCR_U;


typedef union PF38F3050M0Y0YE_psram_rcr{
	struct PF38F3050M0Y0YE_psram_rcr_bits_map {
...
}PF38F3050M0Y0YE_PSRAM_RCR_U;

typedef union PF38F3050M0Y0YE_norflash_cr{
	struct PF38F3050M0Y0YE_norflash_cr_bits_map {
		volatile  uint	operating_mode		:BIT_RANGE(15,15);
...
}PF38F3050M0Y0YE_NORFLASH_CR_U;

#pragma arm section code = "NORMCP_SPEC_FUNC_IN_SRAM"
LOCAL void PF38F3050M0Y0YE_flash_cr_set_func(uint32 flash_addr_offset, uint32 cr, uint32 no_use)
{
...
LOCAL BOOLEAN PF38F3050M0Y0YE_psram_cr_cfg_func(
	SRAM_CFG_FUNC_INPARAM_PTR		sram_cfg_input_ptr,
	SRAM_CFG_FUNC_OUTPARAM_PTR		sram_cfg_output_ptr
	)
{	
	PF38F3050M0Y0YE_PSRAM_BCR_U sram_bcr;
	PF38F3050M0Y0YE_PSRAM_RCR_U sram_rcr;	//just uint32 type for rcr is enough	
	...
	{
		sram_rcr.bits_map.pagemode = 0x1;
	}
	...
	)
{
	...
	flash_cfg_output_ptr->cs_cr_set_func = PF38F3050M0Y0YE_flash_cr_set_func;
...
const NORMCP_SPEC_T g_normcp_PF38F3050M0Y0YE_spec  = 
{
	...
	{	96,			5,		96,			15,			7	},{	40,			5,			0,		0,	},	{133},
	//sram
	{	70,		    5,		70,			20,			10	},{	70,			5,			10,		10,	},	{104},

	PF38F3050M0Y0YE_psram_cr_cfg_func,
	
	PF38F3050M0Y0YE_flash_cr_cfg_func	
