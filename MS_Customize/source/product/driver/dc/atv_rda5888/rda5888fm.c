...
// for rda5888h
#define FM_SEEK_THRESHOLD3        70 // default: 70, range: 0~127.
...
uint16 RDA5888FM_GetRSSI(void)
{
	...
	uint16 rssi;
	rssi = RDA5888_FieldReadReg(0x8b, 0xfe00); //bit15-bit9, 1111 1110 0000 0000
	return rssi;
#endif
}
...
#elif (RDA5888_CHIP_VER == 7)
	// set fm seek threshold
	RDA5888_FieldWriteReg(0x0a3, 0x3ff, ((FM_SEEK_THRESHOLD3 << 7)|FM_SEEK_THRESHOLD3)); // 9'h1f4,16'h1d2d; bits <13:7>
	RDA5888_WriteReg(0x103,0x020d); // 9'h103,16'h020d
	RDA5888_WriteReg(0x114,0xefe0); // 9'h114,16'hefe0;	
#endif
...
{
    RDAEXT_DebugPrint(RDA5888_TRACE_MOD  "RDA5888FM_Exit");
