...
// ----------------------------------------------------------------------------
// This function sets frame skip count while change channel.
//
// Params:
//  nCount: skip nCount times.
//
// Return:
//  None.
// ----------------------------------------------------------------------------
void RDAAPP_SetFrameSkipCount(uint16 nCount);

// ----------------------------------------------------------------------------
// This function Gets frame skip count while change channel.
//
// Params:
//  None.
//
...
//  Current count times.
// ----------------------------------------------------------------------------
uint16 RDAAPP_GetFrameSkipCount(void);
