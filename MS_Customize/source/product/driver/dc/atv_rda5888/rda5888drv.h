...
// Labview Ver: 3.0(RDA5888), 1.8(RDA5888S), 1.2(RDA5888E), 1.1(RDA5888HE)
...
//#define RDA5888_AUXCLK_26M_ENABLE // use GPIO68 for share crystal.
...
//#define BB_GPIO_HOLD_RDA5888
#endif

#ifdef RDA5888_GPIO_I2C_ENABLE
// GPIO for ATV I2C interface
#define RDA5888_SDA_PIN  	65    // GPIO_PORT_3
#define RDA5888_SCL_PIN  	64    // GPIO_PORT_4
#endif

// GPIO/GPO for ATV PDN interface
#define RDA5888_POWER_PIN    40   // GPIO_PORT_47


#if defined(SPRD_CUSTOMER)
#define RDA5888_TRACE_MOD
#define ATV_USE_HW_I2C
#endif
