...
*
* SUPPORTED CHIPS       TLG_CHIP_TYPE            TLG_CHIP_REV
* ---------------   -----------------------     --------------
* TLG1120 1.1       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_1
* TLG1120 1.2       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_2
* TLG1120 2.1       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_3
* TLG1116 1.1       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_4
* TLG1120 2.3       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_5
* TLG1116 1.2       TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_6
* TLG1121 A0        TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_20
* TLG1121 A1        TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_21
* TLG1121 A2        TLG_CHIP_TYPE_TLG1120_1     TLG_CHIP_REV_22
*
*****************************************************************************/
...
*/
#define xHYBRID_DK_I    (1)
/*
    Enable FM Automatic Emphasis Control Support
*/
/** Enable FM Automatic Emphasis Control Support                            */
/** NOTE: THESE VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION          */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define xxTLG_SUPPORT_FM_AVC                 (1)

/** Base threshold value for FM Auto Emphasis Control Algorithm.            */
/** NOTE: THIS VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION           */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define TLG_FM_AVC_BASE_THRESHOLD           (31801)

/** FM Auto Emphasis Control filter count maximum threshold.                */
/** NOTE: THIS VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION           */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define TLG_FM_AVC_COUNT_MAX                (2)

/** FM Auto Emphasis Control filter difference threshold.                   */
/** NOTE: THESE VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION          */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define TLG_FM_AVC_LEAD_AHEAD               (1)
#define TLG_FM_AVC_REG_F0_MAX               (7)          
#define TLG_FM_AVC_REG_F0_INC_STEP          (1)
#define TLG_FM_AVC_REG_F0_DEC_STEP          (1)

/** This feature supports the automated changing of the agc behavior        */
/** NOTE: THESE VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION          */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define xxTLG_SUPPORT_AUTO_AGC_CHANGE        (1)

/** Enable Hybrid Video Standard Detection in the TLG_GetTVSSI().           */
/** NOTE: THIS VALUE SHOULD ONLY BE CHANGED ON THE RECOMMENDATION           */
/**       OF A TELEGENT FIELD ENGINEER.                                     */
#define xxTLG_SUPPORT_HYBRID_POLL            (1)
/*
...
#define SUPPORT_CHANNEL_MAP_SHENZHEN
...
//#define SUPPORT_CHANNEL_PALD_FactoryTest


/*********************proposal in tlgconfig.h**********/
#define TLG_BB_SYS_CLK_1           (80000000)
#define TLG_BB_SYS_CLK_2           (196000000)
#define TLG_BB_SYS_CLK_3           (0)
#define TLG_BB_SYS_CLK_4           (0)
#define TLG_BB_SYS_CLK_5           (0)

#define TLG_NOTCH_BW_1           (0)/*bandwidth of notch1 0 ~8 */
#define TLG_NOTCH_BW_2           (0)
#define TLG_NOTCH_BW_3           (0)
#define TLG_NOTCH_BW_4           (0)
#define TLG_NOTCH_BW_5           (0)
/*****************endof  tlgconfig.h*************************/
