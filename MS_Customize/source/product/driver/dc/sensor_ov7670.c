...
LOCAL uint32 OV7670_Set_Rot(uint32 ang_value);
 ...
 PUBLIC SENSOR_INFO_T g_OV7670_yuv_info =
{
	...
	7,                     // skip frame num before preview 
...
#define OV7670_VER_ADDR		0x0B	
	...
	//SCI_TRACE_LOW:"SENSOR: OV7670_Identify: it is OV7670"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_703_112_2_18_0_32_2_1170,(uint8*)"");
...
LOCAL uint32 _ov7670_InitExifInfo(void)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_718_112_2_18_0_32_2_1171,(uint8*)"");
...
LOCAL uint32 _ov7670_Power_On(uint32 power_on)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: _ov7670_Power_On(1:on, 0:off): %d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_851_112_2_18_0_32_2_1172,(uint8*)"d", power_on);
...
LOCAL uint32 set_ov7670_ae_enable(uint32 enable)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_873_112_2_18_0_32_2_1173,(uint8*)"d", enable);
...
LOCAL uint32 set_ov7670_ae_awb_enable(uint32 ae_enable, uint32 awb_enable)
{
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_905_112_2_18_0_32_2_1174,(uint8*)"dd", ae_enable, awb_enable);
...
LOCAL uint32 set_hmirror_enable(uint32 enable)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_915_112_2_18_0_32_2_1175,(uint8*)"d", enable);
...
LOCAL uint32 set_vmirror_enable(uint32 enable)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_924_112_2_18_0_32_2_1176,(uint8*)"d", enable);
...
//    SCI_ASSERT(PNULL != sensor_reg_ptr);   /*assert verified*/
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_954_112_2_18_0_32_2_1177,(uint8*)"d", level);
...
//    OS_TickDelay(100); 
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_985_112_2_18_0_32_2_1178,(uint8*)"d", mode);
...
LOCAL uint32 set_ov7670_video_mode(uint32 mode)
{
    ...
    if(CHIP_DetectMemType())
        sensor_reg_ptr = (SENSOR_REG_T*)ov7670_video_mode_nand_tab[mode];/*lint !e661*/
    else
        sensor_reg_ptr = (SENSOR_REG_T*)ov7670_video_mode_nor_tab[mode]; /*lint !e661*/
...
/*lint -esym(613, sensor_reg_ptr) */
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1070_112_2_18_0_32_2_1179,(uint8*)"d", mode);
    return 0;
}
...
//	OS_TickDelay(100); 
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1170_112_2_18_0_32_2_1180,(uint8*)"d", mode);
...
//	OS_TickDelay(100); 
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1204_112_2_18_0_32_3_1181,(uint8*)"d", level);
...
//    SCI_ASSERT(PNULL != sensor_reg_ptr);   /*assert verified*/
 ...
 //   OS_TickDelay(20);
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1238_112_2_18_0_32_3_1182,(uint8*)"d", level);
...
LOCAL uint32 set_preview_mode(uint32 preview_mode)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1266_112_2_18_0_32_3_1183,(uint8*)"d", preview_mode);
...
LOCAL uint32 set_image_effect(uint32 effect_type)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1355_112_2_18_0_32_3_1184,(uint8*)"d", effect_type);
...
LOCAL uint32 OV7670_After_Snapshot(uint32 param)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1363_112_2_18_0_32_3_1185,(uint8*)"");
...
#define  OV7670_NORMAL_MAX_EXPLINE 508 
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1409_112_2_18_0_32_3_1186,(uint8*)"");
    ...
    else
    {
         ...
         SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1421_112_2_18_0_32_3_1187,(uint8*)"");
    }
	
    //SCI_TRACE_LOW:"OV7670_BeforeSnapshot max_line= %d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1424_112_2_18_0_32_3_1188,(uint8*)"d", max_line );
    ...
    //SCI_TRACE_LOW:"OV7670_BeforeSnapshot exposal= %d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1481_112_2_18_0_32_3_1189,(uint8*)"d", exposal );
    if(exposal>498)
    {
...
//    SCI_ASSERT(PNULL != sensor_reg_ptr);   /*assert verified*/
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1620_112_2_18_0_32_3_1190,(uint8*)"d", mode);
    return 0;
}
...
LOCAL uint32 OV7670_Set_Rot(uint32 ang_value)
{
     ...
     unsigned char value =(uint8)( (ang_value >> 24)&0xff);
       ...
       //SCI_TRACE_LOW:"OV7670_set_ae_Rot: %d"
       SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_OV7670_1639_112_2_18_0_32_3_1191,(uint8*)"d", ang_value);
