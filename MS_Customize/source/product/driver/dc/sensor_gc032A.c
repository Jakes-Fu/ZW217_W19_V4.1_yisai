...
/*System*/
    ...
    {0x17,0x57},
#else
    {0x17,0x56},// wuxx modify ÏÔÊ¾µ¹µÄ 0x55-0x57 ---0X56 OK   ZW201_CAMERA_ROTATION
#endif
    {0x19,0x08},
    {0x1a,0x0a},
    {0x1f,0x40},
...
__align(4) const SENSOR_REG_T GC032A_image_effect_tab[][5]=
{
    ...
    //effect BLACKWHITE
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0x00}, {0xdb,0x00}, {0xff,0xff}},
    // effect RED pink
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0x10}, {0xdb,0x50}, {0xff,0xff},},
    // effect GREEN
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0xc0}, {0xdb,0xc0}, {0xff,0xff}},
    // effect  BLUE
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0x50}, {0xdb,0xe0}, {0xff,0xff}},
    // effect  YELLOW
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0x80}, {0xdb,0x20}, {0xff,0xff}},
    // effect NEGATIVE
    {{0xfe,0x00}, {0x43,0x51}, {0xda,0x00}, {0xdb,0x00}, {0xff,0xff}},
    //effect ANTIQUE
    {{0xfe,0x00}, {0x43,0x52}, {0xda,0xd2}, {0xdb,0x28}, {0xff,0xff}},
#else
    // effect normal
    {{0xfe,0x00}, {0x43,0x10}, {0xda,0x00}, {0xdb,0x00}, {0xff,0xff}},
    //effect BLACKWHITE
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0x00}, {0xdb,0x00}, {0xff,0xff}},
    // effect RED pink
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0x10}, {0xdb,0x50}, {0xff,0xff},},
    // effect GREEN
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0xc0}, {0xdb,0xc0}, {0xff,0xff}},
    // effect  BLUE
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0x50}, {0xdb,0xe0}, {0xff,0xff}},
    // effect  YELLOW
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0x80}, {0xdb,0x20}, {0xff,0xff}},
    // effect NEGATIVE
    {{0xfe,0x00}, {0x43,0x11}, {0xda,0x00}, {0xdb,0x00}, {0xff,0xff}},
    //effect ANTIQUE
    {{0xfe,0x00}, {0x43,0x12}, {0xda,0xd2}, {0xdb,0x28}, {0xff,0xff}},
#endif
};
...
__align(4) const SENSOR_REG_T GC032a_image_res_tab[][22]=
{
    // VGA
    {
        {0xfe,0x00},{0x51,0x00},{0x52,0x00},{0x53,0x00},{0x54,0x50},{0x55,0x01},{0x56,0xe0},{0x57,0x01},{0x58,0xe0},
        {0x43,0x10},{0xf7,0x01},{0xf8,0x02},{0xfa,0x00},{0xfe,0x01},{0x13,0x4a},{0xfe,0x03},{0x5b,0xe0},{0x5c,0x01},{0x5d,0xe0},{0x5e,0x01},{0xfe,0x00},
        {0xff,0xff}
    },
    // QVGA
    {
        {0xfe,0x00},{0x51,0x00},{0x52,0x00},{0x53,0x00},{0x54,0x28},{0x55,0x00},{0x56,0xF0},{0x57,0x00},{0x58,0xF0},
        {0x43,0x50},{0xf7,0x11},{0xf8,0x02},{0xfa,0x00},{0xfe,0x01},{0x13,0x4a},{0xfe,0x03},{0x5b,0xF0},{0x5c,0x00},{0x5d,0xF0},{0x5e,0x00},{0xfe,0x00},
        {0xff,0xff}
    },
    // others
    {{0xff, 0xff}}
