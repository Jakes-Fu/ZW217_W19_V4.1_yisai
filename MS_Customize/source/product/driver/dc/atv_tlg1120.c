...
LOCAL uint32 _TLG1120_InitChannel(void)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: _TLG1120_InitChannel"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_260_112_2_18_0_30_28_673,(uint8*)"");
...
LOCAL uint32 _TLG1120_PowerOnSequence(uint32 power_on)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: _tlg1120_Power_On(1:on, 0:off): %d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_386_112_2_18_0_30_28_674,(uint8*)"d", power_on);
...
LOCAL uint32 _TLG1120_Identify(uint32 param)
{
    ...
    //SCI_TRACE_LOW:"ATV: _TLG1120_Identify"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_425_112_2_18_0_30_29_675,(uint8*)"");

    TLG1120_IICReadReg(0x0146,&value);    
    if((0x0000!=value)
        &&(0xffff!=value))
    {
        //SCI_TRACE_LOW:"ATV: the atv is TLG1120"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_431_112_2_18_0_30_29_676,(uint8*)"");
    }
    else
    {
        //SCI_TRACE_LOW:"ATV: the atv is not TLG1120"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_435_112_2_18_0_30_29_677,(uint8*)"");
        rtn=SCI_ERROR;
    }
...
LOCAL uint32 _TLG1120_Init(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_Init"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_450_112_2_18_0_30_29_678,(uint8*)"");
...
{
    //SCI_TraceLow:"ATV:_TLG1120_Sleep"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_466_112_2_18_0_30_29_679,(uint8*)"");
...
LOCAL uint32 _TLG1120_ScanChnInit(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_ScanChnInit"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_490_112_2_18_0_30_29_680,(uint8*)"");
...
LOCAL uint32 _TLG1120_ScanChn(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_ScanChn"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_522_112_2_18_0_30_29_681,(uint8*)"");
...
LOCAL uint32 _TLG1120_SetChn(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_SetChn : 0x%x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_547_112_2_18_0_30_29_682,(uint8*)"d", param);
...
LOCAL uint32 _TLG1120_GetAllChnNum(void)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_GetAllChnNum"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_576_112_2_18_0_30_29_683,(uint8*)"");
...
LOCAL uint32 _TLG1120_SetVolume(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_SetVolume : 0x0%x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_595_112_2_18_0_30_29_684,(uint8*)"d", param);
...
LOCAL uint32 _TLG1120_SetRegion(uint32 param)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_SetRegion"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_635_112_2_18_0_30_29_685,(uint8*)"");
...
LOCAL uint32 _TLG1120_GetRssi(void)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_GetRssi"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_737_112_2_18_0_30_29_686,(uint8*)"");
...
PUBLIC BOOLEAN _TLG1120_IsNTSCMode(void)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_IsNTSCMode"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_788_112_2_18_0_30_29_687,(uint8*)"");
    ...
    switch(atv_info_ptr->atv_cur_region)
    {
        ...
        case ATV_REGION_VENEZUELA:
        case ATV_REGION_PHILIPPINES:
			 //SCI_TraceLow:"ATV:_TLG1120_is NTSC"
			 SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_802_112_2_18_0_30_29_688,(uint8*)"");
            Is_NTSCMode=SCI_TRUE;
            break;

        default:
			 //SCI_TraceLow:"ATV:_TLG1120_is PAL"
			 SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_807_112_2_18_0_30_29_689,(uint8*)"");
...
LOCAL uint32 _TLG1120_Close(void)
{
    ...
    //SCI_TraceLow:"ATV:_TLG1120_Close"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_838_112_2_18_0_30_29_690,(uint8*)"");
...
LOCAL uint32 TLG1120_IICWriteReg(uint16 addr, uint16 data)
{
    ...
    //SCI_TRACE_LOW:"ATV: tlg1120_WriteReg reg/value(0x%x,0x%x) !!"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_854_112_2_18_0_30_30_691,(uint8*)"dd", addr, data);
...
LOCAL uint32 TLG1120_IICReadReg(uint16 addr, uint16 *data)
{
    ...
    //SCI_TRACE_LOW:"ATV: tlg1120_ReadReg reg/value(0x%x,0x%x) !!"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,ATV_TLG1120_867_112_2_18_0_30_30_692,(uint8*)"dd", addr, *data);
...
LOCAL uint32 _TLG1120_IOCTL(uint32 ctl_param)
{
    ...
    //SCI_TraceLow("ATV:_TLG1120_IOCTL cmd:0x%x, param:0x%x",cmd,param);
