...
#define s5k5cagx_I2C_ADDR_W       0x5a 
#define s5k5cagx_I2C_ADDR_R       0x5b
#else
#define s5k5cagx_I2C_ADDR_W       0x78 
#define s5k5cagx_I2C_ADDR_R       0x79
#endif
 ...
 **---------------------------------------------------------------------------*/
LOCAL uint32 _s5k5cagx_InitExifInfo(void);
LOCAL uint32 _s5k5cagx_GetResolutionTrimTab(uint32 param);
LOCAL uint32 _s5k5cagx_PowerOn(uint32 power_on);
LOCAL uint32 _s5k5cagx_Identify(uint32 param);
LOCAL uint32 _s5k5cagx_set_brightness(uint32 level);
LOCAL uint32 _s5k5cagx_set_contrast(uint32 level);
LOCAL uint32 _s5k5cagx_set_sharpness(uint32 level);
LOCAL uint32 _s5k5cagx_set_saturation(uint32 level);
LOCAL uint32 _s5k5cagx_set_image_effect(uint32 effect_type);
LOCAL uint32 _s5k5cagx_set_ev(uint32 level); 
LOCAL uint32 _s5k5cagx_set_awb(uint32 mode);
LOCAL uint32 _s5k5cagx_set_work_mode(uint32 mode);
LOCAL uint32 _s5k5cagx_BeforeSnapshot(uint32 param);
LOCAL uint32 _s5k5cagx_check_image_format_support(uint32 param); 
LOCAL uint32 _s5k5cagx_pick_out_jpeg_stream(uint32 param);
LOCAL uint32 _s5k5cagx_chang_image_format(uint32 param);
LOCAL uint32 _s5k5cagx_after_snapshot(uint32 param);
LOCAL uint32 _s5k5cagx_GetExifInfo(uint32 param);
LOCAL uint32 _s5k5cagx_ExtFunc(uint32 ctl_param);
LOCAL uint32 _s5k5cagx_EnterSleep(uint32 pwd_level);

__align(4) LOCAL const SENSOR_REG_T s5k5cagx_common[]= 
{
// ARM GO
// Direct mode 
...
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_640X480[]=
{
    {SENSOR_WRITE_DELAY, 10},
    {0xFCFC, 0xD000},
    {0x0010, 0x0001},	
...
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_1280X960[] =
{
    {0x002A, 0x03B4},  
    {0x0F12, 0x0000},  
    {0x0F12, 0x0500},  
...
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_1600X1200[] =
{ 
    {0x002A, 0x0388},  
    {0x0F12, 0x0000},  
    {0x0F12, 0x0640},  
...
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_2048X1536[] =
{
    {0x002A, 0x035C},
    {0x0F12, 0x0000},  
    {0x0F12, 0x0800},  
...
BOOLEAN s_s5k5cagx_pwr_flag = SCI_FALSE;
...
LOCAL uint32 _s5k5cagx_InitExifInfo(void)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_InitExifInfo"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_3878_112_2_18_0_32_27_1268,(uint8*)"");
...
LOCAL uint32 _s5k5cagx_GetResolutionTrimTab(uint32 param)
{
    return (uint32)s_s5k5cagx_Resolution_Trim_Tab;
}
...
LOCAL uint32 _s5k5cagx_PowerOn(uint32 power_on)
{
    ...
    uint32 reset_width=g_s5k5cagx_yuv_info.reset_pulse_width;        

    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_PowerOn(1:on, 0:off): Entry"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_3971_112_2_18_0_32_27_1269,(uint8*)"");
    
    if(SCI_TRUE==power_on)
    {            
        //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_PowerOn"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_3975_112_2_18_0_32_27_1270,(uint8*)"");
        
        //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_PowerOn dvdd/avdd/iovdd = {%d/%d/%d}"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_3978_112_2_18_0_32_27_1271,(uint8*)"ddd", dvdd_val, avdd_val, iovdd_val);
    ...
    {
        //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_PowerDown"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_3997_112_2_18_0_32_27_1272,(uint8*)"");
    ...
    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_Power_On(1:on, 0:off): %d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4011_112_2_18_0_32_27_1273,(uint8*)"d", power_on);
    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_PowerOn(1:on, 0:off): End"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4012_112_2_18_0_32_27_1274,(uint8*)"");
...
LOCAL uint32 _s5k5cagx_Identify(uint32 param)
{
    ...
    uint16 pid_value = 0x00;
    //uint16 ver_value = 0x00;
    uint32 ret_value = SCI_ERROR;

    Sensor_WriteReg(0x0028, 0xD000);
    //Sensor_WriteReg(0x002A, 0x1006);

    //SCI_TRACE_LOW:"s5k5cagx_Identify Entry"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4036_112_2_18_0_32_27_1275,(uint8*)"");
    pid_value = Sensor_ReadReg(0x1006);
    //SCI_TRACE_LOW:"s5k5cagx_Identify 0xD0001006 PID = 0x%x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4038_112_2_18_0_32_27_1276,(uint8*)"d", pid_value);

    Sensor_WriteReg(0x002C, 0x0000);
    Sensor_WriteReg(0x002E, 0x0040);
        
    //SCI_TRACE_LOW:"s5k5cagx_Identify Entry"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4043_112_2_18_0_32_27_1277,(uint8*)"");
    pid_value = Sensor_ReadReg(0x0F12);
    //SCI_TRACE_LOW:"s5k5cagx_Identify 0x00000040 PID = 0x%x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4045_112_2_18_0_32_27_1278,(uint8*)"d", pid_value);

    if(s5k5cagx_PID_VALUE != pid_value)
    {
         //SCI_TRACE_LOW:"That is not s5k5cagx sensor ! error!"
         SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4049_112_2_18_0_32_27_1279,(uint8*)"");
         return ret_value;
    }
    /*
    if(s5k5cagx_PID_VALUE==pid_value)
    {   
        ver_value=Sensor_ReadReg(s5k5cagx_VER_ADDR);

        //SCI_TRACE_LOW:"s5k5cagx_Identify: PID = %x, VER = %x"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4057_112_2_18_0_32_27_1280,(uint8*)"dd",pid_value, ver_value);

        if(s5k5cagx_VER_VALUE==ver_value)
        {
            ret_value=SCI_SUCCESS;
            //SCI_TRACE_LOW:"That is s5k5cagx sensor !"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4062_112_2_18_0_32_27_1281,(uint8*)"");
        }
        else
        {
            //SCI_TRACE_LOW:"s5k5cagx_Identify: That is OV%x%x sensor !"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4066_112_2_18_0_32_27_1282,(uint8*)"dd", pid_value, ver_value);
        }

    }
    */
     //SCI_TRACE_LOW:"That is s5k5cagx sensor !"
     SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4071_112_2_18_0_32_27_1283,(uint8*)"");
    //SCI_TRACE_LOW:"s5k5cagx_Identify End"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4072_112_2_18_0_32_27_1284,(uint8*)"");
...
//
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_brightness_tab[][4]=
{
    {//level -3
...
LOCAL uint32 _s5k5cagx_set_brightness(uint32 level)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_brightness = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4120_112_2_18_0_32_27_1285,(uint8*)"d", level);
    return 0;
}
...
//
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_contrast_tab[][4]=
{
    {//level -3
...
LOCAL uint32 _s5k5cagx_set_contrast(uint32 level)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_contrast = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4168_112_2_18_0_32_28_1286,(uint8*)"d", level);
    return 0;
}
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_sharpness_tab[][3]=
{
    {//level -3
...
LOCAL uint32 _s5k5cagx_set_sharpness(uint32 level)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_sharpness = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4216_112_2_18_0_32_28_1287,(uint8*)"d", level);
    return 0;
}
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_saturation_tab[][3]=
{
    {//level -3
...
LOCAL uint32 _s5k5cagx_set_saturation(uint32 level)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_saturation = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4261_112_2_18_0_32_28_1288,(uint8*)"d", level);
    return 0;
}
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_image_effect_tab[][14]=
{
...
LOCAL uint32 _s5k5cagx_set_image_effect(uint32 effect_type)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_image_effect = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4422_112_2_18_0_32_28_1289,(uint8*)"d", effect_type);
    return 0;
}
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_ev_tab[][4]=
{
    {//level -3
...
LOCAL uint32 _s5k5cagx_set_ev(uint32 level)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_ev = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4469_112_2_18_0_32_28_1290,(uint8*)"d", level);
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_awb_tab[][13]=
{
    //AUTO
    {
        {0x0028, 0x7000}, 
...
{   
    ...
    //SCI_TRACE_LOW:"SENSOR: s5k5cagx_set_awb = 0x%02x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4553_112_2_18_0_32_28_1291,(uint8*)"d", mode);
    return 0;
}
...
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_work_mode_tab[][16]=
{
...
LOCAL uint32 _s5k5cagx_set_work_mode(uint32 mode)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4617_112_2_18_0_32_28_1292,(uint8*)"d", mode);
    return 0;
}
...
LOCAL uint32 _s5k5cagx_BeforeSnapshot(uint32 param)
{
    //SCI_TRACE_LOW:"_s5k5cagx_BeforeSnapshot =%d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4629_112_2_18_0_32_28_1293,(uint8*)"d",param);
...
LOCAL uint32 _s5k5cagx_check_image_format_support(uint32 param) 
{
    ...
    switch(param)
    {
        ...
        case SENSOR_IMAGE_FORMAT_JPEG:
            ...
            break;
        default:
            //SCI_TRACE_LOW:"s5k5cagx only support SENSOR_IMAGE_FORMAT_JPEG & SENSOR_IMAGE_FORMAT_YUV422, input is %d"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4655_112_2_18_0_32_29_1294,(uint8*)"d");
            break;
    }
...
LOCAL uint32 _s5k5cagx_pick_out_jpeg_stream(uint32 param)
{
    ...
    //SCI_TRACE_LOW:"s5k5cagx: jpeg capture head: 0x%x, 0x%x"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4674_112_2_18_0_32_29_1295,(uint8*)"dd", *((uint8*)p_frame), *((uint8*)p_frame + 1));
    ...
    if(i < buf_len)
    {
        //SCI_TRACE_LOW:"s5k5cagx: Found the jpeg tail at %d: 0x%x 0x%x"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4695_112_2_18_0_32_29_1296,(uint8*)"ddd", i+1, *((uint8*)p_frame + i), *((uint8*)p_frame + i + 1));
    }
    else
    {
        //SCI_TRACE_LOW:"s5k5cagx: can not find the jpeg tail: %d"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4699_112_2_18_0_32_29_1297,(uint8*)"d", i);
        i=0x00;
    }
...
LOCAL uint32 _s5k5cagx_chang_image_format(uint32 param)
{
    ...
    SENSOR_REG_TAB_INFO_T st_yuv422_reg_table_info = 
        { ADDR_AND_LEN_OF_ARRAY(s5k5cagx_640X480),0,0,0,0};
 
    switch(param)
    {
        case SENSOR_IMAGE_FORMAT_YUV422:
            //SCI_TRACE_LOW:"s5k5cagx  chang_image_format  YUV422"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4719_112_2_18_0_32_29_1298,(uint8*)"");
            ret_val = Sensor_SendRegTabToSensor(&st_yuv422_reg_table_info);
            break;

        case SENSOR_IMAGE_FORMAT_JPEG:
            //SCI_TRACE_LOW:"s5k5cagx  chang_image_format  jpg"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4724_112_2_18_0_32_29_1299,(uint8*)"");
            ret_val = SCI_ERROR;//Sensor_SendRegTabToSensor(&st_jpeg_reg_table_info);
            break;

        default:
            SCI_PASSERT(0, ("s5k5cagx only support SENSOR_IMAGE_FORMAT_JPEG & \
                SENSOR_IMAGE_FORMAT_YUV422, input is %d", param));
            break;
    }
...
//        
/******************************************************************************/
__align(4) LOCAL const SENSOR_REG_T s5k5cagx_preview[]=
{
    {0x002A, 0x026C},
    {0x0F12, 0x0280}, //640X480	
    {0x0F12, 0x01E0},
...
LOCAL uint32 _s5k5cagx_after_snapshot(uint32 param)
{
    ...
    //SCI_TRACE_LOW:"_s5k5cagx_after_snapshot =%d"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4787_112_2_18_0_32_29_1300,(uint8*)"d",param);
...
LOCAL uint32 _s5k5cagx_InitExt(uint32 param)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4817_112_2_18_0_32_29_1301,(uint8*)"");
...
/*
    ...
    if(dev_handler == -1)
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4832_112_2_18_0_32_29_1302,(uint8*)"");
        return SCI_ERROR;
    }
*/
    ...
    while(written_num < init_table_size)
    {
        ...
        else
        {
            ...
            if(wr_num_once_ret != (uint32)(wr_num_once*2))
            {
                ...
                SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4885_112_2_18_0_32_29_1303,(uint8*)"");
                rtn = SCI_ERROR;
                break;
            }
            else
            {
                ...
                SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4892_112_2_18_0_32_29_1304,(uint8*)"ddddddd",written_num,cmd[0],cmd[1],wr_num_once,p_reg_val_tmp[0],p_reg_val_tmp[1],SCI_GetTickCount());
                if(wr_num_once > 1)
                {
                    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_InitExt, reg,{0x%x 0x%x} val {0x%x 0x%x} {0x%x 0x%x} {0x%x 0x%x}"
                    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4897_112_2_18_0_32_29_1305,(uint8*)"dddddddd",cmd[0],cmd[1],p_reg_val_tmp[0],p_reg_val_tmp[1],p_reg_val_tmp[2],p_reg_val_tmp[3],p_reg_val_tmp[4],p_reg_val_tmp[5]);
...
/*
    if(0x00!=I2C_HAL_Close(dev_handler))
    {
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4907_112_2_18_0_32_29_1306,(uint8*)"");
        rtn = SCI_ERROR;
    }
    else
    {
        //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_InitExt, i2c close success"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4912_112_2_18_0_32_29_1307,(uint8*)"");
    }
*/
    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_InitExt, success"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4915_112_2_18_0_32_29_1308,(uint8*)"");
...
LOCAL uint32 _s5k5cagx_ExtFunc(uint32 ctl_param)
{
    ...
    //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_ExtFunc cmd:0x%x "
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4932_112_2_18_0_32_29_1309,(uint8*)"d",ext_ptr->cmd);
    ...
    switch(ext_ptr->cmd)
    {
        ...
        default :
            ...
            //SCI_TRACE_LOW:"SENSOR: _s5k5cagx_ExtFunc unsupported command"
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5K5CAGX_4944_112_2_18_0_32_29_1310,(uint8*)"");
            rtn = SCI_ERROR;
