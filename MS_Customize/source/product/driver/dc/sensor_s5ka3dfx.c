 ...
 ** 						   Macro Define
 **---------------------------------------------------------------------------*/
#define S5KA3DFX_I2C_ADDR_W		0xC4
#define S5KA3DFX_I2C_ADDR_R		0xC5
 ...
 **---------------------------------------------------------------------------*/
LOCAL uint32 set_s5ka3dfx_ae_enable(uint32 enable);
LOCAL uint32 set_hmirror_enable(uint32 enable);
LOCAL uint32 set_vmirror_enable(uint32 enable);
LOCAL uint32 s5ka3dfx_set_preview_mode(uint32 preview_mode);
LOCAL uint32 s5ka3dfx_Identify(uint32 param);
LOCAL uint32 s5ka3dfx_BeforeSnapshot(uint32 param);
LOCAL uint32 s5ka3dfx_After_Snapshot(uint32 param);

LOCAL uint32 s5ka3dfx_set_brightness(uint32 level);
LOCAL uint32 s5ka3dfx_set_contrast(uint32 level);
LOCAL uint32 set_sharpness(uint32 level);
LOCAL uint32 set_saturation(uint32 level);
LOCAL uint32 s5ka3dfx_set_image_effect(uint32 effect_type);
...
LOCAL uint32 s5ka3dfx_set_work_mode(uint32 mode);
LOCAL uint32 s5ka3dfx_ev_compensation(uint32 ev_mode);
LOCAL uint32 s5ka3dfx_set_flicker_elimination(uint32 flicker_mode);
LOCAL uint32 s5ka3dfx_set_iso(uint32 iso_type);
LOCAL uint32 s5ka3dfx_get_ev(uint32 param);
LOCAL uint32 s5ka3dfx_set_wb_mode(uint32 wb_mode);
LOCAL uint32 _s5ka3dfx_Power_On(uint32 power_on);
LOCAL uint32 _s5ka3dfx_Reset(uint32 param);
LOCAL uint32 s5ka3dfx_set_meter_mode(uint32 param);
...
// init seq 
__align(4) const SENSOR_REG_T s5ka3dfx_YUV_640X480[]=
...
__align(4) const SENSOR_REG_T s5ka3dfx_cameramode_tab[]=
{
{0xef,0x03},
{0x5f,0x03},
{0x60,0x02},
...
__align(4) const SENSOR_REG_T s5ka3dfx_camcordermode_tab[]=
{
{0xef,0x03},
{0x5f,0x08},
{0x60,0x06},
...
LOCAL uint32 _s5ka3dfx_Power_On(uint32 power_on)
{
	...
	//SCI_TRACE_LOW:"SENSOR: _s5ka3dfx_Power_On  power_on =0x%x"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_844_112_2_18_0_32_31_1311,(uint8*)"d", power_on);
 ...
 **---------------------------------------------------------------------------*/
LOCAL void s5ka3dfx_WriteReg( uint8  subaddr, uint8 data )
{
		...
		//I2C_WriteCmdArr(S5KA3DFX_I2C_ADDR_W, cmd, 2, SCI_TRUE);
		Sensor_WriteReg( subaddr,  data);
	#else
		DSENSOR_IICWrite((uint16)subaddr, (uint16)data);
	#endif

	//SCI_TRACE_LOW:"SENSOR: S5KA3DFX_WriteReg 0x%x=0x%x"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_896_112_2_18_0_32_31_1312,(uint8*)"dd", subaddr, data);

}

LOCAL uint8 s5ka3dfx_ReadReg( uint8  subaddr)
{
	uint8 value = 0;
	...
	#endif
	//SCI_TRACE_LOW:"SENSOR: S5KA3DFX_WriteReg 0x%x=0x%x"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_911_112_2_18_0_32_31_1313,(uint8*)"dd", subaddr, value);
	return value;
}
...
LOCAL uint32 s5ka3dfx_Identify(uint32 param) 
{
    ...
    //SCI_TRACE_LOW:"S5KA3DFX_Identify: it is S5KA3DFX"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_923_112_2_18_0_32_31_1314,(uint8*)"");

    s5ka3dfx_WriteReg(S5KA3DFX_SWITCH_PAGE_ID, S5KA3DFX_PAGE1_ID);    
    
    ret = s5ka3dfx_ReadReg(reg[0]);  
    //SCI_TRACE_LOW:"S5KA3DFX_Identify: it is S5KA3DFX 0x%x after read reg"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_928_112_2_18_0_32_31_1315,(uint8*)"d", ret);
#if 0
    if(value[0]!=ret)
    {
        //SCI_TRACE_LOW:"This is not S5KA3DFX sensor"
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_932_112_2_18_0_32_31_1316,(uint8*)"");
        return SCI_ERROR;
    }

    //SCI_TRACE_LOW:"S5KA3DFX_Identify: it is S5KA3DFX"
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_936_112_2_18_0_32_31_1317,(uint8*)"");
#endif
return (uint32)SCI_SUCCESS;
...
LOCAL uint32 set_hmirror_enable(uint32 enable)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_955_112_2_18_0_32_31_1318,(uint8*)"d", enable);
...
LOCAL uint32 set_vmirror_enable(uint32 enable)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_967_112_2_18_0_32_31_1319,(uint8*)"d", enable);
...
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_brightness_tab[][5]=
{
	{		
		{0xef, 0x03}, 
		{0x31, 0xaa}, 
...
LOCAL uint32 s5ka3dfx_set_brightness(uint32 level)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1051_112_2_18_0_32_32_1320,(uint8*)"d", level);
	
	return 0;
}

__align(4) const SENSOR_REG_T s5ka3dfx_contrast_tab[][2]=
{
	{{0xff,0xff}},
	{{0xff,0xff}},
	{{0xff,0xff}},
...
LOCAL uint32 s5ka3dfx_set_contrast(uint32 level)
{
    ...
    SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1083_112_2_18_0_32_32_1321,(uint8*)"d", level);
...
LOCAL uint32 s5ka3dfx_set_preview_mode(uint32 preview_mode)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1111_112_2_18_0_32_32_1322,(uint8*)"d", preview_mode);
...
//		
/******************************************************************************/
 __align(4) const SENSOR_REG_T s5ka3dfx_image_effect_tab[][10]=
...
LOCAL uint32 s5ka3dfx_set_image_effect(uint32 effect_type)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1227_112_2_18_0_32_32_1323,(uint8*)"d", effect_type);
...
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_iso_tab[][3]=
{
	//IS0 atuto
	{
		{0xff, 0xff}
...
LOCAL uint32 s5ka3dfx_set_iso(uint32 iso_type)
{
	...
	//SCI_TRACE_LOW:"s5ka3dfx_set_iso: iso_type = %d"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1338_112_2_18_0_32_32_1324,(uint8*)"d", iso_type);
...
//		white blance 
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_wb_mode_tab[][8]=
{
...
LOCAL uint32 s5ka3dfx_set_wb_mode(uint32 wb_mode)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1423_112_2_18_0_32_32_1325,(uint8*)"d", wb_mode);
...
//		mode 0:normal;   1:night 
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_flicker_mode_tab[][5]=
{
	//svga 50Hz
	{
	    {0xff, 0xff}	
...
LOCAL uint32 s5ka3dfx_set_flicker_elimination(uint32 flicker_mode)
{
	...
	//SCI_TRACE_LOW:"s5ka3dfx_set_flicker_elimination_mode: flicker_mode = %d"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1457_112_2_18_0_32_32_1326,(uint8*)"d", flicker_mode);
...
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_ev_compensation_tab[][3]=
{
...
LOCAL uint32 s5ka3dfx_ev_compensation(uint32 ev_mode)
{
	...
	//SCI_TRACE_LOW:"s5ka3dfx_ev_compensation: ev_mode = %d"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1491_112_2_18_0_32_33_1327,(uint8*)"d", ev_mode);
...
LOCAL uint32 s5ka3dfx_set_meter_mode(uint32 param)
{
	...
	//SCI_TRACE_LOW:"s5ka3dfx_set_meter_mode: mode = %d, rect(%d,%d,%d,%d)"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1530_112_2_18_0_32_33_1328,(uint8*)"ddddd", p_para[0],p_para[1],p_para[2],p_para[3],p_para[4]);
...
//		mode 0:normal;	 1:night 
/******************************************************************************/
__align(4) const SENSOR_REG_T s5ka3dfx_mode_tab[][64]=
{
    	{ 
...
LOCAL uint32 s5ka3dfx_set_work_mode(uint32 mode)
{
	...
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,SENSOR_S5KA3DFX_1684_112_2_18_0_32_33_1329,(uint8*)"d", mode);
	return 0;
}
