 ...
 * @return pointer to allocated memory
 */
ecma_object_t * JERRY_ATTR_ALWAYS_INLINE
 ...
 * @return pointer to allocated memory
 */
ecma_extended_object_t * JERRY_ATTR_ALWAYS_INLINE
 ...
 * @return pointer to allocated memory
 */
ecma_string_t * JERRY_ATTR_ALWAYS_INLINE
 ...
 * @return pointer to allocated memory
 */
ecma_extended_string_t * JERRY_ATTR_ALWAYS_INLINE
 ...
 * @return pointer to allocated memory
 */
ecma_property_pair_t * JERRY_ATTR_ALWAYS_INLINE
