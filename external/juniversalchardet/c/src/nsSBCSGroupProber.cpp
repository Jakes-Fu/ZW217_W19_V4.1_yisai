...
nsSBCSGroupProber::nsSBCSGroupProber()
{
  ...
  mProbers[0] = new nsSingleByteCharSetProber(&Win1251Model);
  mProbers[1] = new nsSingleByteCharSetProber(&Koi8rModel);
  mProbers[2] = new nsSingleByteCharSetProber(&MacCyrillicModel);
  mProbers[3] = new nsSingleByteCharSetProber(&Ibm866Model);
  mProbers[4] = new nsSingleByteCharSetProber(&Ibm855Model);
