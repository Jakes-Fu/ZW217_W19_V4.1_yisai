 ...
 */
#define TLG_VERSION_MAJOR   (3)
#define TLG_VERSION_MINOR   (3)
...
#define TLG_MVE_NONE        (2) /*!<Mobile Video Enhancement "No" Mode      */
...
#define TLG_DSM_DIFF        (3) /*Audio Mode Analog (DSM)  diff option      */
#define TLG_UNDEFINED       (4) /*!<Undefined option                        */
...
#define TLG_MIN_AUD_GAIN        ( 0) /*!< min gain for TLG_MASTER*/
#define TLG_MAX_AUD_GAIN_DIG    ( 9) /*!< max gain for TLG_MASTER */
#define TLG_MAX_AUD_GAIN_DAC    ( 5) /*!< max gain for TLG_DAC              */

#define TLG_MIN_DSM_VOLUME          (0) /*!<min volume for TLG_DAC                */
#define TLG_MIN_I2S_VOLUME          (0) /*!<min volume for TLG_MASTER*/
#define TLG_MAX_DSM_VOLUME          (10) /*!<max volume for TLG_DAC               */
#define TLG_MAX_I2S_VOLUME          (14) /*!<max volume for TLG_MASTER*/
#define TLG_MAX_I2S_VOLUME_2_1      (12) /*!<max volume for TLG_MASTERfor 2.1 chip */
#define TLG_MAX_DSM_VOLUME_2_1      (9) /*!<max volume for TLG_DAC for 2.1 chip */
...
#define TLG_MAX_VIDEO_BUS_STRENGTH      7
#define TLG_MAX_VIDEO_CKO_STRENGTH      7
#define TLG_MAX_I2S_BUS_STRENGTH_SL      7
#define TLG_MAX_I2S_BUS_STRENGTH_SM      7
/** Supported 601 bus drive strength parameters.
 *
 */
 /** lowes drive strength.                                                  */
#define TLG_601_BUS_DRIVE_MIN       (0x0) /*!< lowest drive strength.       */
#define TLG_601_BUS_DRIVE_MAX       (0x7) /*!< highest drive strength.      */

/** 601 bus select mask to select all 601 bus lines.                        */
#define TLG_601_BUS_SELECT_ALL      (0xffe0)
#define TLG_601_BUS_SELECT_DATA     (0xff00)
#define TLG_601_BUS_SELECT_CLK      (0x0080)
...
#define BAND6_AUDIO_OFFSET 2750000
#define BAND7_AUDIO_OFFSET 3250000
#define BAND8_AUDIO_OFFSET 3750000
...
typedef enum {
    ...
    TLG_ANTENNA_SE,              /*!< Set Antenna to Single-Ended config     */
    TLG_ANTENNA_MAX             /*!< Number of Antenna settings             */
} tlg_antenna_t;


/** System clock types supported                                            */
typedef enum {
    TLG_SYS_CLK_SOURCE_XTAL = 0, /*!< Default system clock source is xtal  */
    TLG_SYS_CLK_SOURCE_EXT,      /*!< system clock source is external      */
    TLG_SYS_CLK_SOURCE_MAX       /*!< Number of system clock sources       */
} tlg_sys_clk_source_t;
...
*/
typedef struct tlg_reg_pair_s
{

    uint16  reg     ;
    uint16  value   ;
} tlg_reg_pair_t, *p_tlg_reg_pair_t;

typedef struct tlg_tone_notch_reg_s
{
    uint16  tone_notch_reg_1;
    uint16  tone_notch_reg_2;
    uint16  notch_status2_addr;
    uint16 tone_notch_reg_3_shift;
    uint16 tone_notch_reg_3_mask;
} tlg_tone_notch_reg_t;
/*
...
#define TLG_LOWEST_NOTCH_FILTER_WITH_EXTENDED_FREQUENCY (3)
#define TLG_NOTCH_FILTER_EXTENDED_PRECISION_BITS (11)
enum 
{
    MAIN_NOTCH = 0,
    AUDIO_ADJ_4_NOTCH  = 0,    /* AUDIO_ADJ_4_NOTCH is not used in the tlg1120Api, only misc_inifile.h */  
    AUDIO_ADJ_3_NOTCH  = 1,
    AUDIO_ADJ_2_NOTCH = 2,
    SYS_CLOCK_NOTCH = 3,
    AUDIO_MAIN_NOTCH  = 4,
...
#define TLG1121_VERS_A_2_BEGIN                 if (g_tlg_chip_ver >= TLG1120_VERS_3_3) {
#define TLG1121_VERS_A_0_ELSE                  }else if (g_tlg_chip_ver >= TLG1120_VERS_3_1) {
#define TLG1121_VERS_A_0_BEGIN                 if (g_tlg_chip_ver >= TLG1120_VERS_3_1) {
#define TLG_CHIP_VERS_2_4_ELSE                 }else if (g_tlg_chip_ver >= TLG1120_VERS_2_4) {
#define TLG_CHIP_VERS_2_4_BEGIN                 if (g_tlg_chip_ver >= TLG1120_VERS_2_4) {
#define TLG_CHIP_VERS_2_3_ELSE                 }else if (g_tlg_chip_ver >= TLG1120_VERS_2_3) {
#define TLG_CHIP_VERS_2_3_BEGIN                 if (g_tlg_chip_ver >= TLG1120_VERS_2_3) {
#define TLG_CHIP_VERS_2_1_ELSE                 }else if (g_tlg_chip_ver >= TLG1120_VERS_2_1) {
#define TLG_CHIP_VERS_2_1_BEGIN                 if (g_tlg_chip_ver >= TLG1120_VERS_2_1) {
#define TLG_CHIP_VERS_2_1_FAMILY_BEGIN              if (g_tlg_chip_ver >= TLG1120_VERS_2_1 && g_tlg_chip_ver <= TLG1116_VERS_1_2) {
...
#define TLG1121_VERS_A_2_BEGIN 
#define TLG1121_VERS_A_0_ELSE 
#define TLG1121_VERS_A_0_BEGIN 
#define TLG_CHIP_VERS_2_4_ELSE
#define TLG_CHIP_VERS_2_4_BEGIN
#define TLG_CHIP_VERS_2_3_ELSE
#define TLG_CHIP_VERS_2_3_BEGIN
#define TLG_CHIP_VERS_2_1_ELSE
#define TLG_CHIP_VERS_2_1_FAMILY_BEGIN
...
/** St the chip version by users.
 *  
 * This would allow users to force a particularversion of chip for testing and evaluation.
 * FOR DIAGNOSTIC PURPOSES ONLY
 *
 * @param version           Valid values:
 *                          - TLG1120_VERS_1_2    jupiter chip 1.2 
 *                          - TLG1120_VERS_2_1    jupiter chip 2.1
 *                          - TLG1120_VERS_3_1    mimas for Diff'l LNA chip
 *                          - TLG1120_VERS_3_2    mimas fpr SE LNA chip
 * @retval TLG_ERR_SUCCESS          Call succeeded.
 * @retval TLG_ERR_NOT_SUPPORTED    Can not set chip version.
 */
TLGDLL_API int TLG_SetChipVersion(uint32 version);
...
/** Get string description of the Chip.
 *
 * This procedure returns the string description of the chip which is being
 * controlled by the TLGAPI. If the chip version is not known, "Unknown Chip"
 * is returned. The size of the string copied into ver_str is controlled by
 * max_len. The copied string will always be '\0' terminated.
 *
 * @param base_addr         I2c address for TLG1200 chip.
 * @param ver_str           A buffer to which the description will be copied.
 * @param max_len           The maximum length, in btyes of the string that 
 *                          may be copied into ver_str. The size includes the
 *                          '\0' termination byte.
 *
 * @retval TLG_ERR_SUCCESS          Call succeeded.
 * @retval TLG_ERR_PARAM            Bad parameter value passed.
 ...
 *                      -----------+---------+-----
 *                      TLG_MASTER |   0-14   | 0-12
 *                      TLG_DAC    |   0-10   | 0-9 
 *                      TLG_DAC_DIFF    |   0-10   | 0-9 
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_FAIL     Error during call.
 */
 ...
 *                      Possible values are: 0-9 for TLG_MASTER
 *                                           0-5 for TLG_DAC
 *                                           0-5 for TLG_DAC_DIFF
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_FAIL     Error during call.
 */
...
/** Example of how to set the TLG1120 into 640x480 NTSC for LCD display.
 *
 * This procedure is an example of how to use the TLG API to set the TLG1120
 * to display a NTSC signal on a 640x480 LCD display. It sets the following:
 *
 * visible Horizontal region (assert HSYNC): pixels 179 - 818
 *
 * horizontal blanking regions             : pixels 1-22, 263-285
 * use default video configuration except:
 * - set 601 clock to TLG_INVERT
 *
 *
 * @param base_addr     I2c address for TLG1120 chip.
 *
...
/** Example of how to set the TLG1120 into 640x480 PAL for LCD display.
 *
 * This procedure is an example of how to use the TLG API to set the TLG1120
 * to display a PAL signal on a 640x480 LCD display. It sets the following:
 *
 * visible Horizontal region (assert HSYNC): pixels 179 - 818
 *
 * horizontal blanking regions             : pixels 1-46, 287-360, 622-625
 * use default video configuration except:
 * - set 601 clock to TLG_INVERT
 *
 *
...
/** Initialize state vector for TLG_SetAlternateStandardASYNC().
 */
TLGDLL_API void TLG_InitSetAlternateStandard(tlg_statep state);

/** Do Set Alternate Standard in an asynchronous fashion.
 */
TLGDLL_API int TLG_SetAlternateStandardASYNC( uint32 base_addr,tlg_statep state, int *ms );
...
/** Check pal-d pal-i.
 * This procedure detect the PAL D/I standard in China, for in Shenzhen of China TV standard is PAL/I
 * in other places of China TV standard is PAL D/K.
 *
 * @param base_addr                I2c address for TLG1120 chip.
 * @retval                 return which tv mode is detected between TLG_VSTD_PAL_D and TLG_VSTD_PAL_I
 */
TLGDLL_API uint16 TLG_setAlternateAudioOffset(uint32 base_addr);

/** Set whether system is using a PAL/SECAM channel map.
 *
 * This procedure is called by TLGAPP_ChannelSetup(). If a developer is using
 * a customer application layer other than the TLGAPP, this call should be
 * made to indicate when the application is tuning to a hybrid channel.
 *
 * @param isHybrid        indicates whether current channel map is hybrid.
 *                        0 - non-hybrid;   non-0 - Hybrid
 *
 * @retval                No return value.
 */
TLGDLL_API void TLG_SetHybrid(uint8 isHybrid);
...
/** Set the drive strength of the desired 601 bus lines to the given level.
 *
 *
* This function will set the drive strength of the specified bus lines to the
* specified value. The strength of lines not specified will not be altered.
 * @param base_addr     I2c address for TLG1120 chip.
* @param bus_lines          bitmask which defines which video bus lines are to
*                           be affected by this call. Supported Values are:
*                           - TLG_601_BUS_SELECT_ALL
*                           - TLG_601_BUS_SELECT_DATA
*                           - TLG_601_BUS_SELECT_CLK
*                           @sa tlg_defs.h
*
* @param drive_strength     Level setting for the desired bus drive strength.
*                           Supported values are any value between:
*                           - TLG_601_BUS_DRIVE_MIN
*                           - TLG_601_BUS_DRIVE_MAX
*                           @sa tlg_defs.h
*
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
* @retval TLG_ERR_FAIL      Error during call.
 */
TLGDLL_API int TLG_Set601DriveStrength(
    uint32          base_addr, 
    uint16          bus_lines, 
    uint16          driver_strengh);


/** Get Video bus output strength
 *
 * This procedure will set output strenght of 601 bus with input parameters.
 *
 * @param base_addr     I2c address for TLG1120 chip.
 * @param bus_lines          bitmask which defines which video bus lines are to
*                           be affected by this call. Supported Values are:
 ...
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 */
TLGDLL_API int TLG_Get601DriveStrength(
    uint32          base_addr, 
    uint16         bus_lines, 
    uint16          *driver_strength);
/** Set I2S bus output strength
 *
 * This procedure will set output strenght of 601 bus with input parameters.
 *
 * @param base_addr     I2c address for TLG1120 chip.
 * @param SM_strength     the strength of ASCK, AMCK output pins :range 0~7.
 * @param SL_strengh       the strength of ASD, ALRCK pins :range 0~7. 
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_NOT_SUPPORTED     Not support in current chip version
 */
TLGDLL_API int TLG_SetI2sBusStrength(
    uint32          base_addr, 
    uint16          SM_strength, 
    uint16          SL_strengh);

/** Get I2S bus output strength
 *
 * This procedure will set output strenght of 601 bus with input parameters.
 *
 * @param base_addr     I2c address for TLG1120 chip.
 * @param SM_strength     pointer to  the strength of ASCK, AMCK output pins  :0~7.
 * @param SL_strengh       pointer to the strength of ASD, ALRCK pins :0~7. 
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 */
TLGDLL_API int TLG_GetI2sBusStrength(
    uint32          base_addr, 
    uint16         *SM_strength, 
    uint16          *SL_strengh);
 ...
 *
 * This procedure sets the source of the system clock.  By default, 
 * the system clock source is TLG_SYS_CLK_SOURCE_XTAL.  This call only needs to
 * be made if using an external clock source.
 *
 * @param base_addr     I2c address for the TLG1120 chip.
 * @param clock_source  System clock source.  Supported values are:
 *                      - TLG_SYS_CLK_SOURCE_XTAL
 *                      - TLG_SYS_CLK_SOURCE_EXT
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 */
