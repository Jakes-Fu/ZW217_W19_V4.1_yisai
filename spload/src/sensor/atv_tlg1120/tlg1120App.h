...
#define tlg_channel_t(a)    const tlg_channel_t a[]
#define tlg_channel_rw_t(a)    tlg_channel_t a[]
#define p_tlg_channel_t(a)  p_tlg_channel_t a
...
TLGDLL_API int  TLGAPP_SetChannelMapPALIShenZhen(void);
 ...
 * to a digital mode (TLG_MASTER). It will also temporarily set
...
TLGDLL_API int TLG_GetChromaLockStatus(void);
 ...
 * TLGAPP_SetFrequency()
 ****************************************************************************/
/** Set Frequency, bypassing any channel map confirmation
 *
 * This procedure will issue a tune immediately to the Telegent subsystem,
 * ignore any checks for validity in the current channel map.
 *
 * The normal procedure to tune is through the physical channel map.
 * This is just for diagnostic purpose.
 *
 * @param frequency     Frequency (in khz) to tune to.
 *
 ****************************************************************************/
 ...
 * TLGAPP_SetBandwidth()
 ****************************************************************************/
/** DIAGNOSTIC ONLY. Manually set the bandwidth for the next channel selection.
 *
 * This procedure set the specified bandwidth in the TLG1170. Value becomes effective
 * after the next set frequency.
 *
 * The normal procedure to tune is through the physical channel map.
 * This is just for diagnostic purpose.
 *
 * @param bw        The desired bandwidth setting. @see tlg_bw
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_FAIL     Error during call.
 ...
 * TLGAPP_SetStd()
 ****************************************************************************/
/** DIAGNOSTIC ONLY. Manually set the standard for the next channel selection.
 *
 * This procedure set the specified analog standard in the TLG1170.
 * Value becomes effective after the next set frequency.
 *
 *
* @param std       The desired video standard. @see tlg_AnalogVideoStandard
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_FAIL     Error during call.
 ...
 * TLGAPP_SetMode()
 ****************************************************************************/
/** Manually set the mode for the next channel selection.
 *
 * This procedure set the specified mode in the TLG1170. Value becomes effective
 * after the next set frequency.
 *
 * The normal procedure to tune is through the physical channel map.
 * This is just for diagnostic purpose.
 *
 * @param mode      The desired mode.  @see tlg_mode
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_PARAM    Bad parameter value passed.
 * @retval TLG_ERR_FAIL     Error during call.
 ...
 * TLGAPP_ScanStart()
 ****************************************************************************/
/** Enter the Telegent Subsystem Scan mode.
 *
 * This procedure starts/enters the Telegent subsystem scan mode which tells
 * the subsystem that the application code is attempting to detect channel
 * presence rather than interested in normal service playing. The subsystem
 * can use this information to optimize performance for a scan.
 *
 * This procedure is being introduced to obsolete TLGAPP_StartChannelScan.
 * It is equivalent to call TLGAPP_StartChannelScan(NULL, 0);
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_FAIL     Error during call.
 *                          @sa Errors in tlg_error.h.
 *
 ****************************************************************************/
 ...
 *
 * This procedure is being introduced to obsolete TLGAPP_StopChannelScan.
 *
 * @retval TLG_ERR_SUCCESS  Call succeeded.
 * @retval TLG_ERR_FAIL     Error during call.
 *                          @sa Errors in tlg_error.h.
