...
public:
	...
	void SendKeys(const VARIANT& Keys, const VARIANT& vWait);
	...
	void Volatile(const VARIANT& vVolatile);
	double GetWidth();
...
public:
	...
	void Protect(const VARIANT& Password, const VARIANT& DrawingObjects, const VARIANT& Contents, const VARIANT& vScenarios, const VARIANT& UserInterfaceOnly);
...
public:
	...
	VARIANT LinkInfo(LPCTSTR Name, long lLinkInfo, const VARIANT& Type, const VARIANT& EditionRef);
	...
	void FollowHyperlink(LPCTSTR Address, const VARIANT& SubAddress, const VARIANT& vNewWindow, const VARIANT& AddHistory, const VARIANT& ExtraInfo, const VARIANT& Method, const VARIANT& HeaderInfo);
	void AddToFavorites();
	BOOL GetIsInplace();
	void PrintOut(const VARIANT& From, const VARIANT& To, const VARIANT& Copies, const VARIANT& Preview, const VARIANT& ActivePrinter, const VARIANT& PrintToFile, const VARIANT& Collate, const VARIANT& PrToFileName);
	void WebPagePreview();
...
public:
	...
	VARIANT Subtotal(long GroupBy, long Function, const VARIANT& TotalList, const VARIANT& vReplace, const VARIANT& PageBreaks, long SummaryBelowData);
	VARIANT GetSummary();
...
public:
	...
	long GetCount();
	void Delete();
	void FillAcrossSheets(LPDISPATCH lpRange, long Type);
	LPDISPATCH GetItem(const VARIANT& Index);
	void Move(const VARIANT& Before, const VARIANT& After);
	LPUNKNOWN Get_NewEnum();
	void PrintPreview(const VARIANT& EnableChanges);
