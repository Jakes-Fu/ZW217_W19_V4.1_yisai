...
void _Application::SendKeys(const VARIANT& Keys, const VARIANT& vWait)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT;
...
void _Application::Volatile(const VARIANT& vVolatile)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void _Worksheet::Protect(const VARIANT& Password, const VARIANT& DrawingObjects, const VARIANT& Contents, const VARIANT& vScenarios, const VARIANT& UserInterfaceOnly)
{
	static BYTE parms[] =
		VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0x11a, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 &Password, &DrawingObjects, &Contents, &vScenarios, &UserInterfaceOnly);
}
...
VARIANT _Workbook::LinkInfo(LPCTSTR Name, long lLinkInfo, const VARIANT& Type, const VARIANT& EditionRef)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4 VTS_VARIANT VTS_VARIANT;
	InvokeHelper(0x327, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		Name, lLinkInfo, &Type, &EditionRef);
	return result;
}
...
void _Workbook::FollowHyperlink(LPCTSTR Address, const VARIANT& SubAddress, const VARIANT& vNewWindow, const VARIANT& AddHistory, const VARIANT& ExtraInfo, const VARIANT& Method, const VARIANT& HeaderInfo)
{
	static BYTE parms[] =
	...
	InvokeHelper(0x5be, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 Address, &SubAddress, &vNewWindow, &AddHistory, &ExtraInfo, &Method, &HeaderInfo);
}
...
VARIANT Range::Subtotal(long GroupBy, long Function, const VARIANT& TotalList, const VARIANT& vReplace, const VARIANT& PageBreaks, long SummaryBelowData)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_I4;
	InvokeHelper(0x372, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		GroupBy, Function, &TotalList, &vReplace, &PageBreaks, SummaryBelowData);
	return result;
}
...
void Worksheets::FillAcrossSheets(LPDISPATCH lpRange, long Type)
{
	static BYTE parms[] =
		VTS_DISPATCH VTS_I4;
