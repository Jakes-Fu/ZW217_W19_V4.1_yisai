...
const COLORREF CCoolStatusBar::CLR_RECT_EDGE = RGB(255, 255, 255);//RGB(49, 105, 198);
/////////////////////////////////////////////////////////////////////////////
// CCoolStatusBar
...
void CCoolStatusBar::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
{
	...
	m_rcPrgrsCtrl.right  = m_rcPrgrsCtrl.left + PRGRSCTRL_WIDTH;
...
int CCoolStatusBar::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	VERIFY( m_brshDlgBckGrnd.CreateSolidBrush(RGB(232,232,232)) );
...
#ifdef _UNICODE
	CRect rect;
	GetItemRect(m_nPaneId, rect);
	memDC.DrawIcon(rect.TopLeft(), m_hIcon);
#endif	
...
//	pDC->FillSolidRect(rect, GetSysColor(COLOR_3DFACE));
	pDC->FillSolidRect(rect, RGB(232,232,232));
}
...
void CCoolStatusBar::SetPaneBmp(int nPaneId, HICON hIcon)
{	
	m_nPaneId = nPaneId;
	m_hIcon = hIcon;
	Invalidate(FALSE);
