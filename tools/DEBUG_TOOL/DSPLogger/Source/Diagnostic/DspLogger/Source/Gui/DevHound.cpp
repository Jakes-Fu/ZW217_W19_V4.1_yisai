...
static bool cmp_less(DEV_INFO &e1,DEV_INFO &e2)
{
	return (e1.nPortNum < e2.nPortNum) ? true : false;		
}
//////////////////////////////////////////////////////////////////////
...
int CDevHound::ScanPort(vector<DEV_INFO> &vPortInfo)
{
	vPortInfo.clear();
	GUID *guidDev = (GUID*)&GUID_CLASS_PORT;
	HDEVINFO hDevInfo = INVALID_HANDLE_VALUE;
...
bool CDevHound::InsertPortInfo( DEV_INFO& epi,vector<DEV_INFO> &vPortInfo)
{
	if(!CheckPortInfo(epi) || epi.nPortNum == 0)
		return false;
