...
public:
    ...
    virtual BOOL StartAutoReceive(void) = 0;
	...
	virtual void OpenOrgFile(LPCTSTR lpFileName)	=0;

	virtual void CloseOrgFile(void)	=0;

	virtual void RenameOrgFile(LPCTSTR lpFileName)	=0;

	virtual void DeleteOrgFile()	=0;
	
	virtual void SetProperty(DWORD dwProperty)	=0;
