...
// Dialog Data
    ...
    CString m_strDebugLevel;
    CString m_strTmpDebugLevel;
...
public:
    CComboBox m_comboDebugLevel;
    afx_msg void OnCbnSelchangeComboDebugLevel();
};
