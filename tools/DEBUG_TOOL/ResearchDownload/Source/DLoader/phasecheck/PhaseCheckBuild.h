...
public:
    ...
    */
    ...
    PHASECHECK_RESULT        CheckStationFrom8K(const BYTE *lpData/*IN*/, int nDataLen, const char* pszStation);


private:
    BOOL        LoadConfigFile(void);   
    PHASECHECK_RESULT    SP05_CheckStation(const char* pszPrevStation, const SP05_PHASE_CHECK_T* sp05);
    PHASECHECK_RESULT    SP09_CheckStation(const char* pszPrevStation, const SP09_PHASE_CHECK_T* sp09);
    PHASECHECK_RESULT    SP15_CheckStation(const char* pszrevStation, const SP15_PHASE_CHECK_T* sp09);
