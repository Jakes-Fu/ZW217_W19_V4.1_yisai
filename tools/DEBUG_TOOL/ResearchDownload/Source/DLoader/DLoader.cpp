...
BOOL CDLoaderApp::InitInstance()
{
	...
	*/
    ...
    m_bScripCtrlStop    = GetPrivateProfileInt(_T("GUI"), _T("ScriptControlStop"), 1, szConfigPath);
...
void CDLoaderApp::OnAppAbout()
{
	...
	*pResult = '\0';
	...
	_tcscat(szPath,_T("\\..\\Doc\\UNISOC Upgrade Download User Guide V1.1 EN.pdf"));
#elif defined _FACTORY 
	aboutDlg.SetProductName( _T("FactoryDownload"));
	_tcscat(szPath,_T("\\..\\Doc\\UNISOC Factory Download User Guide V1.1 EN.pdf"));
#else
	aboutDlg.SetProductName( _T("ResearchDownload"));
	_tcscat(szPath,_T("\\..\\Doc\\UNISOC Research Download User Guide  V1.1 EN.pdf"));
#endif
	CFileFind finder;
