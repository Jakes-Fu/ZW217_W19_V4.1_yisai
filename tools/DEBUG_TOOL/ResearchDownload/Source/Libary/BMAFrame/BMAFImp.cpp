...
HRESULT CBMAFImp::BMAF_SetProperty(DWORD dwPropertyID, LPCVOID pPropertyValue)
{
	...
	case BMAF_UART_MODE_DOWNLOAD:
		...
		break;
    case BMAF_AES_KEY:
        m_pAesKey = (LPBYTE)pPropertyValue;
        break;
    case BMAF_RSA2048_PRIVATE_KEY:
        m_pRsaKey = (LPBYTE)pPropertyValue;
        break;
	default:
		return S_FALSE;
		break;
					           ...
					           LPCWSTR lpbstrProgID )
{
    ...
    pSettings->SetProperty(0,_T("AesKey"), (LPVOID)m_pAesKey);
    pSettings->SetProperty(0,_T("RsaKey"), (LPVOID)m_pRsaKey);
...
// 	}
	...
	try
	{
		pBMFileInfo = new BMFileInfo[m_nBMFileCount];
