 ...
 */
int rsa_pkcs1_encrypt(const rsa_context *ctx,
                       int mode, int  ilen,
                       unsigned char *input,
                       unsigned char *output );
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
int rsa_pkcs1_decrypt(const rsa_context *ctx,
                       int mode, int *olen,
                       unsigned char *input,
                       unsigned char *output );
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
int rsa_pkcs1_sign(const rsa_context *ctx,
                    int mode,
                    int hash_id,
                    int hashlen,
                    unsigned char *hash,
