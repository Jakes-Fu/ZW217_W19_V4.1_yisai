 ...
 **                                  *
 ******************************************************************************/
#ifndef SIMLOCK_AES_H
#define SIMLOCK_AES_H
...
#ifdef DEBUG_CMD
#define CMD_TRACE				SCI_TRACE_LOW
#else
#define CMD_TRACE
#endif
#define CMD_ASSERT(_x_)		SCI_ASSERT(_x_)
...
typedef struct
{
    ...
    unsigned long ik[64];      /*!<  unaligned data    */
}
aes_context;
