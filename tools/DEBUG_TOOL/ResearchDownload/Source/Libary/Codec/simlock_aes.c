/** File Name:      simlock_aes.c                                         *
 ** Author:        gloria.he                                               *
 ** Date:           06/01/2015                                                *
 ** Copyright:      Copyright 2001-2010 by Spreadtrum PLD_CDRV_MODEM,Inc.     *
 **                 All Rights Reserved.                                      *
 ...
 **---------------------------------------------------------------------------*
 ** 20/01/2015     gloria.he      Create.                                   *
 **                                  *
 ******************************************************************************/
/* +BUG137716 Code management */
/* +BUG63292 Add code to support AES-ECB encryption algorithm for lock/unlock keys */
...
#if defined(PADLOCK_ALIGN16)
    ctx->rk = RK = PADLOCK_ALIGN16( ctx->ik );
#else
    ctx->rk = RK = ctx->ik;
#endif
