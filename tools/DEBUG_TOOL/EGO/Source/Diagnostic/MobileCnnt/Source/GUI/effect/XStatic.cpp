...
CXStatic::CXStatic()
{
	m_uTextColor = /*RGB(68,85,123);//*/RGB(0,0,0);
...
void CXStatic::DrawBkgBmp(CPaintDC *pDC,CRect &rect)
{
...
void CXStatic::DrawBkgColor(CPaintDC *pDC,CRect &rect)
{
	CBrush brush(m_uBKGColor);
	pDC->FillRect(&rect,&brush);
}
void CXStatic::DrawText(CPaintDC *pDC,CRect &rect)
{
	CFont	Font;
	CFont*	pOldFont = NULL;
	LOGFONT	csLogFont;
