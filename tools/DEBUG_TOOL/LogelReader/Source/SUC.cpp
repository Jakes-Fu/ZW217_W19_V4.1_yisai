// SUC.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSUCApp, CWinApp)
	//{{AFX_MSG_MAP(CSUCApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CSUCApp object

CSUCApp theApp;
// CLoadDll g_dllSocObj;
// CLoadDll g_dllObj;

/////////////////////////////////////////////////////////////////////////////
// CSUCApp initialization

BOOL CSUCApp::InitInstance()
{
	if (!AfxSocketInit())
	{
