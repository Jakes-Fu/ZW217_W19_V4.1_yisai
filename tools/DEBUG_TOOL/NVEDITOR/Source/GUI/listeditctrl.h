...
// Implementation
public:
	void SetItemType(int iItemType,int iItemLength=-1);
...
class CListEditCtrlLite : public CEdit
{
// Construction
public:
	CListEditCtrlLite(int iItem, int iSubItem,  CString sInitText);
// Attributes
public:
