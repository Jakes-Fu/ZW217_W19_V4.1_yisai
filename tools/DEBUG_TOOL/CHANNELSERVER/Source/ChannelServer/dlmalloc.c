...
#ifndef  UNUSE_DL_LOCKS
#ifndef USE_LOCKS
#define USE_LOCKS 1 
#endif /* USE_LOCKS */
#endif /* UNUSE_DL_LOCKS */
//]]
...
//[[ @hongliang InitializeCriticalSectionAndSpinCount need _WIN32_WINNT>=0x0500
#ifndef _WIN32_WINNT
...
#pragma warning( disable : 4127 ) /* no "conditional expression is constant" warnings */
#pragma warning( disable : 4702 ) /* no "unreachable code" warning */
#endif /* WIN32 */
...
extern "C" {
#endif /* __cplusplus */
PVOID __cdecl _InterlockedCompareExchange(PVOID volatile *Dest, PVOID Exchange, PVOID Comp);
...
static void init_malloc_global_mutex() {
  for (;;) {
    ...
    if (stat == 0 &&
        interlockedcompareexchange((volatile PVOID)&malloc_global_mutex_status, (PVOID)-1, (PVOID)0) == 0) {
