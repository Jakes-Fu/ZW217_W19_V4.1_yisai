...
extern "C" {
#endif
extern volatile int g_nHWCodec;
...
MY_STDAPI LzmaUncompress2(unsigned char *dest, size_t *destLen, const unsigned char *src, SizeT srcLen,int bHWCodec);

MY_STDAPI LzmaUncompress3(unsigned char *dest, size_t *destLen, const unsigned char *src, SizeT srcLen);
