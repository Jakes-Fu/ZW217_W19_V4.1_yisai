// NAParserV2.h: interface for the CNAParserV2 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_NAPARSER_V2_H__0EB648BA_98ED_4249_8425_79006B31CAD2__INCLUDED_)
#define AFX_NAPARSER_V2_H__0EB648BA_98ED_4249_8425_79006B31CAD2__INCLUDED_
...
typedef struct _NTAC_T
{
	...
	BYTE  Visible;	//0~1
	BYTE  Roaming;	//0~1
	BYTE  roaming_protocol; //0~2
	WCHAR name[NTAC_NAME_LEN+1];//连接名称 最大32
	...
	WCHAR apn[NTAC_APN_LEN+1];//接入点名称       最大32
	WCHAR homepage[NTAC_HOMEPAGE_LEN+1];//主页地址    最大512

	//WCHAR spn[NTAC_SPN_LEN+1];//SPN   最大32
	//remove ntac_v1::NTAC_T.spn
	//add below
	WCHAR mvno_value[NTAC_SPN_LEN + 1]; //MVNO VALUE  最大32
...
namespace ntac_v2
{
	typedef struct _NTAC_T
	{
		...
		//add below
		BYTE  mvno_type;//0~5
		WCHAR mvno_value[NTAC_NAME_LEN + 1]; //MVNO VALUE  最大
		BYTE  Visible;	//0~1
		BYTE  Roaming;	//0~1
		BYTE  roaming_protocol; //0~2
...
#endif // !defined(AFX_NAPARSER_V2_H__0EB648BA_98ED_4249_8425_79006B31CAD2__INCLUDED_)
