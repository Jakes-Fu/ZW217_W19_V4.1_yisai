...
unsigned long  gb2312_to_ucs2(  /*lint -esym(765,gb2312_to_ucs2)*/            // return the UCS2 count
...
{
    unsigned long    ucs2_count = 0;
    unsigned short   offset, tmp;
    
    while( (ucs2_count < max_ucs2) && (gb2312_size > 0) && (gb2312_size < 0xFFF) )
    {
        tmp = (unsigned short)(*gb2312++);
        gb2312_size--;
        ucs2_count++;
        ...
        { 
            ...
            {
                offset  = (offset - 0xA1) + (tmp - 0xA0) * 94;
                *ucs2++ = (offset < 8272) ? gb2312_to_ucs2_table[offset] : 0x0; 
            }            
        }
        else
        {
