...
enum
{
    ...
    PRI_CARDLOG_TASK_PRIO_OFFSET            = 30,
    PRI_DSP_CODEC_UPLOAD_TASK_OFFSET        = 5, 
    PRI_IMG_DEC_TASK_OFFSET                 = 29,
    PRI_PNGDEC_TASK_OFFSET                  = 30,
    PRI_DCAM_TASK_OFFSET                    = 28,
    PRI_LCD_TASK_OFFSET                     = 27,
    PRI_IMG_SCALE_TASK_OFFSET               = 29,
    ...
    PRI_AUTODEMO_TASK_OFFSET                = 29,
#endif
    PRI_MSENSOR_TASK_OFFSET                 = 28,
    PRI_ISP_SERVICE_TASK_OFFSET             = 29,
    PRI_IMG_PROC_CTRL_TASK_OFFSET           = 28,
    PRI_IMG_PROC_PROCESS_TASK_OFFSET        = 31,
    PRI_DV_DEMUX_OFFSET                     = 29,
    PRI_DCAMERA_TASK_OFFSET                 = 29,
    PRI_VT_MIDDLEWARE_TASK_OFFSET           = 29,
    PRI_VT_LOOP_TASK_OFFSET                 = 29,
    PRI_UCOM_ORG_TASK_OFFSET                = 29,
    PRI_JPEG_TASK_OFFSET                    = 29,
    PRI_JPEG_TASK_HW_DEFAULT_OFFSET         = 29,
    PRIFS_OFFSET                            = 29,
    PRI_DV_VIDEO_OFFSET                     = 30,
    PRI_DV_MUX_OFFSET                       = 30,
    PRI_FFS_OFFSET                          = 30,
    PRI_AUDIO_CODEC_LOW_OFFSET              = 30,
    PRI_BMP_TASK_OFFSET                     = 30,
    PRI_IMG_DEC_CONFIG_OFFSET               = 30,
    PRI_GIF_DECODE_TASK_OFFSET              = 30,
    PRI_UPCC_MAIN_TASK_OFFSET               = 30,
    PRI_UPCC_DRV_TASK_OFFSET                = 30,
    PRI_RECORD_OFFSET                       = 31,
    PRI_BT_FTP_OFFSET                       = 31,
    PRI_BT_TIMEOUT_OFFSET                   = 31,
    PRI_APP_INIT_TASK_OFFSET                = 31,
    PRI_CPU_MONITOR_OFFSET                  = 31,
    PRI_VOICE_RECORD_DEBUG_DATA_TASK_OFFSET = 31,
    PRI_DSP_LOG_TASK_OFFSET                 = 31,
    PRI_MV_SCHED_TASK_OFFSET                = 25,
    PRI_SFS_DISK_C_TASK_OFFSET              = 30,
    PRI_SFS_DISK_D_TASK_OFFSET              = 30,
    PRI_SFS_DISK_OFFSET_TASK_OFFSET         = 30,
    PRI_SFS_DISK_F_TASK_OFFSET              = 30,
    PRI_NET_PRIORITY_OFFSET				    = 18,
    PRI_WIFISUPP_TASK_OFFSET			    = 26,
    PRI_IPERF_TASK_HIGH_OFFSET			    = 19,
    PRI_IPERF_TASK_NORMAL_OFFSET		    = 26,
    PRI_IPERF_TASK_LOW_OFFSET			    = 31,
    PRI_RTP_TASK_OFFSET					    = 26,
    PRI_ODM_TASK_OFFSET					    = 26,
    PRI_ODM_UT_TASK_OFFSET				    = 30,
    PRI_STRM_TASK_OFFSET				    = 27,
    PRI_DUA_TASK_OFFSET					    = 27,
    PRI_NETMGR_TASK_OFFSET				    = 26,
    PRI_NETMGR_TESTAPP_TASK_OFFSET		    = 27,
    PRI_DRM_DH_TASK_OFFSET				    = 31,
    PRI_DRM_IO_TASK_OFFSET				    = 30,
    PRI_WIFI_TEST_TASK_OFFSET			    = 28,
    PRI_WIFITEST_TASK_OFFSET			    = 31,
...
SCI_DEFINE_TASK_PRI(PRI_KPDSVR                        ,SCI_SYSTEM_PRI( PRI_KPDSVR_OFFSET                       ));
