 ...
 */
//uint32 crc32Update(uint32 crc, const void *p, size_t size);
 ...
 * \return  CRC32 value
 */
uint32 crc32Calc(const void *p, size_t length);
 ...
 * \return  updated value
 */
uint32 crc32VariantUpdate(uint32 crc, const void *p, size_t size);
 ...
 * \return  CRC32 value
 */
uint32 crc32VariantCalc(const void *p, size_t length);
 ...
 * \return  CRC16 value
 */
uint16 crc16NvCalc(const void *p, size_t size);
 ...
 * \return  CRC16 value
 */
uint16 crc16RomBslCalc(const void *p, unsigned size);
 ...
 */
uint8 crc16RomBslCheck(const void *p, unsigned size);
 ...
 * \return  CRC16 value
 */
uint16 crc16FdlCalc(const uint16 *p, unsigned size);
