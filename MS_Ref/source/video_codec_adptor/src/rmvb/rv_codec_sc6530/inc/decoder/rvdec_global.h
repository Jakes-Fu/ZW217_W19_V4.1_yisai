...
extern BOOLEAN g_rv_skip_bfrm_after_seek;
...
#else
extern const uint32 g_msk_rvdec_ptr[33];
extern const uint8 g_clip_tbl_rvdec_ptr[CLIP_TAB_SIZE];
#endif

#if !defined(SC6800H_VIDEO_ROMCODE)
extern uint8 *g_ClipTab_rv89;//[CLIP_TAB_SIZE];
#endif
