...
length		FIELD	0
		...
		strb	r10, [pPred], #1
		add		r10, $p1, $p4
		smlabb	$p0, $p3, par52, $p0
		add		r10, r10, r10, lsl #2
		rsb		r10, r10, $p0
		smlabb	$p0, $p2, par20, $p5
		add		r10, r10, #32
		add		$p0, $p0, r10
...
;/***************************************************/
;arm_mc_luma16x16_dx3dy2_rv9
;input:
;	r0: pRef
;	r1: pPred
;	r2: srcPitch
;/****************************************************/		
		EXPORT	arm_mc_luma16x16_dx3dy2_rv9 	
		IMPORT	g_rgiRvClipTab
		IMPORT	g_int_bfr
		IMPORT	arm_mc_luma16x16_dx0dy2_rv9
...
ROW_LOOP
		...
		ldrb	pp3, [pRef], #1
		add		r10, pn1, pp2
		smlabb	pn2, pp1, par52, pn2
		add		r10, r10, r10, lsl #2
		rsb		r10, r10, pn2
		smlabb	pn2, pp0, par20, pp3
		add		r10, r10, #32
		add		pn2, pn2, r10
		...
		mov		r2,	#MB_SIZE
		add		r0, r0, #(2*MB_SIZE)
		bl		arm_mc_luma16x16_dx0dy2_rv9
