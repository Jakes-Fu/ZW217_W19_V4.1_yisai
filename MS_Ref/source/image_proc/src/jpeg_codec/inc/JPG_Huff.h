...
void Vlc_Quant_Block(int32 *block, HUFF_TBL_T *dc_tbl, HUFF_TBL_T *ac_tbl, const uint16 *quant);
BOOLEAN Vld_DQuant_Block(int32 *block, HUFF_TBL_T *dc_tbl, HUFF_TBL_T *ac_tbl, const uint16 *quant);
