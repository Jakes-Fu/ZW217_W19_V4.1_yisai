...
PUBLIC uint32 LCDC_DrvReset (void)
{
    ...
    REG32 (AHB_RST0_SET) = LCDC_SOFT_RST;

    SCI_Sleep (10);

    // clear AHB lcdc soft reset
    REG32 (AHB_RST0_CLR) = LCDC_SOFT_RST;
...
PUBLIC uint32 LCDC_DrvSetAlphaBaseAddr (LCD_LAYER_ID_E layer_id, uint32 base_addr)
{
   ...
   // alpha_addr_ptr->dwValue=alpha_base_addr;//alpha_addr_ptr might be  NULL, put it in switch case
