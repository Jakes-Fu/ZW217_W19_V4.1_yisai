...
#define RM_PARSER_INDEX_TABLE_LEN    1024
...
typedef struct rm_idx_info
{
    UINT32  ulStreamNum;
    UINT32  ulNumIndexes;
    UINT32  ulNumIndexesAll;
    BYTE*    pIndexBuffer;
    UINT32  ulFirstIndexTime;
    UINT32  ulFIrstFileOffset;
    UINT32  ulLastIndexTime;
    UINT32  ulLastFileOffset;
    BOOL     bHaveIndex;
    UINT32  ulFirstIndex;
    UINT32  ulLastIndex;
    UINT32  ulCurIndex;                //index readed in next searching
    UINT32  ulNextIndexOffset;
    UINT32  ulIndexChunkOffset;
    UINT32  ulCurIndexInBuf;        //index found 
    UINT32  ulFoundTime;
}rm_index_info;
...
typedef struct rm_parser_internal_struct
{
    ...
    BYTE*                          pPacketBuffer;
    UINT32                        ulPacketBufferSize;
    UINT32                        ulUsedBufferSize;
    UINT32                        ulCurBufferOffset;
    UINT32                        ulVideoStreamNum;
    UINT32                        ulAudioStreamNum;
    struct rm_idx_info   videoIndexInfo;
    struct rm_idx_info   audioIndexInfo;
