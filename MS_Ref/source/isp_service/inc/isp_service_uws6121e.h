...
typedef enum
{
    ISP_SERVICE_DUMP_INVALID = 0,
    ISP_SERVICE_DUMP_DDR = 1,
    ISP_SERVICE_DUMP_FILE,
    ISP_SERVICE_DUMP_MODE_MAX
}ISP_SERVICE_DUMP_MODE_E;


typedef struct
{
    ISP_SERVICE_DUMP_MODE_E dump_mode;
    int max_dump_frame_to_file; // set max num of frames that can be dumped
