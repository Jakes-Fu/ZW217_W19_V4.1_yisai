...
/*****************************************************************************/
//! \fn PUBLIC AUDMOD_RESULT_E AUDMOD_ChangeNVParam(
//!    AUDMOD_DEVMOD_T *ptAudMode,
//!    AUDMOD_CHANGE_MODE_E modeflag 
//!    )
//! \return Operation results. \sa AUDMOD_RESULT_E
//! \brief  Description:  This function is change nv params in temp.
//! \author Author:  Benjamin.Wang
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC AUDMOD_RESULT_E AUDMOD_ChangeNVParam(
    AUDMOD_DEVMOD_T *ptAudMode, 
    uint8 modeflag
);
