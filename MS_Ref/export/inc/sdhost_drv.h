...
//---PIN设置相关
/* Before power down, sd pins should be set to logical '0' to  
* avoid a situation that the operating current is drawn through 
* the signal lines.
*/
typedef enum
{
...
{
    uint32 pin_sd_name;
    uint32 addr; //pin reg addr
    uint32 pin_reg_reserved; // to record pin reg value in pinmap_cfg.c
}PIN_SD_INFO_T;
