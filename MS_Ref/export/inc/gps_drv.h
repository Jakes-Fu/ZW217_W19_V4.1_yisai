...
#ifndef CONFIG_SOC_6121
#define CONFIG_SOC_6121 6121
#endif

#define DBG_6121 6121
#define DEBUG_GNSS_EPH_RAM 1
...
{
    unsigned char is_hw_work;
    unsigned char is_position_fix;
...
//  Note:
/*****************************************************************************/
PUBLIC GPS_ERR_E GPS_EnterSleep(unsigned char is_sleep);
...
/*************************************************************************
 * Function    : LIBGPS_STARTMODE_AGNSS
 * Description : get the gnss work mode
 * Parameters  : 
 * Return      : gnss work mode
**************************************************************************/

void LIBGPS_STARTMODE_AGNSS();

void GPSTEST_SendPdpInfoReq(
    unsigned int dual_sys);
