...
typedef enum
{
    AUDMOD_CALLBACK_FUNC_TYPE_SETMODE,       //AUDMOD_SetDevMode or AUDMOD_SetDevModeEx
    AUDMOD_CALLBACK_FUNC_TYPE_SETVOLUME,    //AUDMOD_SetVolume
    AUDMOD_CALLBACK_FUNC_TYPE_MAX
}AUDMOD_CALLBACK_FUNC_TYPE_E_;
typedef uint32 AUDMOD_CALLBACK_FUNC_TYPE_E;
typedef void (*AUDMOD_CALLBACK_FUNC_)(void);
...
typedef enum
{
        ...
        NV_AUDIO_HEADFREE_E,
        NV_AUDIO_HANDSET_E,
        NV_AUDIO_HANDSFREE_E,
        NV_AUDIO_RECORD_E,
        NV_AUDIO_RECORDHEADSET_E,
        NV_AUDIO_MP4HFTR_E,
        NV_AUDIO_MP4HFTRHEADSET_E, 
        NV_AUDIO_BTHS_E,
        NV_AUDIO_HEADSETTD_E,
        NV_AUDIO_HEADFREETD_E,
        NV_AUDIO_HANDSETTD_E,
        NV_AUDIO_HANDSFREETD_E,
        NV_AUDIO_LOOPBACK_HEADSET_E,
        NV_AUDIO_LOOPBACK_HANDSET_E,        
        NV_AUDIO_LOOPBACK_HANDSFREE_E,
        NV_AUDIO_MP4HFTP_E,
        NV_AUDIO_MP4HEADSET_E,
        NV_AUDIO_MAX
}NV_AUDIO_E;
...
/*****************************************************************************/
//! \fn PUBLIC uint32 AUDMOD_SetVolume(uint32  uiVol)
//! \param vvolume value.
//! \return void No parameter.
//! \brief  Description:  This function is to set current volume level.
//! \author Author:  Shujing.Dong
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC void AUDMOD_SetVolume(uint32  uiVol);

/*****************************************************************************/
//! \fn PUBLIC void AUDMOD_SetExtraVolume( 
...
//! \note   Note: None.      
/*****************************************************************************/
PUBLIC void AUDMOD_SetExtraVolume(
     BOOLEAN bExtraVolFlag,
     uint16 usExtraVolGain
    );
...
//!    const uint8* pucModeName, 
//!    AUDMOD_DEVMOD_T* ptDeviceMode
//!const uint8* pucModeNametd, 
//!    )
//! \param pucModeName gsm Mode Name.
 //\param pucModeNametd td  Mode Name.
//! \param ptDeviceMode [IN] Address which the mode parameter saved.
//! \return Operation resules. \sa AUDMOD_RESULT_E
//! \brief  Description:  This function is to set the named device mode information.
//! \author Author:  Benjamin.Wang
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC AUDMOD_RESULT_E AUDMOD_SetDevModeEx(
    const uint8* pucModeName, 
    AUDMOD_DEVICECTL_T *ptDeviceCtrl,
     const uint8* pucModeNametd
);
...
/*****************************************************************************/
//! \fn PUBLIC AUDIO_DEVICE_MODE_TYPE_E AUDMOD_GetAudioDevModeFromName(
//!    char * pcModeName
//!    )
//! \param mode name. \sa char*
//! \return AUDIO_DEVICE_MODE_TYPE_E Mode type.
//! \brief  Description:  This function is to get the mode by mode name.
//! \author Author:  Shujing.Dong
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC AUDIO_DEVICE_MODE_TYPE_E AUDMOD_GetAudioDevModeFromName (
	char * pcModeName
	);
/*****************************************************************************/
//! \fn PUBLIC char *AUDMOD_GetAudioDeviceModeNameById (
//!    NV_AUDIO_E nv_audio_e
//!    )
//! \param nv_audio_e mode id. 
//! \return  mode name \sa char*
//! \brief  Description:  This function is to get the mode name by mode id.
//! \author Author:  Shujing.Dong
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC char *AUDMOD_GetAudioDeviceModeNameById (
    NV_AUDIO_E nv_audio_e
    );

/*****************************************************************************/
//! \fn PUBLIC AUDMOD_RESULT_E AUDMOD_RegCallbackFunc(
//!    AUDMOD_CALLBACK_FUNC_TYPE_E eCallbackFuncType,
//!    AUDMOD_CALLBACK_FUNC_ pCallbackFunc    
//!    )
//! \param eCallbackFuncType callback type
//! \param pCallbackFunc  callback function
//! \return AUDMOD_RESULT_E
//! \brief  Description:  This function is to register the callback function to the mode manager and
//                        when call the interface correspondent with the type, the callback with the type 
//                        have to be called.
//! \author Author:  Shujing.Dong
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC AUDMOD_RESULT_E AUDMOD_RegCallbackFunc (
    AUDMOD_CALLBACK_FUNC_TYPE_E eCallbackFuncType,
    AUDMOD_CALLBACK_FUNC_ pCallbackFunc    
    );
...
/*****************************************************************************/
//! \fn PUBLIC AUDMOD_RESULT_E AUDMOD_UnRegCallbackFunc(
//!    AUDMOD_CALLBACK_FUNC_TYPE_E eCallbackFuncType,
//!    AUDMOD_CALLBACK_FUNC_ pCallbackFunc    
//!    )
//! \param eCallbackFuncType callback type
//! \param pCallbackFunc  callback function
//! \return AUDMOD_RESULT_E
//! \brief  Description:  This function is to unregister the callback function from the mode manager.
//! \author Author:  Shujing.Dong
//! \note   Note:Nothing.  
/*****************************************************************************/
PUBLIC AUDMOD_RESULT_E AUDMOD_UnRegCallbackFunc (
    AUDMOD_CALLBACK_FUNC_TYPE_E eCallbackFuncType,
    AUDMOD_CALLBACK_FUNC_ pCallbackFunc    
    );
/**---------------------------------------------------------------------------**
