...
typedef enum
{
    BT_DUN_CONNECTED  = (BT_DUN_SERVICE << 8) | 1,
    BT_DUN_DISCONNECTED,
    BT_DUN_MSG_MAX_NUM
}BT_DUN_EVENT_E;
...
typedef struct _AvrcpCtPanelOperation
{
	 ...
	 */
	uint16	Op;
	BOOLEAN press;	/* ¡êotrue stands for pressed, false stands for release*/
...
#define ID_STATUS_CM_INQUIRY_FINISH                 (ID_CM_MSG_BASE|0x0003)                                          
